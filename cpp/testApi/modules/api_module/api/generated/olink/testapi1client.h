...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi1 publisher in a way it provides access 
* to remote TestApi1 services. 
...
*     It provides a network implementation and tools to connect TestApi1Client to it.
* Use on client side to request changes of the TestApi1 on the server side 
* and to subscribe for the TestApi1 changes.
*/
class CPP_API_EXPORT TestApi1Client : public ITestApi1,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi1Client();
    /** dtor */
    virtual ~TestApi1Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi1 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi1::funcInt on the TestApi1 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi1::funcFloat on the TestApi1 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi1::funcString on the TestApi1 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi1Client is ready to send and receive messages.
    * @return true if TestApi1 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi1 service
...
private:
    ...
    * @param the data received from TestApi1 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi1Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi1 */
