...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi63 publisher in a way it provides access 
* to remote TestApi63 services. 
...
*     It provides a network implementation and tools to connect TestApi63Client to it.
* Use on client side to request changes of the TestApi63 on the server side 
* and to subscribe for the TestApi63 changes.
*/
class CPP_API_EXPORT TestApi63Client : public ITestApi63,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi63Client();
    /** dtor */
    virtual ~TestApi63Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi63 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi63::funcInt on the TestApi63 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi63::funcFloat on the TestApi63 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi63::funcString on the TestApi63 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi63Client is ready to send and receive messages.
    * @return true if TestApi63 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi63 service
...
private:
    ...
    * @param the data received from TestApi63 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi63Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi63 */
