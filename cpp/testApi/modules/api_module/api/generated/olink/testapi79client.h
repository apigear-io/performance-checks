...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi79 publisher in a way it provides access 
* to remote TestApi79 services. 
...
*     It provides a network implementation and tools to connect TestApi79Client to it.
* Use on client side to request changes of the TestApi79 on the server side 
* and to subscribe for the TestApi79 changes.
*/
class CPP_API_EXPORT TestApi79Client : public ITestApi79,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi79Client();
    /** dtor */
    virtual ~TestApi79Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi79 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi79::funcInt on the TestApi79 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi79::funcFloat on the TestApi79 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi79::funcString on the TestApi79 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi79Client is ready to send and receive messages.
    * @return true if TestApi79 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi79 service
...
private:
    ...
    * @param the data received from TestApi79 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi79Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi79 */
