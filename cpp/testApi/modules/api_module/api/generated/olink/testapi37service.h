...
namespace olink {
/**
* Server side for TestApi37 implements the TestApi37 service.
* It is a source of data for TestApi37 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi37Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi37Subscriber
{
public:
    /**
    * ctor
    * @param TestApi37 The service source object, the actual TestApi37 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi37Service(std::shared_ptr<ITestApi37> TestApi37, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi37Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi37 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi37 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi37 object.
    * @return the set of properties with their current values for the TestApi37 object in json format.
    */
...
private:
    /**
    * The TestApi37 used for object source.
    */
    std::shared_ptr<ITestApi37> m_TestApi37;
    /**
