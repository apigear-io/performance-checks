...
namespace olink {
/**
* Server side for TestApi50 implements the TestApi50 service.
* It is a source of data for TestApi50 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi50Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi50Subscriber
{
public:
    /**
    * ctor
    * @param TestApi50 The service source object, the actual TestApi50 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi50Service(std::shared_ptr<ITestApi50> TestApi50, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi50Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi50 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi50 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi50 object.
    * @return the set of properties with their current values for the TestApi50 object in json format.
    */
...
private:
    /**
    * The TestApi50 used for object source.
    */
    std::shared_ptr<ITestApi50> m_TestApi50;
    /**
