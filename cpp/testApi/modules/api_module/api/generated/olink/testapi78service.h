...
namespace olink {
/**
* Server side for TestApi78 implements the TestApi78 service.
* It is a source of data for TestApi78 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi78Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi78Subscriber
{
public:
    /**
    * ctor
    * @param TestApi78 The service source object, the actual TestApi78 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi78Service(std::shared_ptr<ITestApi78> TestApi78, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi78Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi78 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi78 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi78 object.
    * @return the set of properties with their current values for the TestApi78 object in json format.
    */
...
private:
    /**
    * The TestApi78 used for object source.
    */
    std::shared_ptr<ITestApi78> m_TestApi78;
    /**
