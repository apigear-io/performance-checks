...
namespace olink {
/**
* Server side for TestApi94 implements the TestApi94 service.
* It is a source of data for TestApi94 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi94Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi94Subscriber
{
public:
    /**
    * ctor
    * @param TestApi94 The service source object, the actual TestApi94 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi94Service(std::shared_ptr<ITestApi94> TestApi94, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi94Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi94 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi94 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi94 object.
    * @return the set of properties with their current values for the TestApi94 object in json format.
    */
...
private:
    /**
    * The TestApi94 used for object source.
    */
    std::shared_ptr<ITestApi94> m_TestApi94;
    /**
