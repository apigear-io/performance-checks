...
#include "api/generated/core/testapi27.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi27 publisher in a way it provides access 
* to remote TestApi27 services. 
...
*     It provides a network implementation and tools to connect TestApi27Client to it.
* Use on client side to request changes of the TestApi27 on the server side 
* and to subscribe for the TestApi27 changes.
*/
class CPP_API_EXPORT TestApi27Client : public ITestApi27,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi27Client();
    /** dtor */
    virtual ~TestApi27Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi27 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi27::funcInt on the TestApi27 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi27::funcFloat on the TestApi27 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi27::funcString on the TestApi27 service.
    ...
    */
    ...
    ITestApi27Publisher& _getPublisher() const override;
    
    /**
    * Informs if the TestApi27Client is ready to send and receive messages.
    * @return true if TestApi27 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi27 service
...
private:
    ...
    * @param the data received from TestApi27 service.
    */
    ...
    TestApi27Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi27Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi27 */
    std::unique_ptr<ITestApi27Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
