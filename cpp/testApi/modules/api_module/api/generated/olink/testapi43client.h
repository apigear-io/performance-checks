...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi43 publisher in a way it provides access 
* to remote TestApi43 services. 
...
*     It provides a network implementation and tools to connect TestApi43Client to it.
* Use on client side to request changes of the TestApi43 on the server side 
* and to subscribe for the TestApi43 changes.
*/
class CPP_API_EXPORT TestApi43Client : public ITestApi43,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi43Client();
    /** dtor */
    virtual ~TestApi43Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi43 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi43::funcInt on the TestApi43 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi43::funcFloat on the TestApi43 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi43::funcString on the TestApi43 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi43Client is ready to send and receive messages.
    * @return true if TestApi43 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi43 service
...
private:
    ...
    * @param the data received from TestApi43 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi43Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi43 */
