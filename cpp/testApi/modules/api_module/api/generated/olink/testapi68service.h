...
namespace olink {
/**
* Server side for TestApi68 implements the TestApi68 service.
* It is a source of data for TestApi68 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi68Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi68Subscriber
{
public:
    /**
    * ctor
    * @param TestApi68 The service source object, the actual TestApi68 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi68Service(std::shared_ptr<ITestApi68> TestApi68, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi68Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi68 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi68 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi68 object.
    * @return the set of properties with their current values for the TestApi68 object in json format.
    */
...
private:
    /**
    * The TestApi68 used for object source.
    */
    std::shared_ptr<ITestApi68> m_TestApi68;
    /**
