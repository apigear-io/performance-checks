...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi17 publisher in a way it provides access 
* to remote TestApi17 services. 
...
*     It provides a network implementation and tools to connect TestApi17Client to it.
* Use on client side to request changes of the TestApi17 on the server side 
* and to subscribe for the TestApi17 changes.
*/
class CPP_API_EXPORT TestApi17Client : public ITestApi17,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi17Client();
    /** dtor */
    virtual ~TestApi17Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi17 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi17::funcInt on the TestApi17 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi17::funcFloat on the TestApi17 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi17::funcString on the TestApi17 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi17Client is ready to send and receive messages.
    * @return true if TestApi17 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi17 service
...
private:
    ...
    * @param the data received from TestApi17 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi17Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi17 */
