...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi71 publisher in a way it provides access 
* to remote TestApi71 services. 
...
*     It provides a network implementation and tools to connect TestApi71Client to it.
* Use on client side to request changes of the TestApi71 on the server side 
* and to subscribe for the TestApi71 changes.
*/
class CPP_API_EXPORT TestApi71Client : public ITestApi71,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi71Client();
    /** dtor */
    virtual ~TestApi71Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi71 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi71::funcInt on the TestApi71 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi71::funcFloat on the TestApi71 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi71::funcString on the TestApi71 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi71Client is ready to send and receive messages.
    * @return true if TestApi71 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi71 service
...
private:
    ...
    * @param the data received from TestApi71 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi71Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi71 */
