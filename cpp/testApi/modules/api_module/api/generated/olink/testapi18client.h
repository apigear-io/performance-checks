...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi18 publisher in a way it provides access 
* to remote TestApi18 services. 
...
*     It provides a network implementation and tools to connect TestApi18Client to it.
* Use on client side to request changes of the TestApi18 on the server side 
* and to subscribe for the TestApi18 changes.
*/
class CPP_API_EXPORT TestApi18Client : public ITestApi18,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi18Client();
    /** dtor */
    virtual ~TestApi18Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi18 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi18::funcInt on the TestApi18 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi18::funcFloat on the TestApi18 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi18::funcString on the TestApi18 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi18Client is ready to send and receive messages.
    * @return true if TestApi18 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi18 service
...
private:
    ...
    * @param the data received from TestApi18 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi18Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi18 */
