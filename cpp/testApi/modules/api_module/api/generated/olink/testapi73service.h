...
namespace olink {
/**
* Server side for TestApi73 implements the TestApi73 service.
* It is a source of data for TestApi73 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi73Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi73Subscriber
{
public:
    /**
    * ctor
    * @param TestApi73 The service source object, the actual TestApi73 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi73Service(std::shared_ptr<ITestApi73> TestApi73, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi73Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi73 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi73 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi73 object.
    * @return the set of properties with their current values for the TestApi73 object in json format.
    */
...
private:
    /**
    * The TestApi73 used for object source.
    */
    std::shared_ptr<ITestApi73> m_TestApi73;
    /**
