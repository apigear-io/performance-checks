...
namespace olink {
/**
* Server side for TestApi3 implements the TestApi3 service.
* It is a source of data for TestApi3 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi3Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi3Subscriber
{
public:
    /**
    * ctor
    * @param TestApi3 The service source object, the actual TestApi3 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi3Service(std::shared_ptr<ITestApi3> TestApi3, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi3Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi3 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi3 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi3 object.
    * @return the set of properties with their current values for the TestApi3 object in json format.
    */
...
private:
    /**
    * The TestApi3 used for object source.
    */
    std::shared_ptr<ITestApi3> m_TestApi3;
    /**
