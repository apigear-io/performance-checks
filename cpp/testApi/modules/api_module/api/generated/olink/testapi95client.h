...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi95 publisher in a way it provides access 
* to remote TestApi95 services. 
...
*     It provides a network implementation and tools to connect TestApi95Client to it.
* Use on client side to request changes of the TestApi95 on the server side 
* and to subscribe for the TestApi95 changes.
*/
class CPP_API_EXPORT TestApi95Client : public ITestApi95,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi95Client();
    /** dtor */
    virtual ~TestApi95Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi95 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi95::funcInt on the TestApi95 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi95::funcFloat on the TestApi95 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi95::funcString on the TestApi95 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi95Client is ready to send and receive messages.
    * @return true if TestApi95 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi95 service
...
private:
    ...
    * @param the data received from TestApi95 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi95Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi95 */
