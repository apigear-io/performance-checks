...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi38 publisher in a way it provides access 
* to remote TestApi38 services. 
...
*     It provides a network implementation and tools to connect TestApi38Client to it.
* Use on client side to request changes of the TestApi38 on the server side 
* and to subscribe for the TestApi38 changes.
*/
class CPP_API_EXPORT TestApi38Client : public ITestApi38,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi38Client();
    /** dtor */
    virtual ~TestApi38Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi38 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi38::funcInt on the TestApi38 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi38::funcFloat on the TestApi38 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi38::funcString on the TestApi38 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi38Client is ready to send and receive messages.
    * @return true if TestApi38 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi38 service
...
private:
    ...
    * @param the data received from TestApi38 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi38Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi38 */
