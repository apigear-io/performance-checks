...
namespace olink {
/**
* Server side for TestApi27 implements the TestApi27 service.
* It is a source of data for TestApi27 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi27Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi27Subscriber
{
public:
    /**
    * ctor
    * @param TestApi27 The service source object, the actual TestApi27 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi27Service(std::shared_ptr<ITestApi27> TestApi27, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi27Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi27 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi27 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi27 object.
    * @return the set of properties with their current values for the TestApi27 object in json format.
    */
...
private:
    /**
    * The TestApi27 used for object source.
    */
    std::shared_ptr<ITestApi27> m_TestApi27;
    /**
