...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi29 publisher in a way it provides access 
* to remote TestApi29 services. 
...
*     It provides a network implementation and tools to connect TestApi29Client to it.
* Use on client side to request changes of the TestApi29 on the server side 
* and to subscribe for the TestApi29 changes.
*/
class CPP_API_EXPORT TestApi29Client : public ITestApi29,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi29Client();
    /** dtor */
    virtual ~TestApi29Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi29 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi29::funcInt on the TestApi29 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi29::funcFloat on the TestApi29 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi29::funcString on the TestApi29 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi29Client is ready to send and receive messages.
    * @return true if TestApi29 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi29 service
...
private:
    ...
    * @param the data received from TestApi29 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi29Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi29 */
