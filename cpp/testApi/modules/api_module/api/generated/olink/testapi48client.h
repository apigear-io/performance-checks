...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi48 publisher in a way it provides access 
* to remote TestApi48 services. 
...
*     It provides a network implementation and tools to connect TestApi48Client to it.
* Use on client side to request changes of the TestApi48 on the server side 
* and to subscribe for the TestApi48 changes.
*/
class CPP_API_EXPORT TestApi48Client : public ITestApi48,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi48Client();
    /** dtor */
    virtual ~TestApi48Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi48 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi48::funcInt on the TestApi48 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi48::funcFloat on the TestApi48 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi48::funcString on the TestApi48 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi48Client is ready to send and receive messages.
    * @return true if TestApi48 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi48 service
...
private:
    ...
    * @param the data received from TestApi48 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi48Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi48 */
