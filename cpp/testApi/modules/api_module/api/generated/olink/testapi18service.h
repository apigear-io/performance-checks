...
namespace olink {
/**
* Server side for TestApi18 implements the TestApi18 service.
* It is a source of data for TestApi18 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi18Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi18Subscriber
{
public:
    /**
    * ctor
    * @param TestApi18 The service source object, the actual TestApi18 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi18Service(std::shared_ptr<ITestApi18> TestApi18, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi18Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi18 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi18 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi18 object.
    * @return the set of properties with their current values for the TestApi18 object in json format.
    */
...
private:
    /**
    * The TestApi18 used for object source.
    */
    std::shared_ptr<ITestApi18> m_TestApi18;
    /**
