...
namespace olink {
/**
* Server side for TestApi59 implements the TestApi59 service.
* It is a source of data for TestApi59 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi59Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi59Subscriber
{
public:
    /**
    * ctor
    * @param TestApi59 The service source object, the actual TestApi59 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi59Service(std::shared_ptr<ITestApi59> TestApi59, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi59Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi59 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi59 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi59 object.
    * @return the set of properties with their current values for the TestApi59 object in json format.
    */
...
private:
    /**
    * The TestApi59 used for object source.
    */
    std::shared_ptr<ITestApi59> m_TestApi59;
    /**
