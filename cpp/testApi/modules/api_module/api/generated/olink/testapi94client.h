...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi94 publisher in a way it provides access 
* to remote TestApi94 services. 
...
*     It provides a network implementation and tools to connect TestApi94Client to it.
* Use on client side to request changes of the TestApi94 on the server side 
* and to subscribe for the TestApi94 changes.
*/
class CPP_API_EXPORT TestApi94Client : public ITestApi94,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi94Client();
    /** dtor */
    virtual ~TestApi94Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi94 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi94::funcInt on the TestApi94 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi94::funcFloat on the TestApi94 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi94::funcString on the TestApi94 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi94Client is ready to send and receive messages.
    * @return true if TestApi94 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi94 service
...
private:
    ...
    * @param the data received from TestApi94 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi94Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi94 */
