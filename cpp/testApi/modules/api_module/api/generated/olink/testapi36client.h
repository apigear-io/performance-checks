...
#include "api/generated/core/testapi36.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi36 publisher in a way it provides access 
* to remote TestApi36 services. 
...
*     It provides a network implementation and tools to connect TestApi36Client to it.
* Use on client side to request changes of the TestApi36 on the server side 
* and to subscribe for the TestApi36 changes.
*/
class CPP_API_EXPORT TestApi36Client : public ITestApi36,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi36Client();
    /** dtor */
    virtual ~TestApi36Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi36 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi36::funcInt on the TestApi36 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi36::funcFloat on the TestApi36 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi36::funcString on the TestApi36 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi36Client is ready to send and receive messages.
    * @return true if TestApi36 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi36 service
...
private:
    ...
    * @param the data received from TestApi36 service.
    */
    ...
    TestApi36Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi36Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi36 */
    std::unique_ptr<ITestApi36Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
