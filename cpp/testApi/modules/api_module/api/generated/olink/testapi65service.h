...
namespace olink {
/**
* Server side for TestApi65 implements the TestApi65 service.
* It is a source of data for TestApi65 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi65Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi65Subscriber
{
public:
    /**
    * ctor
    * @param TestApi65 The service source object, the actual TestApi65 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi65Service(std::shared_ptr<ITestApi65> TestApi65, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi65Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi65 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi65 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi65 object.
    * @return the set of properties with their current values for the TestApi65 object in json format.
    */
...
private:
    /**
    * The TestApi65 used for object source.
    */
    std::shared_ptr<ITestApi65> m_TestApi65;
    /**
