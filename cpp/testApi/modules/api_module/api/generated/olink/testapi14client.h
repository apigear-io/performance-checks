...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi14 publisher in a way it provides access 
* to remote TestApi14 services. 
...
*     It provides a network implementation and tools to connect TestApi14Client to it.
* Use on client side to request changes of the TestApi14 on the server side 
* and to subscribe for the TestApi14 changes.
*/
class CPP_API_EXPORT TestApi14Client : public ITestApi14,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi14Client();
    /** dtor */
    virtual ~TestApi14Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi14 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi14::funcInt on the TestApi14 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi14::funcFloat on the TestApi14 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi14::funcString on the TestApi14 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi14Client is ready to send and receive messages.
    * @return true if TestApi14 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi14 service
...
private:
    ...
    * @param the data received from TestApi14 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi14Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi14 */
