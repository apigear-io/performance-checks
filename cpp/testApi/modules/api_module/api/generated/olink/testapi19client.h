...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi19 publisher in a way it provides access 
* to remote TestApi19 services. 
...
*     It provides a network implementation and tools to connect TestApi19Client to it.
* Use on client side to request changes of the TestApi19 on the server side 
* and to subscribe for the TestApi19 changes.
*/
class CPP_API_EXPORT TestApi19Client : public ITestApi19,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi19Client();
    /** dtor */
    virtual ~TestApi19Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi19 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi19::funcInt on the TestApi19 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi19::funcFloat on the TestApi19 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi19::funcString on the TestApi19 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi19Client is ready to send and receive messages.
    * @return true if TestApi19 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi19 service
...
private:
    ...
    * @param the data received from TestApi19 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi19Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi19 */
