...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi22 publisher in a way it provides access 
* to remote TestApi22 services. 
...
*     It provides a network implementation and tools to connect TestApi22Client to it.
* Use on client side to request changes of the TestApi22 on the server side 
* and to subscribe for the TestApi22 changes.
*/
class CPP_API_EXPORT TestApi22Client : public ITestApi22,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi22Client();
    /** dtor */
    virtual ~TestApi22Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi22 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi22::funcInt on the TestApi22 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi22::funcFloat on the TestApi22 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi22::funcString on the TestApi22 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi22Client is ready to send and receive messages.
    * @return true if TestApi22 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi22 service
...
private:
    ...
    * @param the data received from TestApi22 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi22Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi22 */
