...
#include "api/generated/core/testapi55.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi55 publisher in a way it provides access 
* to remote TestApi55 services. 
...
*     It provides a network implementation and tools to connect TestApi55Client to it.
* Use on client side to request changes of the TestApi55 on the server side 
* and to subscribe for the TestApi55 changes.
*/
class CPP_API_EXPORT TestApi55Client : public ITestApi55,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi55Client();
    /** dtor */
    virtual ~TestApi55Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi55 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi55::funcInt on the TestApi55 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi55::funcFloat on the TestApi55 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi55::funcString on the TestApi55 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi55Client is ready to send and receive messages.
    * @return true if TestApi55 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi55 service
...
private:
    ...
    * @param the data received from TestApi55 service.
    */
    ...
    TestApi55Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi55Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi55 */
    std::unique_ptr<ITestApi55Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
