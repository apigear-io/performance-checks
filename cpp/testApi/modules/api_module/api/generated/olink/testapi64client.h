...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi64 publisher in a way it provides access 
* to remote TestApi64 services. 
...
*     It provides a network implementation and tools to connect TestApi64Client to it.
* Use on client side to request changes of the TestApi64 on the server side 
* and to subscribe for the TestApi64 changes.
*/
class CPP_API_EXPORT TestApi64Client : public ITestApi64,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi64Client();
    /** dtor */
    virtual ~TestApi64Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi64 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi64::funcInt on the TestApi64 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi64::funcFloat on the TestApi64 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi64::funcString on the TestApi64 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi64Client is ready to send and receive messages.
    * @return true if TestApi64 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi64 service
...
private:
    ...
    * @param the data received from TestApi64 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi64Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi64 */
