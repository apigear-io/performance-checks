...
namespace olink {
/**
* Server side for TestApi14 implements the TestApi14 service.
* It is a source of data for TestApi14 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi14Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi14Subscriber
{
public:
    /**
    * ctor
    * @param TestApi14 The service source object, the actual TestApi14 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi14Service(std::shared_ptr<ITestApi14> TestApi14, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi14Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi14 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi14 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi14 object.
    * @return the set of properties with their current values for the TestApi14 object in json format.
    */
...
private:
    /**
    * The TestApi14 used for object source.
    */
    std::shared_ptr<ITestApi14> m_TestApi14;
    /**
