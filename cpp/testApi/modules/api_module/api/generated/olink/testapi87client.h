...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi87 publisher in a way it provides access 
* to remote TestApi87 services. 
...
*     It provides a network implementation and tools to connect TestApi87Client to it.
* Use on client side to request changes of the TestApi87 on the server side 
* and to subscribe for the TestApi87 changes.
*/
class CPP_API_EXPORT TestApi87Client : public ITestApi87,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi87Client();
    /** dtor */
    virtual ~TestApi87Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Informs if the TestApi87Client is ready to send and receive messages.
    * @return true if TestApi87 is operable, false otherwise.
    */
    bool isReady() const;
...
private:
    ...
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi87Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi87 */
