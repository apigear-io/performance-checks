...
namespace olink {
/**
* Server side for TestApi16 implements the TestApi16 service.
* It is a source of data for TestApi16 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi16Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi16Subscriber
{
public:
    /**
    * ctor
    * @param TestApi16 The service source object, the actual TestApi16 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi16Service(std::shared_ptr<ITestApi16> TestApi16, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi16Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi16 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi16 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi16 object.
    * @return the set of properties with their current values for the TestApi16 object in json format.
    */
...
private:
    /**
    * The TestApi16 used for object source.
    */
    std::shared_ptr<ITestApi16> m_TestApi16;
    /**
