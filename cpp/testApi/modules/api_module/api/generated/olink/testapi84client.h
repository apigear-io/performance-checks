...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi84 publisher in a way it provides access 
* to remote TestApi84 services. 
...
*     It provides a network implementation and tools to connect TestApi84Client to it.
* Use on client side to request changes of the TestApi84 on the server side 
* and to subscribe for the TestApi84 changes.
*/
class CPP_API_EXPORT TestApi84Client : public ITestApi84,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi84Client();
    /** dtor */
    virtual ~TestApi84Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi84 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi84::funcInt on the TestApi84 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi84::funcFloat on the TestApi84 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi84::funcString on the TestApi84 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi84Client is ready to send and receive messages.
    * @return true if TestApi84 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi84 service
...
private:
    ...
    * @param the data received from TestApi84 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi84Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi84 */
