...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi37 publisher in a way it provides access 
* to remote TestApi37 services. 
...
*     It provides a network implementation and tools to connect TestApi37Client to it.
* Use on client side to request changes of the TestApi37 on the server side 
* and to subscribe for the TestApi37 changes.
*/
class CPP_API_EXPORT TestApi37Client : public ITestApi37,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi37Client();
    /** dtor */
    virtual ~TestApi37Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi37 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi37::funcInt on the TestApi37 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi37::funcFloat on the TestApi37 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi37::funcString on the TestApi37 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi37Client is ready to send and receive messages.
    * @return true if TestApi37 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi37 service
...
private:
    ...
    * @param the data received from TestApi37 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi37Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi37 */
