...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi51 publisher in a way it provides access 
* to remote TestApi51 services. 
...
*     It provides a network implementation and tools to connect TestApi51Client to it.
* Use on client side to request changes of the TestApi51 on the server side 
* and to subscribe for the TestApi51 changes.
*/
class CPP_API_EXPORT TestApi51Client : public ITestApi51,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi51Client();
    /** dtor */
    virtual ~TestApi51Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi51 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi51::funcInt on the TestApi51 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi51::funcFloat on the TestApi51 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi51::funcString on the TestApi51 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi51Client is ready to send and receive messages.
    * @return true if TestApi51 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi51 service
...
private:
    ...
    * @param the data received from TestApi51 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi51Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi51 */
