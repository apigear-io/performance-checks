...
namespace olink {
/**
* Server side for TestApi38 implements the TestApi38 service.
* It is a source of data for TestApi38 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi38Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi38Subscriber
{
public:
    /**
    * ctor
    * @param TestApi38 The service source object, the actual TestApi38 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi38Service(std::shared_ptr<ITestApi38> TestApi38, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi38Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi38 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi38 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi38 object.
    * @return the set of properties with their current values for the TestApi38 object in json format.
    */
...
private:
    /**
    * The TestApi38 used for object source.
    */
    std::shared_ptr<ITestApi38> m_TestApi38;
    /**
