...
namespace olink {
/**
* Server side for TestApi88 implements the TestApi88 service.
* It is a source of data for TestApi88 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi88Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi88Subscriber
{
public:
    /**
    * ctor
    * @param TestApi88 The service source object, the actual TestApi88 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi88Service(std::shared_ptr<ITestApi88> TestApi88, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi88Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi88 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi88 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi88 object.
    * @return the set of properties with their current values for the TestApi88 object in json format.
    */
...
private:
    /**
    * The TestApi88 used for object source.
    */
    std::shared_ptr<ITestApi88> m_TestApi88;
    /**
