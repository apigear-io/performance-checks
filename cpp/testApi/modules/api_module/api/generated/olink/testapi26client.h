...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi26 publisher in a way it provides access 
* to remote TestApi26 services. 
...
*     It provides a network implementation and tools to connect TestApi26Client to it.
* Use on client side to request changes of the TestApi26 on the server side 
* and to subscribe for the TestApi26 changes.
*/
class CPP_API_EXPORT TestApi26Client : public ITestApi26,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi26Client();
    /** dtor */
    virtual ~TestApi26Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi26 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi26::funcInt on the TestApi26 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi26::funcFloat on the TestApi26 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi26::funcString on the TestApi26 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi26Client is ready to send and receive messages.
    * @return true if TestApi26 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi26 service
...
private:
    ...
    * @param the data received from TestApi26 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi26Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi26 */
