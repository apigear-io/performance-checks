...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi24 publisher in a way it provides access 
* to remote TestApi24 services. 
...
*     It provides a network implementation and tools to connect TestApi24Client to it.
* Use on client side to request changes of the TestApi24 on the server side 
* and to subscribe for the TestApi24 changes.
*/
class CPP_API_EXPORT TestApi24Client : public ITestApi24,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi24Client();
    /** dtor */
    virtual ~TestApi24Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi24 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi24::funcInt on the TestApi24 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi24::funcFloat on the TestApi24 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi24::funcString on the TestApi24 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi24Client is ready to send and receive messages.
    * @return true if TestApi24 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi24 service
...
private:
    ...
    * @param the data received from TestApi24 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi24Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi24 */
