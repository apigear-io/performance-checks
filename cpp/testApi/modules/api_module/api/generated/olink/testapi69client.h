...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi69 publisher in a way it provides access 
* to remote TestApi69 services. 
...
*     It provides a network implementation and tools to connect TestApi69Client to it.
* Use on client side to request changes of the TestApi69 on the server side 
* and to subscribe for the TestApi69 changes.
*/
class CPP_API_EXPORT TestApi69Client : public ITestApi69,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi69Client();
    /** dtor */
    virtual ~TestApi69Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi69 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi69::funcInt on the TestApi69 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi69::funcFloat on the TestApi69 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi69::funcString on the TestApi69 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi69Client is ready to send and receive messages.
    * @return true if TestApi69 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi69 service
...
private:
    ...
    * @param the data received from TestApi69 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi69Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi69 */
