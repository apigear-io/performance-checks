...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi11 publisher in a way it provides access 
* to remote TestApi11 services. 
...
*     It provides a network implementation and tools to connect TestApi11Client to it.
* Use on client side to request changes of the TestApi11 on the server side 
* and to subscribe for the TestApi11 changes.
*/
class CPP_API_EXPORT TestApi11Client : public ITestApi11,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi11Client();
    /** dtor */
    virtual ~TestApi11Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi11 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi11::funcInt on the TestApi11 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi11::funcFloat on the TestApi11 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi11::funcString on the TestApi11 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi11Client is ready to send and receive messages.
    * @return true if TestApi11 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi11 service
...
private:
    ...
    * @param the data received from TestApi11 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi11Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi11 */
