...
namespace olink {
/**
* Server side for TestApi12 implements the TestApi12 service.
* It is a source of data for TestApi12 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi12Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi12Subscriber
{
public:
    /**
    * ctor
    * @param TestApi12 The service source object, the actual TestApi12 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi12Service(std::shared_ptr<ITestApi12> TestApi12, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi12Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi12 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi12 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi12 object.
    * @return the set of properties with their current values for the TestApi12 object in json format.
    */
...
private:
    /**
    * The TestApi12 used for object source.
    */
    std::shared_ptr<ITestApi12> m_TestApi12;
    /**
