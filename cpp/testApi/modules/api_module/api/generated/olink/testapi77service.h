...
namespace olink {
/**
* Server side for TestApi77 implements the TestApi77 service.
* It is a source of data for TestApi77 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi77Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi77Subscriber
{
public:
    /**
    * ctor
    * @param TestApi77 The service source object, the actual TestApi77 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi77Service(std::shared_ptr<ITestApi77> TestApi77, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi77Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi77 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi77 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi77 object.
    * @return the set of properties with their current values for the TestApi77 object in json format.
    */
...
private:
    /**
    * The TestApi77 used for object source.
    */
    std::shared_ptr<ITestApi77> m_TestApi77;
    /**
