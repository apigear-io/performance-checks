...
namespace olink {
/**
* Server side for TestApi17 implements the TestApi17 service.
* It is a source of data for TestApi17 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi17Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi17Subscriber
{
public:
    /**
    * ctor
    * @param TestApi17 The service source object, the actual TestApi17 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi17Service(std::shared_ptr<ITestApi17> TestApi17, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi17Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi17 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi17 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi17 object.
    * @return the set of properties with their current values for the TestApi17 object in json format.
    */
...
private:
    /**
    * The TestApi17 used for object source.
    */
    std::shared_ptr<ITestApi17> m_TestApi17;
    /**
