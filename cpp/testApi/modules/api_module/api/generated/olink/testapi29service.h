...
namespace olink {
/**
* Server side for TestApi29 implements the TestApi29 service.
* It is a source of data for TestApi29 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi29Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi29Subscriber
{
public:
    /**
    * ctor
    * @param TestApi29 The service source object, the actual TestApi29 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi29Service(std::shared_ptr<ITestApi29> TestApi29, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi29Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi29 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi29 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi29 object.
    * @return the set of properties with their current values for the TestApi29 object in json format.
    */
...
private:
    /**
    * The TestApi29 used for object source.
    */
    std::shared_ptr<ITestApi29> m_TestApi29;
    /**
