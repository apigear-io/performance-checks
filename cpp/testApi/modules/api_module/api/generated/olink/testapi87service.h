...
namespace olink {
/**
* Server side for TestApi87 implements the TestApi87 service.
* It is a source of data for TestApi87 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi87Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi87Subscriber
{
public:
    /**
    * ctor
    * @param TestApi87 The service source object, the actual TestApi87 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi87Service(std::shared_ptr<ITestApi87> TestApi87, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi87Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi87 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi87 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi87 object.
    * @return the set of properties with their current values for the TestApi87 object in json format.
    */
...
private:
    /**
    * The TestApi87 used for object source.
    */
    std::shared_ptr<ITestApi87> m_TestApi87;
    /**
