...
namespace olink {
/**
* Server side for TestApi45 implements the TestApi45 service.
* It is a source of data for TestApi45 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi45Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi45Subscriber
{
public:
    /**
    * ctor
    * @param TestApi45 The service source object, the actual TestApi45 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi45Service(std::shared_ptr<ITestApi45> TestApi45, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi45Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi45 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi45 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi45 object.
    * @return the set of properties with their current values for the TestApi45 object in json format.
    */
...
private:
    /**
    * The TestApi45 used for object source.
    */
    std::shared_ptr<ITestApi45> m_TestApi45;
    /**
