...
namespace olink {
/**
* Server side for TestApi76 implements the TestApi76 service.
* It is a source of data for TestApi76 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi76Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi76Subscriber
{
public:
    /**
    * ctor
    * @param TestApi76 The service source object, the actual TestApi76 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi76Service(std::shared_ptr<ITestApi76> TestApi76, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi76Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi76 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi76 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi76 object.
    * @return the set of properties with their current values for the TestApi76 object in json format.
    */
...
private:
    /**
    * The TestApi76 used for object source.
    */
    std::shared_ptr<ITestApi76> m_TestApi76;
    /**
