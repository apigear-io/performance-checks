...
namespace olink {
/**
* Server side for TestApi33 implements the TestApi33 service.
* It is a source of data for TestApi33 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi33Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi33Subscriber
{
public:
    /**
    * ctor
    * @param TestApi33 The service source object, the actual TestApi33 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi33Service(std::shared_ptr<ITestApi33> TestApi33, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi33Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi33 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi33 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi33 object.
    * @return the set of properties with their current values for the TestApi33 object in json format.
    */
...
private:
    /**
    * The TestApi33 used for object source.
    */
    std::shared_ptr<ITestApi33> m_TestApi33;
    /**
