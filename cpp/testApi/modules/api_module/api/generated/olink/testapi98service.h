...
namespace olink {
/**
* Server side for TestApi98 implements the TestApi98 service.
* It is a source of data for TestApi98 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi98Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi98Subscriber
{
public:
    /**
    * ctor
    * @param TestApi98 The service source object, the actual TestApi98 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi98Service(std::shared_ptr<ITestApi98> TestApi98, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi98Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi98 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi98 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi98 object.
    * @return the set of properties with their current values for the TestApi98 object in json format.
    */
...
private:
    /**
    * The TestApi98 used for object source.
    */
    std::shared_ptr<ITestApi98> m_TestApi98;
    /**
