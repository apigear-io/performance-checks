...
#include "api/generated/core/testapi2.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi2 publisher in a way it provides access 
* to remote TestApi2 services. 
...
*     It provides a network implementation and tools to connect TestApi2Client to it.
* Use on client side to request changes of the TestApi2 on the server side 
* and to subscribe for the TestApi2 changes.
*/
class CPP_API_EXPORT TestApi2Client : public ITestApi2,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi2Client();
    /** dtor */
    virtual ~TestApi2Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi2 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi2::funcInt on the TestApi2 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi2::funcFloat on the TestApi2 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi2::funcString on the TestApi2 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi2Client is ready to send and receive messages.
    * @return true if TestApi2 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi2 service
...
private:
    ...
    * @param the data received from TestApi2 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi2Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi2 */
    std::unique_ptr<ITestApi2Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
