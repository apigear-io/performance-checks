...
namespace olink {
/**
* Server side for TestApi39 implements the TestApi39 service.
* It is a source of data for TestApi39 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi39Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi39Subscriber
{
public:
    /**
    * ctor
    * @param TestApi39 The service source object, the actual TestApi39 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi39Service(std::shared_ptr<ITestApi39> TestApi39, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi39Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi39 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi39 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi39 object.
    * @return the set of properties with their current values for the TestApi39 object in json format.
    */
...
private:
    /**
    * The TestApi39 used for object source.
    */
    std::shared_ptr<ITestApi39> m_TestApi39;
    /**
