...
namespace olink {
/**
* Server side for TestApi28 implements the TestApi28 service.
* It is a source of data for TestApi28 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi28Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi28Subscriber
{
public:
    /**
    * ctor
    * @param TestApi28 The service source object, the actual TestApi28 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi28Service(std::shared_ptr<ITestApi28> TestApi28, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi28Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi28 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi28 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi28 object.
    * @return the set of properties with their current values for the TestApi28 object in json format.
    */
...
private:
    /**
    * The TestApi28 used for object source.
    */
    std::shared_ptr<ITestApi28> m_TestApi28;
    /**
