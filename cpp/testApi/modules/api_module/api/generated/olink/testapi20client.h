...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi20 publisher in a way it provides access 
* to remote TestApi20 services. 
...
*     It provides a network implementation and tools to connect TestApi20Client to it.
* Use on client side to request changes of the TestApi20 on the server side 
* and to subscribe for the TestApi20 changes.
*/
class CPP_API_EXPORT TestApi20Client : public ITestApi20,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi20Client();
    /** dtor */
    virtual ~TestApi20Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi20 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi20::funcInt on the TestApi20 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi20::funcFloat on the TestApi20 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi20::funcString on the TestApi20 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi20Client is ready to send and receive messages.
    * @return true if TestApi20 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi20 service
...
private:
    ...
    * @param the data received from TestApi20 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi20Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi20 */
