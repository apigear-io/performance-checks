...
namespace olink {
/**
* Server side for TestApi9 implements the TestApi9 service.
* It is a source of data for TestApi9 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi9Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi9Subscriber
{
public:
    /**
    * ctor
    * @param TestApi9 The service source object, the actual TestApi9 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi9Service(std::shared_ptr<ITestApi9> TestApi9, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi9Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi9 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi9 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi9 object.
    * @return the set of properties with their current values for the TestApi9 object in json format.
    */
...
private:
    /**
    * The TestApi9 used for object source.
    */
    std::shared_ptr<ITestApi9> m_TestApi9;
    /**
