...
#include "api/generated/core/testapi21.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi21 publisher in a way it provides access 
* to remote TestApi21 services. 
...
*     It provides a network implementation and tools to connect TestApi21Client to it.
* Use on client side to request changes of the TestApi21 on the server side 
* and to subscribe for the TestApi21 changes.
*/
class CPP_API_EXPORT TestApi21Client : public ITestApi21,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi21Client();
    /** dtor */
    virtual ~TestApi21Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi21 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi21::funcInt on the TestApi21 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi21::funcFloat on the TestApi21 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi21::funcString on the TestApi21 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi21Client is ready to send and receive messages.
    * @return true if TestApi21 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi21 service
...
private:
    ...
    * @param the data received from TestApi21 service.
    */
    ...
    TestApi21Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi21Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi21 */
    std::unique_ptr<ITestApi21Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
