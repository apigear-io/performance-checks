...
namespace olink {
/**
* Server side for TestApi99 implements the TestApi99 service.
* It is a source of data for TestApi99 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi99Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi99Subscriber
{
public:
    /**
    * ctor
    * @param TestApi99 The service source object, the actual TestApi99 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi99Service(std::shared_ptr<ITestApi99> TestApi99, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi99Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi99 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi99 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi99 object.
    * @return the set of properties with their current values for the TestApi99 object in json format.
    */
...
private:
    /**
    * The TestApi99 used for object source.
    */
    std::shared_ptr<ITestApi99> m_TestApi99;
    /**
