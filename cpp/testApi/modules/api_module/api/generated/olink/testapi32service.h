...
namespace olink {
/**
* Server side for TestApi32 implements the TestApi32 service.
* It is a source of data for TestApi32 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi32Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi32Subscriber
{
public:
    /**
    * ctor
    * @param TestApi32 The service source object, the actual TestApi32 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi32Service(std::shared_ptr<ITestApi32> TestApi32, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi32Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi32 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi32 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi32 object.
    * @return the set of properties with their current values for the TestApi32 object in json format.
    */
...
private:
    /**
    * The TestApi32 used for object source.
    */
    std::shared_ptr<ITestApi32> m_TestApi32;
    /**
