...
namespace olink {
/**
* Server side for TestApi43 implements the TestApi43 service.
* It is a source of data for TestApi43 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi43Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi43Subscriber
{
public:
    /**
    * ctor
    * @param TestApi43 The service source object, the actual TestApi43 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi43Service(std::shared_ptr<ITestApi43> TestApi43, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi43Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi43 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi43 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi43 object.
    * @return the set of properties with their current values for the TestApi43 object in json format.
    */
...
private:
    /**
    * The TestApi43 used for object source.
    */
    std::shared_ptr<ITestApi43> m_TestApi43;
    /**
