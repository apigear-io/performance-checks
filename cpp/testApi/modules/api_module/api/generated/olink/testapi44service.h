...
namespace olink {
/**
* Server side for TestApi44 implements the TestApi44 service.
* It is a source of data for TestApi44 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi44Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi44Subscriber
{
public:
    /**
    * ctor
    * @param TestApi44 The service source object, the actual TestApi44 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi44Service(std::shared_ptr<ITestApi44> TestApi44, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi44Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi44 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi44 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi44 object.
    * @return the set of properties with their current values for the TestApi44 object in json format.
    */
...
private:
    /**
    * The TestApi44 used for object source.
    */
    std::shared_ptr<ITestApi44> m_TestApi44;
    /**
