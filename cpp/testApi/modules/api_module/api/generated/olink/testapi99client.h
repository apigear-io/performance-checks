...
#include "api/generated/core/testapi99.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi99 publisher in a way it provides access 
* to remote TestApi99 services. 
...
*     It provides a network implementation and tools to connect TestApi99Client to it.
* Use on client side to request changes of the TestApi99 on the server side 
* and to subscribe for the TestApi99 changes.
*/
class CPP_API_EXPORT TestApi99Client : public ITestApi99,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi99Client();
    /** dtor */
    virtual ~TestApi99Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi99 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi99::funcInt on the TestApi99 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi99::funcFloat on the TestApi99 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi99::funcString on the TestApi99 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi99Client is ready to send and receive messages.
    * @return true if TestApi99 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi99 service
...
private:
    ...
    * @param the data received from TestApi99 service.
    */
    ...
    TestApi99Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi99Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi99 */
    std::unique_ptr<ITestApi99Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
