...
namespace olink {
/**
* Server side for TestApi5 implements the TestApi5 service.
* It is a source of data for TestApi5 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi5Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi5Subscriber
{
public:
    /**
    * ctor
    * @param TestApi5 The service source object, the actual TestApi5 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi5Service(std::shared_ptr<ITestApi5> TestApi5, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi5Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi5 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi5 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi5 object.
    * @return the set of properties with their current values for the TestApi5 object in json format.
    */
...
private:
    /**
    * The TestApi5 used for object source.
    */
    std::shared_ptr<ITestApi5> m_TestApi5;
    /**
