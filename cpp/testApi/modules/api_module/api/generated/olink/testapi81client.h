...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi81 publisher in a way it provides access 
* to remote TestApi81 services. 
...
*     It provides a network implementation and tools to connect TestApi81Client to it.
* Use on client side to request changes of the TestApi81 on the server side 
* and to subscribe for the TestApi81 changes.
*/
class CPP_API_EXPORT TestApi81Client : public ITestApi81,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi81Client();
    /** dtor */
    virtual ~TestApi81Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi81 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi81::funcInt on the TestApi81 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi81::funcFloat on the TestApi81 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi81::funcString on the TestApi81 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi81Client is ready to send and receive messages.
    * @return true if TestApi81 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi81 service
...
private:
    ...
    * @param the data received from TestApi81 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi81Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi81 */
