...
namespace olink {
/**
* Server side for TestApi95 implements the TestApi95 service.
* It is a source of data for TestApi95 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi95Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi95Subscriber
{
public:
    /**
    * ctor
    * @param TestApi95 The service source object, the actual TestApi95 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi95Service(std::shared_ptr<ITestApi95> TestApi95, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi95Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi95 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi95 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi95 object.
    * @return the set of properties with their current values for the TestApi95 object in json format.
    */
...
private:
    /**
    * The TestApi95 used for object source.
    */
    std::shared_ptr<ITestApi95> m_TestApi95;
    /**
