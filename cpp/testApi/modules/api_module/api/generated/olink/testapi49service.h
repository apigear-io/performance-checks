...
namespace olink {
/**
* Server side for TestApi49 implements the TestApi49 service.
* It is a source of data for TestApi49 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi49Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi49Subscriber
{
public:
    /**
    * ctor
    * @param TestApi49 The service source object, the actual TestApi49 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi49Service(std::shared_ptr<ITestApi49> TestApi49, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi49Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi49 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi49 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi49 object.
    * @return the set of properties with their current values for the TestApi49 object in json format.
    */
...
private:
    /**
    * The TestApi49 used for object source.
    */
    std::shared_ptr<ITestApi49> m_TestApi49;
    /**
