...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi67 publisher in a way it provides access 
* to remote TestApi67 services. 
...
*     It provides a network implementation and tools to connect TestApi67Client to it.
* Use on client side to request changes of the TestApi67 on the server side 
* and to subscribe for the TestApi67 changes.
*/
class CPP_API_EXPORT TestApi67Client : public ITestApi67,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi67Client();
    /** dtor */
    virtual ~TestApi67Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi67 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi67::funcInt on the TestApi67 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi67::funcFloat on the TestApi67 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi67::funcString on the TestApi67 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi67Client is ready to send and receive messages.
    * @return true if TestApi67 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi67 service
...
private:
    ...
    * @param the data received from TestApi67 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi67Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi67 */
