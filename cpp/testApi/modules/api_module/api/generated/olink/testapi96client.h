...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi96 publisher in a way it provides access 
* to remote TestApi96 services. 
...
*     It provides a network implementation and tools to connect TestApi96Client to it.
* Use on client side to request changes of the TestApi96 on the server side 
* and to subscribe for the TestApi96 changes.
*/
class CPP_API_EXPORT TestApi96Client : public ITestApi96,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi96Client();
    /** dtor */
    virtual ~TestApi96Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi96 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi96::funcInt on the TestApi96 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi96::funcFloat on the TestApi96 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi96::funcString on the TestApi96 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi96Client is ready to send and receive messages.
    * @return true if TestApi96 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi96 service
...
private:
    ...
    * @param the data received from TestApi96 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi96Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi96 */
