...
namespace olink {
/**
* Server side for TestApi21 implements the TestApi21 service.
* It is a source of data for TestApi21 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi21Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi21Subscriber
{
public:
    /**
    * ctor
    * @param TestApi21 The service source object, the actual TestApi21 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi21Service(std::shared_ptr<ITestApi21> TestApi21, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi21Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi21 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi21 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi21 object.
    * @return the set of properties with their current values for the TestApi21 object in json format.
    */
...
private:
    /**
    * The TestApi21 used for object source.
    */
    std::shared_ptr<ITestApi21> m_TestApi21;
    /**
