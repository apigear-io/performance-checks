...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi75 publisher in a way it provides access 
* to remote TestApi75 services. 
...
*     It provides a network implementation and tools to connect TestApi75Client to it.
* Use on client side to request changes of the TestApi75 on the server side 
* and to subscribe for the TestApi75 changes.
*/
class CPP_API_EXPORT TestApi75Client : public ITestApi75,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi75Client();
    /** dtor */
    virtual ~TestApi75Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi75 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi75::funcInt on the TestApi75 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi75::funcFloat on the TestApi75 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi75::funcString on the TestApi75 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi75Client is ready to send and receive messages.
    * @return true if TestApi75 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi75 service
...
private:
    ...
    * @param the data received from TestApi75 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi75Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi75 */
