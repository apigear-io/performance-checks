...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi3 publisher in a way it provides access 
* to remote TestApi3 services. 
...
*     It provides a network implementation and tools to connect TestApi3Client to it.
* Use on client side to request changes of the TestApi3 on the server side 
* and to subscribe for the TestApi3 changes.
*/
class CPP_API_EXPORT TestApi3Client : public ITestApi3,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi3Client();
    /** dtor */
    virtual ~TestApi3Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi3 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi3::funcInt on the TestApi3 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi3::funcFloat on the TestApi3 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi3::funcString on the TestApi3 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi3Client is ready to send and receive messages.
    * @return true if TestApi3 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi3 service
...
private:
    ...
    * @param the data received from TestApi3 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi3Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi3 */
