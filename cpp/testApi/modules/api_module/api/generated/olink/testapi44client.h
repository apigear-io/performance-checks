...
#include "api/generated/core/testapi44.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi44 publisher in a way it provides access 
* to remote TestApi44 services. 
...
*     It provides a network implementation and tools to connect TestApi44Client to it.
* Use on client side to request changes of the TestApi44 on the server side 
* and to subscribe for the TestApi44 changes.
*/
class CPP_API_EXPORT TestApi44Client : public ITestApi44,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi44Client();
    /** dtor */
    virtual ~TestApi44Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi44 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi44::funcInt on the TestApi44 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi44::funcFloat on the TestApi44 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi44::funcString on the TestApi44 service.
    ...
    */
    ...
    ITestApi44Publisher& _getPublisher() const override;
    
    /**
    * Informs if the TestApi44Client is ready to send and receive messages.
    * @return true if TestApi44 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi44 service
...
private:
    ...
    * @param the data received from TestApi44 service.
    */
    ...
    TestApi44Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi44Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi44 */
    std::unique_ptr<ITestApi44Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
