...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi82 publisher in a way it provides access 
* to remote TestApi82 services. 
...
*     It provides a network implementation and tools to connect TestApi82Client to it.
* Use on client side to request changes of the TestApi82 on the server side 
* and to subscribe for the TestApi82 changes.
*/
class CPP_API_EXPORT TestApi82Client : public ITestApi82,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi82Client();
    /** dtor */
    virtual ~TestApi82Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi82 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi82::funcInt on the TestApi82 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi82::funcFloat on the TestApi82 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi82::funcString on the TestApi82 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi82Client is ready to send and receive messages.
    * @return true if TestApi82 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi82 service
...
private:
    ...
    * @param the data received from TestApi82 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi82Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi82 */
