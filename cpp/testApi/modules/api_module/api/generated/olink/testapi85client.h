...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi85 publisher in a way it provides access 
* to remote TestApi85 services. 
...
*     It provides a network implementation and tools to connect TestApi85Client to it.
* Use on client side to request changes of the TestApi85 on the server side 
* and to subscribe for the TestApi85 changes.
*/
class CPP_API_EXPORT TestApi85Client : public ITestApi85,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi85Client();
    /** dtor */
    virtual ~TestApi85Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi85 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi85::funcInt on the TestApi85 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi85::funcFloat on the TestApi85 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi85::funcString on the TestApi85 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi85Client is ready to send and receive messages.
    * @return true if TestApi85 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi85 service
...
private:
    ...
    * @param the data received from TestApi85 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi85Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi85 */
