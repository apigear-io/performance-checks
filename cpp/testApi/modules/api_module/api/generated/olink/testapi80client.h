...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi80 publisher in a way it provides access 
* to remote TestApi80 services. 
...
*     It provides a network implementation and tools to connect TestApi80Client to it.
* Use on client side to request changes of the TestApi80 on the server side 
* and to subscribe for the TestApi80 changes.
*/
class CPP_API_EXPORT TestApi80Client : public ITestApi80,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi80Client();
    /** dtor */
    virtual ~TestApi80Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi80 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi80::funcInt on the TestApi80 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi80::funcFloat on the TestApi80 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi80::funcString on the TestApi80 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi80Client is ready to send and receive messages.
    * @return true if TestApi80 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi80 service
...
private:
    ...
    * @param the data received from TestApi80 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi80Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi80 */
