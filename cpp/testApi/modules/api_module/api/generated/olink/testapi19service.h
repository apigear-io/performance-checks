...
namespace olink {
/**
* Server side for TestApi19 implements the TestApi19 service.
* It is a source of data for TestApi19 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi19Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi19Subscriber
{
public:
    /**
    * ctor
    * @param TestApi19 The service source object, the actual TestApi19 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi19Service(std::shared_ptr<ITestApi19> TestApi19, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi19Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi19 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi19 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi19 object.
    * @return the set of properties with their current values for the TestApi19 object in json format.
    */
...
private:
    /**
    * The TestApi19 used for object source.
    */
    std::shared_ptr<ITestApi19> m_TestApi19;
    /**
