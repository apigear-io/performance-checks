...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi30 publisher in a way it provides access 
* to remote TestApi30 services. 
...
*     It provides a network implementation and tools to connect TestApi30Client to it.
* Use on client side to request changes of the TestApi30 on the server side 
* and to subscribe for the TestApi30 changes.
*/
class CPP_API_EXPORT TestApi30Client : public ITestApi30,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi30Client();
    /** dtor */
    virtual ~TestApi30Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi30 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi30::funcInt on the TestApi30 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi30::funcFloat on the TestApi30 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi30::funcString on the TestApi30 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi30Client is ready to send and receive messages.
    * @return true if TestApi30 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi30 service
...
private:
    ...
    * @param the data received from TestApi30 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi30Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi30 */
