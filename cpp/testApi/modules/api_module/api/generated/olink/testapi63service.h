...
namespace olink {
/**
* Server side for TestApi63 implements the TestApi63 service.
* It is a source of data for TestApi63 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi63Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi63Subscriber
{
public:
    /**
    * ctor
    * @param TestApi63 The service source object, the actual TestApi63 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi63Service(std::shared_ptr<ITestApi63> TestApi63, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi63Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi63 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi63 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi63 object.
    * @return the set of properties with their current values for the TestApi63 object in json format.
    */
...
private:
    /**
    * The TestApi63 used for object source.
    */
    std::shared_ptr<ITestApi63> m_TestApi63;
    /**
