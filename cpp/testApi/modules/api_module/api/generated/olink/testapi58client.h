...
#include "api/generated/core/testapi58.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi58 publisher in a way it provides access 
* to remote TestApi58 services. 
...
*     It provides a network implementation and tools to connect TestApi58Client to it.
* Use on client side to request changes of the TestApi58 on the server side 
* and to subscribe for the TestApi58 changes.
*/
class CPP_API_EXPORT TestApi58Client : public ITestApi58,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi58Client();
    /** dtor */
    virtual ~TestApi58Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi58 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi58::funcInt on the TestApi58 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi58::funcFloat on the TestApi58 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi58::funcString on the TestApi58 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi58Client is ready to send and receive messages.
    * @return true if TestApi58 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi58 service
...
private:
    ...
    * @param the data received from TestApi58 service.
    */
    ...
    TestApi58Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi58Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi58 */
    std::unique_ptr<ITestApi58Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
