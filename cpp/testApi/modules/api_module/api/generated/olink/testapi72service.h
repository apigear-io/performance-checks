...
*/
class CPP_API_EXPORT TestApi72Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi72Subscriber
{
public:
    /**
    * ctor
    ...
    */
    explicit TestApi72Service(std::shared_ptr<ITestApi72> TestApi72, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi72Service() override;
...
private:
    /**
    * The TestApi72 used for object source.
    */
    std::shared_ptr<ITestApi72> m_TestApi72;
    /**
