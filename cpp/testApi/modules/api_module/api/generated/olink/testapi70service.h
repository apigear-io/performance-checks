...
namespace olink {
/**
* Server side for TestApi70 implements the TestApi70 service.
* It is a source of data for TestApi70 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi70Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi70Subscriber
{
public:
    /**
    * ctor
    * @param TestApi70 The service source object, the actual TestApi70 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi70Service(std::shared_ptr<ITestApi70> TestApi70, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi70Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi70 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi70 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi70 object.
    * @return the set of properties with their current values for the TestApi70 object in json format.
    */
...
private:
    /**
    * The TestApi70 used for object source.
    */
    std::shared_ptr<ITestApi70> m_TestApi70;
    /**
