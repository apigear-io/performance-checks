...
namespace olink {
/**
* Server side for TestApi23 implements the TestApi23 service.
* It is a source of data for TestApi23 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi23Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi23Subscriber
{
public:
    /**
    * ctor
    * @param TestApi23 The service source object, the actual TestApi23 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi23Service(std::shared_ptr<ITestApi23> TestApi23, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi23Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi23 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi23 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi23 object.
    * @return the set of properties with their current values for the TestApi23 object in json format.
    */
...
private:
    /**
    * The TestApi23 used for object source.
    */
    std::shared_ptr<ITestApi23> m_TestApi23;
    /**
