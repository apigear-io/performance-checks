...
#include "api/generated/core/testapi59.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi59 publisher in a way it provides access 
* to remote TestApi59 services. 
...
*     It provides a network implementation and tools to connect TestApi59Client to it.
* Use on client side to request changes of the TestApi59 on the server side 
* and to subscribe for the TestApi59 changes.
*/
class CPP_API_EXPORT TestApi59Client : public ITestApi59,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi59Client();
    /** dtor */
    virtual ~TestApi59Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi59 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi59::funcInt on the TestApi59 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi59::funcFloat on the TestApi59 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi59::funcString on the TestApi59 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi59Client is ready to send and receive messages.
    * @return true if TestApi59 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi59 service
...
private:
    ...
    * @param the data received from TestApi59 service.
    */
    ...
    TestApi59Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi59Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi59 */
    std::unique_ptr<ITestApi59Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
