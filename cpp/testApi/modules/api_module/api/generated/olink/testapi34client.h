...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi34 publisher in a way it provides access 
* to remote TestApi34 services. 
...
*     It provides a network implementation and tools to connect TestApi34Client to it.
* Use on client side to request changes of the TestApi34 on the server side 
* and to subscribe for the TestApi34 changes.
*/
class CPP_API_EXPORT TestApi34Client : public ITestApi34,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi34Client();
    /** dtor */
    virtual ~TestApi34Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi34 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi34::funcInt on the TestApi34 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi34::funcFloat on the TestApi34 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi34::funcString on the TestApi34 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi34Client is ready to send and receive messages.
    * @return true if TestApi34 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi34 service
...
private:
    ...
    * @param the data received from TestApi34 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi34Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi34 */
