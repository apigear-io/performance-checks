...
namespace olink {
/**
* Server side for TestApi71 implements the TestApi71 service.
* It is a source of data for TestApi71 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi71Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi71Subscriber
{
public:
    /**
    * ctor
    * @param TestApi71 The service source object, the actual TestApi71 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi71Service(std::shared_ptr<ITestApi71> TestApi71, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi71Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi71 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi71 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi71 object.
    * @return the set of properties with their current values for the TestApi71 object in json format.
    */
...
private:
    /**
    * The TestApi71 used for object source.
    */
    std::shared_ptr<ITestApi71> m_TestApi71;
    /**
