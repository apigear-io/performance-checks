...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi97 publisher in a way it provides access 
* to remote TestApi97 services. 
...
*     It provides a network implementation and tools to connect TestApi97Client to it.
* Use on client side to request changes of the TestApi97 on the server side 
* and to subscribe for the TestApi97 changes.
*/
class CPP_API_EXPORT TestApi97Client : public ITestApi97,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi97Client();
    /** dtor */
    virtual ~TestApi97Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi97 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi97::funcInt on the TestApi97 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi97::funcFloat on the TestApi97 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi97::funcString on the TestApi97 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi97Client is ready to send and receive messages.
    * @return true if TestApi97 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi97 service
...
private:
    ...
    * @param the data received from TestApi97 service.
    */
    ...
    TestApi97Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi97Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi97 */
    std::unique_ptr<ITestApi97Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
