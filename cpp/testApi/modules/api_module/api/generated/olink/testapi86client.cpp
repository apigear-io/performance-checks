...
TestApi86Client::TestApi86Client()
    : m_publisher(std::make_unique<TestApi86Publisher>())
{}

void TestApi86Client::applyState(const nlohmann::json& fields) 
{
...
void TestApi86Client::setPropInt(int propInt)
{
    if(!m_node) {
...
void TestApi86Client::setPropIntLocal(int propInt)
{
...
int TestApi86Client::getPropInt() const
{
    return m_data.m_propInt;
}

void TestApi86Client::setPropFloat(float propFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi86Client::setPropFloatLocal(float propFloat)
{
...
float TestApi86Client::getPropFloat() const
{
    return m_data.m_propFloat;
}

void TestApi86Client::setPropString(const std::string& propString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi86Client::setPropStringLocal(const std::string& propString)
{
...
const std::string& TestApi86Client::getPropString() const
{
    return m_data.m_propString;
}

int TestApi86Client::funcInt(int paramInt)
{
     if(!m_node) {
...
std::future<int> TestApi86Client::funcIntAsync(int paramInt)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
float TestApi86Client::funcFloat(float paramFloat)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return 0.0f;
...
std::future<float> TestApi86Client::funcFloatAsync(float paramFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi86Client::funcString(const std::string& paramString)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return std::string();
...
std::future<std::string> TestApi86Client::funcStringAsync(const std::string& paramString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi86Client::olinkObjectName()
{
    return interfaceId;
}

void TestApi86Client::olinkOnSignal(const std::string& signalId, const nlohmann::json& args)
{
...
void TestApi86Client::olinkOnPropertyChanged(const std::string& propertyId, const nlohmann::json& value)
{
    applyState({ {ApiGear::ObjectLink::Name::getMemberName(propertyId), value} });
}
void TestApi86Client::olinkOnInit(const std::string& /*name*/, const nlohmann::json& props, ApiGear::ObjectLink::IClientNode *node)
{
    m_node = node;
    applyState(props);
}

void TestApi86Client::olinkOnRelease()
{
    m_node = nullptr;
}

bool TestApi86Client::isReady() const
{
    return m_node != nullptr;
}

ITestApi86Publisher& TestApi86Client::_getPublisher() const
{
    return *m_publisher;
}
