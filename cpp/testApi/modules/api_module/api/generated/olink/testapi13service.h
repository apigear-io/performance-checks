...
namespace olink {
/**
* Server side for TestApi13 implements the TestApi13 service.
* It is a source of data for TestApi13 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi13Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi13Subscriber
{
public:
    /**
    * ctor
    * @param TestApi13 The service source object, the actual TestApi13 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi13Service(std::shared_ptr<ITestApi13> TestApi13, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi13Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi13 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi13 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi13 object.
    * @return the set of properties with their current values for the TestApi13 object in json format.
    */
...
private:
    /**
    * The TestApi13 used for object source.
    */
    std::shared_ptr<ITestApi13> m_TestApi13;
    /**
