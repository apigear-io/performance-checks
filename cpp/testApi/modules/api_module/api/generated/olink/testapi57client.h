...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi57 publisher in a way it provides access 
* to remote TestApi57 services. 
...
*     It provides a network implementation and tools to connect TestApi57Client to it.
* Use on client side to request changes of the TestApi57 on the server side 
* and to subscribe for the TestApi57 changes.
*/
class CPP_API_EXPORT TestApi57Client : public ITestApi57,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi57Client();
    /** dtor */
    virtual ~TestApi57Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi57 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi57::funcInt on the TestApi57 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi57::funcFloat on the TestApi57 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi57::funcString on the TestApi57 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi57Client is ready to send and receive messages.
    * @return true if TestApi57 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi57 service
...
private:
    ...
    * @param the data received from TestApi57 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi57Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi57 */
