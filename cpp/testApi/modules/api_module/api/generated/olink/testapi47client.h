...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi47 publisher in a way it provides access 
* to remote TestApi47 services. 
...
*     It provides a network implementation and tools to connect TestApi47Client to it.
* Use on client side to request changes of the TestApi47 on the server side 
* and to subscribe for the TestApi47 changes.
*/
class CPP_API_EXPORT TestApi47Client : public ITestApi47,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi47Client();
    /** dtor */
    virtual ~TestApi47Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi47 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi47::funcInt on the TestApi47 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi47::funcFloat on the TestApi47 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi47::funcString on the TestApi47 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi47Client is ready to send and receive messages.
    * @return true if TestApi47 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi47 service
...
private:
    ...
    * @param the data received from TestApi47 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi47Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi47 */
