...
namespace olink {
/**
* Server side for TestApi74 implements the TestApi74 service.
* It is a source of data for TestApi74 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi74Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi74Subscriber
{
public:
    /**
    * ctor
    * @param TestApi74 The service source object, the actual TestApi74 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi74Service(std::shared_ptr<ITestApi74> TestApi74, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi74Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi74 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi74 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi74 object.
    * @return the set of properties with their current values for the TestApi74 object in json format.
    */
...
private:
    /**
    * The TestApi74 used for object source.
    */
    std::shared_ptr<ITestApi74> m_TestApi74;
    /**
