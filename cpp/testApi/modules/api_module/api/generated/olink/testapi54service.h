...
namespace olink {
/**
* Server side for TestApi54 implements the TestApi54 service.
* It is a source of data for TestApi54 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi54Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi54Subscriber
{
public:
    /**
    * ctor
    * @param TestApi54 The service source object, the actual TestApi54 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi54Service(std::shared_ptr<ITestApi54> TestApi54, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi54Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi54 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi54 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi54 object.
    * @return the set of properties with their current values for the TestApi54 object in json format.
    */
...
private:
    /**
    * The TestApi54 used for object source.
    */
    std::shared_ptr<ITestApi54> m_TestApi54;
    /**
