...
namespace olink {
/**
* Server side for TestApi83 implements the TestApi83 service.
* It is a source of data for TestApi83 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi83Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi83Subscriber
{
public:
    /**
    * ctor
    * @param TestApi83 The service source object, the actual TestApi83 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi83Service(std::shared_ptr<ITestApi83> TestApi83, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi83Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi83 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi83 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi83 object.
    * @return the set of properties with their current values for the TestApi83 object in json format.
    */
...
private:
    /**
    * The TestApi83 used for object source.
    */
    std::shared_ptr<ITestApi83> m_TestApi83;
    /**
