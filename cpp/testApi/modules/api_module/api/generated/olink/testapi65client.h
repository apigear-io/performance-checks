...
#include "api/generated/core/testapi65.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi65 publisher in a way it provides access 
* to remote TestApi65 services. 
...
*     It provides a network implementation and tools to connect TestApi65Client to it.
* Use on client side to request changes of the TestApi65 on the server side 
* and to subscribe for the TestApi65 changes.
*/
class CPP_API_EXPORT TestApi65Client : public ITestApi65,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi65Client();
    /** dtor */
    virtual ~TestApi65Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi65 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi65::funcInt on the TestApi65 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi65::funcFloat on the TestApi65 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi65::funcString on the TestApi65 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi65Client is ready to send and receive messages.
    * @return true if TestApi65 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi65 service
...
private:
    ...
    * @param the data received from TestApi65 service.
    */
    ...
    TestApi65Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi65Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi65 */
    std::unique_ptr<ITestApi65Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
