...
namespace olink {
/**
* Server side for TestApi1 implements the TestApi1 service.
* It is a source of data for TestApi1 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi1Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi1Subscriber
{
public:
    /**
    * ctor
    * @param TestApi1 The service source object, the actual TestApi1 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi1Service(std::shared_ptr<ITestApi1> TestApi1, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi1Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi1 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi1 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi1 object.
    * @return the set of properties with their current values for the TestApi1 object in json format.
    */
...
private:
    /**
    * The TestApi1 used for object source.
    */
    std::shared_ptr<ITestApi1> m_TestApi1;
    /**
