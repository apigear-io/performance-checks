...
namespace olink {
/**
* Server side for TestApi31 implements the TestApi31 service.
* It is a source of data for TestApi31 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi31Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi31Subscriber
{
public:
    /**
    * ctor
    * @param TestApi31 The service source object, the actual TestApi31 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi31Service(std::shared_ptr<ITestApi31> TestApi31, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi31Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi31 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi31 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi31 object.
    * @return the set of properties with their current values for the TestApi31 object in json format.
    */
...
private:
    /**
    * The TestApi31 used for object source.
    */
    std::shared_ptr<ITestApi31> m_TestApi31;
    /**
