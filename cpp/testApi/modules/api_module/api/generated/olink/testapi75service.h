...
namespace olink {
/**
* Server side for TestApi75 implements the TestApi75 service.
* It is a source of data for TestApi75 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi75Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi75Subscriber
{
public:
    /**
    * ctor
    * @param TestApi75 The service source object, the actual TestApi75 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi75Service(std::shared_ptr<ITestApi75> TestApi75, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi75Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi75 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi75 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi75 object.
    * @return the set of properties with their current values for the TestApi75 object in json format.
    */
...
private:
    /**
    * The TestApi75 used for object source.
    */
    std::shared_ptr<ITestApi75> m_TestApi75;
    /**
