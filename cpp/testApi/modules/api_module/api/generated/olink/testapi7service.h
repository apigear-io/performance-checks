...
namespace olink {
/**
* Server side for TestApi7 implements the TestApi7 service.
* It is a source of data for TestApi7 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi7Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi7Subscriber
{
public:
    /**
    * ctor
    * @param TestApi7 The service source object, the actual TestApi7 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi7Service(std::shared_ptr<ITestApi7> TestApi7, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi7Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi7 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi7 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi7 object.
    * @return the set of properties with their current values for the TestApi7 object in json format.
    */
...
private:
    /**
    * The TestApi7 used for object source.
    */
    std::shared_ptr<ITestApi7> m_TestApi7;
    /**
