...
namespace olink {
/**
* Server side for TestApi48 implements the TestApi48 service.
* It is a source of data for TestApi48 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi48Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi48Subscriber
{
public:
    /**
    * ctor
    * @param TestApi48 The service source object, the actual TestApi48 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi48Service(std::shared_ptr<ITestApi48> TestApi48, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi48Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi48 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi48 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi48 object.
    * @return the set of properties with their current values for the TestApi48 object in json format.
    */
...
private:
    /**
    * The TestApi48 used for object source.
    */
    std::shared_ptr<ITestApi48> m_TestApi48;
    /**
