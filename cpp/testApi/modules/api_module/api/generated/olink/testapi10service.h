...
namespace olink {
/**
* Server side for TestApi10 implements the TestApi10 service.
* It is a source of data for TestApi10 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi10Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi10Subscriber
{
public:
    /**
    * ctor
    * @param TestApi10 The service source object, the actual TestApi10 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi10Service(std::shared_ptr<ITestApi10> TestApi10, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi10Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi10 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi10 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi10 object.
    * @return the set of properties with their current values for the TestApi10 object in json format.
    */
...
private:
    /**
    * The TestApi10 used for object source.
    */
    std::shared_ptr<ITestApi10> m_TestApi10;
    /**
