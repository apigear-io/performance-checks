...
namespace olink {
/**
* Server side for TestApi0 implements the TestApi0 service.
* It is a source of data for TestApi0 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi0Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi0Subscriber
{
public:
    /**
    * ctor
    * @param TestApi0 The service source object, the actual TestApi0 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi0Service(std::shared_ptr<ITestApi0> TestApi0, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi0Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi0 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi0 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi0 object.
    * @return the set of properties with their current values for the TestApi0 object in json format.
    */
...
private:
    /**
    * The TestApi0 used for object source.
    */
    std::shared_ptr<ITestApi0> m_TestApi0;
    /**
