...
namespace olink {
/**
* Server side for TestApi53 implements the TestApi53 service.
* It is a source of data for TestApi53 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi53Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi53Subscriber
{
public:
    /**
    * ctor
    * @param TestApi53 The service source object, the actual TestApi53 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi53Service(std::shared_ptr<ITestApi53> TestApi53, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi53Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi53 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi53 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi53 object.
    * @return the set of properties with their current values for the TestApi53 object in json format.
    */
...
private:
    /**
    * The TestApi53 used for object source.
    */
    std::shared_ptr<ITestApi53> m_TestApi53;
    /**
