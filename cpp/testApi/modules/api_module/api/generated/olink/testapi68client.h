...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi68 publisher in a way it provides access 
* to remote TestApi68 services. 
...
*     It provides a network implementation and tools to connect TestApi68Client to it.
* Use on client side to request changes of the TestApi68 on the server side 
* and to subscribe for the TestApi68 changes.
*/
class CPP_API_EXPORT TestApi68Client : public ITestApi68,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi68Client();
    /** dtor */
    virtual ~TestApi68Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi68 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi68::funcInt on the TestApi68 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi68::funcFloat on the TestApi68 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi68::funcString on the TestApi68 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi68Client is ready to send and receive messages.
    * @return true if TestApi68 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi68 service
...
private:
    ...
    * @param the data received from TestApi68 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi68Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi68 */
