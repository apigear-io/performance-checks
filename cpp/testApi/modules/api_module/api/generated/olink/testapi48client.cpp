...
TestApi48Client::TestApi48Client()
    : m_publisher(std::make_unique<TestApi48Publisher>())
{}

void TestApi48Client::applyState(const nlohmann::json& fields) 
{
...
void TestApi48Client::setPropInt(int propInt)
{
    if(!m_node) {
...
void TestApi48Client::setPropIntLocal(int propInt)
{
...
int TestApi48Client::getPropInt() const
{
    return m_data.m_propInt;
}

void TestApi48Client::setPropFloat(float propFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi48Client::setPropFloatLocal(float propFloat)
{
...
float TestApi48Client::getPropFloat() const
{
    return m_data.m_propFloat;
}

void TestApi48Client::setPropString(const std::string& propString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi48Client::setPropStringLocal(const std::string& propString)
{
...
const std::string& TestApi48Client::getPropString() const
{
    return m_data.m_propString;
}

int TestApi48Client::funcInt(int paramInt)
{
     if(!m_node) {
...
std::future<int> TestApi48Client::funcIntAsync(int paramInt)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
float TestApi48Client::funcFloat(float paramFloat)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return 0.0f;
...
std::future<float> TestApi48Client::funcFloatAsync(float paramFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi48Client::funcString(const std::string& paramString)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return std::string();
...
std::future<std::string> TestApi48Client::funcStringAsync(const std::string& paramString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi48Client::olinkObjectName()
{
    return interfaceId;
}

void TestApi48Client::olinkOnSignal(const std::string& signalId, const nlohmann::json& args)
{
...
void TestApi48Client::olinkOnPropertyChanged(const std::string& propertyId, const nlohmann::json& value)
{
    applyState({ {ApiGear::ObjectLink::Name::getMemberName(propertyId), value} });
}
void TestApi48Client::olinkOnInit(const std::string& /*name*/, const nlohmann::json& props, ApiGear::ObjectLink::IClientNode *node)
{
    m_node = node;
    applyState(props);
}

void TestApi48Client::olinkOnRelease()
{
    m_node = nullptr;
}

bool TestApi48Client::isReady() const
{
    return m_node != nullptr;
}

ITestApi48Publisher& TestApi48Client::_getPublisher() const
{
    return *m_publisher;
}
