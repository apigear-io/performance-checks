...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi78 publisher in a way it provides access 
* to remote TestApi78 services. 
...
*     It provides a network implementation and tools to connect TestApi78Client to it.
* Use on client side to request changes of the TestApi78 on the server side 
* and to subscribe for the TestApi78 changes.
*/
class CPP_API_EXPORT TestApi78Client : public ITestApi78,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi78Client();
    /** dtor */
    virtual ~TestApi78Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi78 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi78::funcInt on the TestApi78 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi78::funcFloat on the TestApi78 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi78::funcString on the TestApi78 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi78Client is ready to send and receive messages.
    * @return true if TestApi78 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi78 service
...
private:
    ...
    * @param the data received from TestApi78 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi78Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi78 */
