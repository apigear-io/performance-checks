...
namespace olink {
/**
* Server side for TestApi84 implements the TestApi84 service.
* It is a source of data for TestApi84 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi84Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi84Subscriber
{
public:
    /**
    * ctor
    * @param TestApi84 The service source object, the actual TestApi84 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi84Service(std::shared_ptr<ITestApi84> TestApi84, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi84Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi84 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi84 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi84 object.
    * @return the set of properties with their current values for the TestApi84 object in json format.
    */
...
private:
    /**
    * The TestApi84 used for object source.
    */
    std::shared_ptr<ITestApi84> m_TestApi84;
    /**
