...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi7 publisher in a way it provides access 
* to remote TestApi7 services. 
...
*     It provides a network implementation and tools to connect TestApi7Client to it.
* Use on client side to request changes of the TestApi7 on the server side 
* and to subscribe for the TestApi7 changes.
*/
class CPP_API_EXPORT TestApi7Client : public ITestApi7,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi7Client();
    /** dtor */
    virtual ~TestApi7Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi7 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi7::funcInt on the TestApi7 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi7::funcFloat on the TestApi7 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi7::funcString on the TestApi7 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi7Client is ready to send and receive messages.
    * @return true if TestApi7 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi7 service
...
private:
    ...
    * @param the data received from TestApi7 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi7Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi7 */
