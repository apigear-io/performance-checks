...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi83 publisher in a way it provides access 
* to remote TestApi83 services. 
...
*     It provides a network implementation and tools to connect TestApi83Client to it.
* Use on client side to request changes of the TestApi83 on the server side 
* and to subscribe for the TestApi83 changes.
*/
class CPP_API_EXPORT TestApi83Client : public ITestApi83,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi83Client();
    /** dtor */
    virtual ~TestApi83Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi83 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi83::funcInt on the TestApi83 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi83::funcFloat on the TestApi83 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi83::funcString on the TestApi83 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi83Client is ready to send and receive messages.
    * @return true if TestApi83 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi83 service
...
private:
    ...
    * @param the data received from TestApi83 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi83Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi83 */
