...
namespace olink {
/**
* Server side for TestApi81 implements the TestApi81 service.
* It is a source of data for TestApi81 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi81Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi81Subscriber
{
public:
    /**
    * ctor
    * @param TestApi81 The service source object, the actual TestApi81 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi81Service(std::shared_ptr<ITestApi81> TestApi81, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi81Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi81 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi81 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi81 object.
    * @return the set of properties with their current values for the TestApi81 object in json format.
    */
...
private:
    /**
    * The TestApi81 used for object source.
    */
    std::shared_ptr<ITestApi81> m_TestApi81;
    /**
