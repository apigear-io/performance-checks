...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi4 publisher in a way it provides access 
* to remote TestApi4 services. 
...
*     It provides a network implementation and tools to connect TestApi4Client to it.
* Use on client side to request changes of the TestApi4 on the server side 
* and to subscribe for the TestApi4 changes.
*/
class CPP_API_EXPORT TestApi4Client : public ITestApi4,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi4Client();
    /** dtor */
    virtual ~TestApi4Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi4 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi4::funcInt on the TestApi4 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi4::funcFloat on the TestApi4 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi4::funcString on the TestApi4 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi4Client is ready to send and receive messages.
    * @return true if TestApi4 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi4 service
...
private:
    ...
    * @param the data received from TestApi4 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi4Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi4 */
