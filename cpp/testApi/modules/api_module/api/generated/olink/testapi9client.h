...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi9 publisher in a way it provides access 
* to remote TestApi9 services. 
...
*     It provides a network implementation and tools to connect TestApi9Client to it.
* Use on client side to request changes of the TestApi9 on the server side 
* and to subscribe for the TestApi9 changes.
*/
class CPP_API_EXPORT TestApi9Client : public ITestApi9,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi9Client();
    /** dtor */
    virtual ~TestApi9Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi9 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi9::funcInt on the TestApi9 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi9::funcFloat on the TestApi9 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi9::funcString on the TestApi9 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi9Client is ready to send and receive messages.
    * @return true if TestApi9 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi9 service
...
private:
    ...
    * @param the data received from TestApi9 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi9Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi9 */
