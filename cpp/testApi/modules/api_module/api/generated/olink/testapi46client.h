...
#include "api/generated/core/testapi46.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi46 publisher in a way it provides access 
* to remote TestApi46 services. 
...
*     It provides a network implementation and tools to connect TestApi46Client to it.
* Use on client side to request changes of the TestApi46 on the server side 
* and to subscribe for the TestApi46 changes.
*/
class CPP_API_EXPORT TestApi46Client : public ITestApi46,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi46Client();
    /** dtor */
    virtual ~TestApi46Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi46 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi46::funcInt on the TestApi46 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi46::funcFloat on the TestApi46 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi46::funcString on the TestApi46 service.
    ...
    */
    ...
    ITestApi46Publisher& _getPublisher() const override;
    
    /**
    * Informs if the TestApi46Client is ready to send and receive messages.
    * @return true if TestApi46 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi46 service
...
private:
    ...
    * @param the data received from TestApi46 service.
    */
    ...
    TestApi46Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi46Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi46 */
    std::unique_ptr<ITestApi46Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
