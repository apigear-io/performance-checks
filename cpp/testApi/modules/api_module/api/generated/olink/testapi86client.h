...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi86 publisher in a way it provides access 
* to remote TestApi86 services. 
...
*     It provides a network implementation and tools to connect TestApi86Client to it.
* Use on client side to request changes of the TestApi86 on the server side 
* and to subscribe for the TestApi86 changes.
*/
class CPP_API_EXPORT TestApi86Client : public ITestApi86,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi86Client();
    /** dtor */
    virtual ~TestApi86Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi86 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi86::funcInt on the TestApi86 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi86::funcFloat on the TestApi86 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi86::funcString on the TestApi86 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi86Client is ready to send and receive messages.
    * @return true if TestApi86 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi86 service
...
private:
    ...
    * @param the data received from TestApi86 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi86Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi86 */
