...
#include "api/generated/core/testapi50.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi50 publisher in a way it provides access 
* to remote TestApi50 services. 
...
*     It provides a network implementation and tools to connect TestApi50Client to it.
* Use on client side to request changes of the TestApi50 on the server side 
* and to subscribe for the TestApi50 changes.
*/
class CPP_API_EXPORT TestApi50Client : public ITestApi50,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi50Client();
    /** dtor */
    virtual ~TestApi50Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi50 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi50::funcInt on the TestApi50 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi50::funcFloat on the TestApi50 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi50::funcString on the TestApi50 service.
    ...
    */
    ...
    ITestApi50Publisher& _getPublisher() const override;
    
    /**
    * Informs if the TestApi50Client is ready to send and receive messages.
    * @return true if TestApi50 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi50 service
...
private:
    ...
    * @param the data received from TestApi50 service.
    */
    ...
    TestApi50Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi50Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi50 */
    std::unique_ptr<ITestApi50Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
