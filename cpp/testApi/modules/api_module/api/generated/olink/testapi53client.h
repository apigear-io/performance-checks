...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi53 publisher in a way it provides access 
* to remote TestApi53 services. 
...
*     It provides a network implementation and tools to connect TestApi53Client to it.
* Use on client side to request changes of the TestApi53 on the server side 
* and to subscribe for the TestApi53 changes.
*/
class CPP_API_EXPORT TestApi53Client : public ITestApi53,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi53Client();
    /** dtor */
    virtual ~TestApi53Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi53 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi53::funcInt on the TestApi53 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi53::funcFloat on the TestApi53 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi53::funcString on the TestApi53 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi53Client is ready to send and receive messages.
    * @return true if TestApi53 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi53 service
...
private:
    ...
    * @param the data received from TestApi53 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi53Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi53 */
