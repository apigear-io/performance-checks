...
#include "api/generated/core/testapi93.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi93 publisher in a way it provides access 
* to remote TestApi93 services. 
...
*     It provides a network implementation and tools to connect TestApi93Client to it.
* Use on client side to request changes of the TestApi93 on the server side 
* and to subscribe for the TestApi93 changes.
*/
class CPP_API_EXPORT TestApi93Client : public ITestApi93,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi93Client();
    /** dtor */
    virtual ~TestApi93Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi93 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi93::funcInt on the TestApi93 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi93::funcFloat on the TestApi93 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi93::funcString on the TestApi93 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi93Client is ready to send and receive messages.
    * @return true if TestApi93 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi93 service
...
private:
    ...
    * @param the data received from TestApi93 service.
    */
    ...
    TestApi93Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi93Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi93 */
    std::unique_ptr<ITestApi93Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
