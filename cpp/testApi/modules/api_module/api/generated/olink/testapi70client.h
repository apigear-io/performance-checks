...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi70 publisher in a way it provides access 
* to remote TestApi70 services. 
...
*     It provides a network implementation and tools to connect TestApi70Client to it.
* Use on client side to request changes of the TestApi70 on the server side 
* and to subscribe for the TestApi70 changes.
*/
class CPP_API_EXPORT TestApi70Client : public ITestApi70,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi70Client();
    /** dtor */
    virtual ~TestApi70Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi70 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi70::funcInt on the TestApi70 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi70::funcFloat on the TestApi70 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi70::funcString on the TestApi70 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi70Client is ready to send and receive messages.
    * @return true if TestApi70 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi70 service
...
private:
    ...
    * @param the data received from TestApi70 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi70Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi70 */
