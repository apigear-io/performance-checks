...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi73 publisher in a way it provides access 
* to remote TestApi73 services. 
...
*     It provides a network implementation and tools to connect TestApi73Client to it.
* Use on client side to request changes of the TestApi73 on the server side 
* and to subscribe for the TestApi73 changes.
*/
class CPP_API_EXPORT TestApi73Client : public ITestApi73,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi73Client();
    /** dtor */
    virtual ~TestApi73Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi73 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi73::funcInt on the TestApi73 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi73::funcFloat on the TestApi73 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi73::funcString on the TestApi73 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi73Client is ready to send and receive messages.
    * @return true if TestApi73 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi73 service
...
private:
    ...
    * @param the data received from TestApi73 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi73Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi73 */
