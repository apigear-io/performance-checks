...
namespace olink {
/**
* Server side for TestApi62 implements the TestApi62 service.
* It is a source of data for TestApi62 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi62Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi62Subscriber
{
public:
    /**
    * ctor
    * @param TestApi62 The service source object, the actual TestApi62 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi62Service(std::shared_ptr<ITestApi62> TestApi62, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi62Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi62 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi62 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi62 object.
    * @return the set of properties with their current values for the TestApi62 object in json format.
    */
...
private:
    /**
    * The TestApi62 used for object source.
    */
    std::shared_ptr<ITestApi62> m_TestApi62;
    /**
