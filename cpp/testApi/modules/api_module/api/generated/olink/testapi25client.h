...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi25 publisher in a way it provides access 
* to remote TestApi25 services. 
...
*     It provides a network implementation and tools to connect TestApi25Client to it.
* Use on client side to request changes of the TestApi25 on the server side 
* and to subscribe for the TestApi25 changes.
*/
class CPP_API_EXPORT TestApi25Client : public ITestApi25,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi25Client();
    /** dtor */
    virtual ~TestApi25Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi25 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi25::funcInt on the TestApi25 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi25::funcFloat on the TestApi25 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi25::funcString on the TestApi25 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi25Client is ready to send and receive messages.
    * @return true if TestApi25 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi25 service
...
private:
    ...
    * @param the data received from TestApi25 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi25Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi25 */
