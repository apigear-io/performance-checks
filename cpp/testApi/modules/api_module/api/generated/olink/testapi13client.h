...
#include "api/generated/core/testapi13.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi13 publisher in a way it provides access 
* to remote TestApi13 services. 
...
*     It provides a network implementation and tools to connect TestApi13Client to it.
* Use on client side to request changes of the TestApi13 on the server side 
* and to subscribe for the TestApi13 changes.
*/
class CPP_API_EXPORT TestApi13Client : public ITestApi13,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi13Client();
    /** dtor */
    virtual ~TestApi13Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi13 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi13::funcInt on the TestApi13 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi13::funcFloat on the TestApi13 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi13::funcString on the TestApi13 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi13Client is ready to send and receive messages.
    * @return true if TestApi13 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi13 service
...
private:
    ...
    * @param the data received from TestApi13 service.
    */
    ...
    TestApi13Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi13Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi13 */
    std::unique_ptr<ITestApi13Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
