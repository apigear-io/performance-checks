...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi10 publisher in a way it provides access 
* to remote TestApi10 services. 
...
*     It provides a network implementation and tools to connect TestApi10Client to it.
* Use on client side to request changes of the TestApi10 on the server side 
* and to subscribe for the TestApi10 changes.
*/
class CPP_API_EXPORT TestApi10Client : public ITestApi10,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi10Client();
    /** dtor */
    virtual ~TestApi10Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi10 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi10::funcInt on the TestApi10 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi10::funcFloat on the TestApi10 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi10::funcString on the TestApi10 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi10Client is ready to send and receive messages.
    * @return true if TestApi10 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi10 service
...
private:
    ...
    * @param the data received from TestApi10 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi10Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi10 */
