...
namespace olink {
/**
* Server side for TestApi55 implements the TestApi55 service.
* It is a source of data for TestApi55 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi55Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi55Subscriber
{
public:
    /**
    * ctor
    * @param TestApi55 The service source object, the actual TestApi55 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi55Service(std::shared_ptr<ITestApi55> TestApi55, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi55Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi55 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi55 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi55 object.
    * @return the set of properties with their current values for the TestApi55 object in json format.
    */
...
private:
    /**
    * The TestApi55 used for object source.
    */
    std::shared_ptr<ITestApi55> m_TestApi55;
    /**
