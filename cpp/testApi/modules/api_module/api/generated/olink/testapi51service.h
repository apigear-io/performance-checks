...
namespace olink {
/**
* Server side for TestApi51 implements the TestApi51 service.
* It is a source of data for TestApi51 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi51Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi51Subscriber
{
public:
    /**
    * ctor
    * @param TestApi51 The service source object, the actual TestApi51 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi51Service(std::shared_ptr<ITestApi51> TestApi51, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi51Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi51 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi51 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi51 object.
    * @return the set of properties with their current values for the TestApi51 object in json format.
    */
...
private:
    /**
    * The TestApi51 used for object source.
    */
    std::shared_ptr<ITestApi51> m_TestApi51;
    /**
