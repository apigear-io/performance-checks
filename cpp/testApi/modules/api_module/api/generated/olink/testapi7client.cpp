...
TestApi7Client::TestApi7Client()
    : m_publisher(std::make_unique<TestApi7Publisher>())
{}

void TestApi7Client::applyState(const nlohmann::json& fields) 
{
...
void TestApi7Client::setPropInt(int propInt)
{
    if(!m_node) {
...
void TestApi7Client::setPropIntLocal(int propInt)
{
...
int TestApi7Client::getPropInt() const
{
    return m_data.m_propInt;
}

void TestApi7Client::setPropFloat(float propFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi7Client::setPropFloatLocal(float propFloat)
{
...
float TestApi7Client::getPropFloat() const
{
    return m_data.m_propFloat;
}

void TestApi7Client::setPropString(const std::string& propString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi7Client::setPropStringLocal(const std::string& propString)
{
...
const std::string& TestApi7Client::getPropString() const
{
    return m_data.m_propString;
}

int TestApi7Client::funcInt(int paramInt)
{
     if(!m_node) {
...
std::future<int> TestApi7Client::funcIntAsync(int paramInt)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
float TestApi7Client::funcFloat(float paramFloat)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return 0.0f;
...
std::future<float> TestApi7Client::funcFloatAsync(float paramFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi7Client::funcString(const std::string& paramString)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return std::string();
...
std::future<std::string> TestApi7Client::funcStringAsync(const std::string& paramString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi7Client::olinkObjectName()
{
    return interfaceId;
}

void TestApi7Client::olinkOnSignal(const std::string& signalId, const nlohmann::json& args)
{
...
void TestApi7Client::olinkOnPropertyChanged(const std::string& propertyId, const nlohmann::json& value)
{
    applyState({ {ApiGear::ObjectLink::Name::getMemberName(propertyId), value} });
}
void TestApi7Client::olinkOnInit(const std::string& /*name*/, const nlohmann::json& props, ApiGear::ObjectLink::IClientNode *node)
{
    m_node = node;
    applyState(props);
}

void TestApi7Client::olinkOnRelease()
{
    m_node = nullptr;
}

bool TestApi7Client::isReady() const
{
    return m_node != nullptr;
}

ITestApi7Publisher& TestApi7Client::_getPublisher() const
{
    return *m_publisher;
}
