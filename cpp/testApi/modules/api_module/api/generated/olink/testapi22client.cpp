...
TestApi22Client::TestApi22Client()
    : m_publisher(std::make_unique<TestApi22Publisher>())
{}

void TestApi22Client::applyState(const nlohmann::json& fields) 
{
...
void TestApi22Client::setPropInt(int propInt)
{
    if(!m_node) {
...
void TestApi22Client::setPropIntLocal(int propInt)
{
...
int TestApi22Client::getPropInt() const
{
    return m_data.m_propInt;
}

void TestApi22Client::setPropFloat(float propFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi22Client::setPropFloatLocal(float propFloat)
{
...
float TestApi22Client::getPropFloat() const
{
    return m_data.m_propFloat;
}

void TestApi22Client::setPropString(const std::string& propString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi22Client::setPropStringLocal(const std::string& propString)
{
...
const std::string& TestApi22Client::getPropString() const
{
    return m_data.m_propString;
}

int TestApi22Client::funcInt(int paramInt)
{
     if(!m_node) {
...
std::future<int> TestApi22Client::funcIntAsync(int paramInt)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
float TestApi22Client::funcFloat(float paramFloat)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return 0.0f;
...
std::future<float> TestApi22Client::funcFloatAsync(float paramFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi22Client::funcString(const std::string& paramString)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return std::string();
...
std::future<std::string> TestApi22Client::funcStringAsync(const std::string& paramString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi22Client::olinkObjectName()
{
    return interfaceId;
}

void TestApi22Client::olinkOnSignal(const std::string& signalId, const nlohmann::json& args)
{
...
void TestApi22Client::olinkOnPropertyChanged(const std::string& propertyId, const nlohmann::json& value)
{
    applyState({ {ApiGear::ObjectLink::Name::getMemberName(propertyId), value} });
}
void TestApi22Client::olinkOnInit(const std::string& /*name*/, const nlohmann::json& props, ApiGear::ObjectLink::IClientNode *node)
{
    m_node = node;
    applyState(props);
}

void TestApi22Client::olinkOnRelease()
{
    m_node = nullptr;
}

bool TestApi22Client::isReady() const
{
    return m_node != nullptr;
}

ITestApi22Publisher& TestApi22Client::_getPublisher() const
{
    return *m_publisher;
}
