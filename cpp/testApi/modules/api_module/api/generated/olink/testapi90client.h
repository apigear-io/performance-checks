...
#include "api/generated/core/testapi90.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi90 publisher in a way it provides access 
* to remote TestApi90 services. 
...
*     It provides a network implementation and tools to connect TestApi90Client to it.
* Use on client side to request changes of the TestApi90 on the server side 
* and to subscribe for the TestApi90 changes.
*/
class CPP_API_EXPORT TestApi90Client : public ITestApi90,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi90Client();
    /** dtor */
    virtual ~TestApi90Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi90 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi90::funcInt on the TestApi90 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi90::funcFloat on the TestApi90 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi90::funcString on the TestApi90 service.
    ...
    */
    ...
    ITestApi90Publisher& _getPublisher() const override;
    
    /**
    * Informs if the TestApi90Client is ready to send and receive messages.
    * @return true if TestApi90 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi90 service
...
private:
    ...
    * @param the data received from TestApi90 service.
    */
    ...
    TestApi90Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi90Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi90 */
    std::unique_ptr<ITestApi90Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
