...
namespace olink {
/**
* Server side for TestApi46 implements the TestApi46 service.
* It is a source of data for TestApi46 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi46Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi46Subscriber
{
public:
    /**
    * ctor
    * @param TestApi46 The service source object, the actual TestApi46 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi46Service(std::shared_ptr<ITestApi46> TestApi46, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi46Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi46 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi46 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi46 object.
    * @return the set of properties with their current values for the TestApi46 object in json format.
    */
...
private:
    /**
    * The TestApi46 used for object source.
    */
    std::shared_ptr<ITestApi46> m_TestApi46;
    /**
