...
namespace olink {
/**
* Server side for TestApi20 implements the TestApi20 service.
* It is a source of data for TestApi20 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi20Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi20Subscriber
{
public:
    /**
    * ctor
    * @param TestApi20 The service source object, the actual TestApi20 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi20Service(std::shared_ptr<ITestApi20> TestApi20, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi20Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi20 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi20 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi20 object.
    * @return the set of properties with their current values for the TestApi20 object in json format.
    */
...
private:
    /**
    * The TestApi20 used for object source.
    */
    std::shared_ptr<ITestApi20> m_TestApi20;
    /**
