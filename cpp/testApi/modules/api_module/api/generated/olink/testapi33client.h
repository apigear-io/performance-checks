...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi33 publisher in a way it provides access 
* to remote TestApi33 services. 
...
*     It provides a network implementation and tools to connect TestApi33Client to it.
* Use on client side to request changes of the TestApi33 on the server side 
* and to subscribe for the TestApi33 changes.
*/
class CPP_API_EXPORT TestApi33Client : public ITestApi33,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi33Client();
    /** dtor */
    virtual ~TestApi33Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi33 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi33::funcInt on the TestApi33 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi33::funcFloat on the TestApi33 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi33::funcString on the TestApi33 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi33Client is ready to send and receive messages.
    * @return true if TestApi33 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi33 service
...
private:
    ...
    * @param the data received from TestApi33 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi33Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi33 */
