...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi60 publisher in a way it provides access 
* to remote TestApi60 services. 
...
*     It provides a network implementation and tools to connect TestApi60Client to it.
* Use on client side to request changes of the TestApi60 on the server side 
* and to subscribe for the TestApi60 changes.
*/
class CPP_API_EXPORT TestApi60Client : public ITestApi60,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi60Client();
    /** dtor */
    virtual ~TestApi60Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi60 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi60::funcInt on the TestApi60 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi60::funcFloat on the TestApi60 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi60::funcString on the TestApi60 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi60Client is ready to send and receive messages.
    * @return true if TestApi60 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi60 service
...
private:
    ...
    * @param the data received from TestApi60 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi60Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi60 */
