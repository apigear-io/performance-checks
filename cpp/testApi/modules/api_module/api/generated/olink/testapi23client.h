...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi23 publisher in a way it provides access 
* to remote TestApi23 services. 
...
*     It provides a network implementation and tools to connect TestApi23Client to it.
* Use on client side to request changes of the TestApi23 on the server side 
* and to subscribe for the TestApi23 changes.
*/
class CPP_API_EXPORT TestApi23Client : public ITestApi23,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi23Client();
    /** dtor */
    virtual ~TestApi23Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi23 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi23::funcInt on the TestApi23 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi23::funcFloat on the TestApi23 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi23::funcString on the TestApi23 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi23Client is ready to send and receive messages.
    * @return true if TestApi23 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi23 service
...
private:
    ...
    * @param the data received from TestApi23 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi23Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi23 */
