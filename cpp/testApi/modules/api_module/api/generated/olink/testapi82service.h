...
namespace olink {
/**
* Server side for TestApi82 implements the TestApi82 service.
* It is a source of data for TestApi82 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi82Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi82Subscriber
{
public:
    /**
    * ctor
    * @param TestApi82 The service source object, the actual TestApi82 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi82Service(std::shared_ptr<ITestApi82> TestApi82, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi82Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi82 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi82 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi82 object.
    * @return the set of properties with their current values for the TestApi82 object in json format.
    */
...
private:
    /**
    * The TestApi82 used for object source.
    */
    std::shared_ptr<ITestApi82> m_TestApi82;
    /**
