...
namespace olink {
/**
* Server side for TestApi52 implements the TestApi52 service.
* It is a source of data for TestApi52 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi52Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi52Subscriber
{
public:
    /**
    * ctor
    * @param TestApi52 The service source object, the actual TestApi52 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi52Service(std::shared_ptr<ITestApi52> TestApi52, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi52Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi52 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi52 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi52 object.
    * @return the set of properties with their current values for the TestApi52 object in json format.
    */
...
private:
    /**
    * The TestApi52 used for object source.
    */
    std::shared_ptr<ITestApi52> m_TestApi52;
    /**
