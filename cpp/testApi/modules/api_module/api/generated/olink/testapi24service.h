...
namespace olink {
/**
* Server side for TestApi24 implements the TestApi24 service.
* It is a source of data for TestApi24 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi24Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi24Subscriber
{
public:
    /**
    * ctor
    * @param TestApi24 The service source object, the actual TestApi24 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi24Service(std::shared_ptr<ITestApi24> TestApi24, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi24Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi24 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi24 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi24 object.
    * @return the set of properties with their current values for the TestApi24 object in json format.
    */
...
private:
    /**
    * The TestApi24 used for object source.
    */
    std::shared_ptr<ITestApi24> m_TestApi24;
    /**
