...
namespace olink {
/**
* Server side for TestApi36 implements the TestApi36 service.
* It is a source of data for TestApi36 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi36Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi36Subscriber
{
public:
    /**
    * ctor
    * @param TestApi36 The service source object, the actual TestApi36 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi36Service(std::shared_ptr<ITestApi36> TestApi36, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi36Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi36 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi36 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi36 object.
    * @return the set of properties with their current values for the TestApi36 object in json format.
    */
...
private:
    /**
    * The TestApi36 used for object source.
    */
    std::shared_ptr<ITestApi36> m_TestApi36;
    /**
