...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi8 publisher in a way it provides access 
* to remote TestApi8 services. 
...
*     It provides a network implementation and tools to connect TestApi8Client to it.
* Use on client side to request changes of the TestApi8 on the server side 
* and to subscribe for the TestApi8 changes.
*/
class CPP_API_EXPORT TestApi8Client : public ITestApi8,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi8Client();
    /** dtor */
    virtual ~TestApi8Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi8 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi8::funcInt on the TestApi8 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi8::funcFloat on the TestApi8 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi8::funcString on the TestApi8 service.
    ...
    */
    ...
    ITestApi8Publisher& _getPublisher() const override;
    
    /**
    * Informs if the TestApi8Client is ready to send and receive messages.
    * @return true if TestApi8 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi8 service
...
private:
    ...
    * @param the data received from TestApi8 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi8Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi8 */
    std::unique_ptr<ITestApi8Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
