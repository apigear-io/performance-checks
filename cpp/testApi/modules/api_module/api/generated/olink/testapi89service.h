...
namespace olink {
/**
* Server side for TestApi89 implements the TestApi89 service.
* It is a source of data for TestApi89 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi89Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi89Subscriber
{
public:
    /**
    * ctor
    * @param TestApi89 The service source object, the actual TestApi89 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi89Service(std::shared_ptr<ITestApi89> TestApi89, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi89Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi89 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi89 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi89 object.
    * @return the set of properties with their current values for the TestApi89 object in json format.
    */
...
private:
    /**
    * The TestApi89 used for object source.
    */
    std::shared_ptr<ITestApi89> m_TestApi89;
    /**
