...
#include "api/generated/core/testapi89.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi89 publisher in a way it provides access 
* to remote TestApi89 services. 
...
*     It provides a network implementation and tools to connect TestApi89Client to it.
* Use on client side to request changes of the TestApi89 on the server side 
* and to subscribe for the TestApi89 changes.
*/
class CPP_API_EXPORT TestApi89Client : public ITestApi89,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi89Client();
    /** dtor */
    virtual ~TestApi89Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi89 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi89::funcInt on the TestApi89 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi89::funcFloat on the TestApi89 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi89::funcString on the TestApi89 service.
    ...
    */
    ...
    ITestApi89Publisher& _getPublisher() const override;
    
    /**
    * Informs if the TestApi89Client is ready to send and receive messages.
    * @return true if TestApi89 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi89 service
...
private:
    ...
    * @param the data received from TestApi89 service.
    */
    ...
    TestApi89Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi89Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi89 */
    std::unique_ptr<ITestApi89Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
