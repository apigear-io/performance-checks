...
#include "api/generated/core/testapi32.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi32 publisher in a way it provides access 
* to remote TestApi32 services. 
...
*     It provides a network implementation and tools to connect TestApi32Client to it.
* Use on client side to request changes of the TestApi32 on the server side 
* and to subscribe for the TestApi32 changes.
*/
class CPP_API_EXPORT TestApi32Client : public ITestApi32,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi32Client();
    /** dtor */
    virtual ~TestApi32Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi32 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi32::funcInt on the TestApi32 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi32::funcFloat on the TestApi32 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi32::funcString on the TestApi32 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi32Client is ready to send and receive messages.
    * @return true if TestApi32 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi32 service
...
private:
    ...
    * @param the data received from TestApi32 service.
    */
    ...
    TestApi32Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi32Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi32 */
    std::unique_ptr<ITestApi32Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
