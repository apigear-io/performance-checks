...
namespace olink {
/**
* Server side for TestApi56 implements the TestApi56 service.
* It is a source of data for TestApi56 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi56Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi56Subscriber
{
public:
    /**
    * ctor
    * @param TestApi56 The service source object, the actual TestApi56 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi56Service(std::shared_ptr<ITestApi56> TestApi56, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi56Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi56 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi56 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi56 object.
    * @return the set of properties with their current values for the TestApi56 object in json format.
    */
...
private:
    /**
    * The TestApi56 used for object source.
    */
    std::shared_ptr<ITestApi56> m_TestApi56;
    /**
