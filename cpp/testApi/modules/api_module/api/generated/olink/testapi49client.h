...
#include "api/generated/core/testapi49.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi49 publisher in a way it provides access 
* to remote TestApi49 services. 
...
*     It provides a network implementation and tools to connect TestApi49Client to it.
* Use on client side to request changes of the TestApi49 on the server side 
* and to subscribe for the TestApi49 changes.
*/
class CPP_API_EXPORT TestApi49Client : public ITestApi49,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi49Client();
    /** dtor */
    virtual ~TestApi49Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi49 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi49::funcInt on the TestApi49 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi49::funcFloat on the TestApi49 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi49::funcString on the TestApi49 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi49Client is ready to send and receive messages.
    * @return true if TestApi49 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi49 service
...
private:
    ...
    * @param the data received from TestApi49 service.
    */
    ...
    TestApi49Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi49Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi49 */
    std::unique_ptr<ITestApi49Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
