...
TestApi60Client::TestApi60Client()
    : m_publisher(std::make_unique<TestApi60Publisher>())
{}

void TestApi60Client::applyState(const nlohmann::json& fields) 
{
...
void TestApi60Client::setPropInt(int propInt)
{
    if(!m_node) {
...
void TestApi60Client::setPropIntLocal(int propInt)
{
...
int TestApi60Client::getPropInt() const
{
    return m_data.m_propInt;
}

void TestApi60Client::setPropFloat(float propFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi60Client::setPropFloatLocal(float propFloat)
{
...
float TestApi60Client::getPropFloat() const
{
    return m_data.m_propFloat;
}

void TestApi60Client::setPropString(const std::string& propString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi60Client::setPropStringLocal(const std::string& propString)
{
...
const std::string& TestApi60Client::getPropString() const
{
    return m_data.m_propString;
}

int TestApi60Client::funcInt(int paramInt)
{
     if(!m_node) {
...
std::future<int> TestApi60Client::funcIntAsync(int paramInt)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
float TestApi60Client::funcFloat(float paramFloat)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return 0.0f;
...
std::future<float> TestApi60Client::funcFloatAsync(float paramFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi60Client::funcString(const std::string& paramString)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return std::string();
...
std::future<std::string> TestApi60Client::funcStringAsync(const std::string& paramString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi60Client::olinkObjectName()
{
    return interfaceId;
}

void TestApi60Client::olinkOnSignal(const std::string& signalId, const nlohmann::json& args)
{
...
void TestApi60Client::olinkOnPropertyChanged(const std::string& propertyId, const nlohmann::json& value)
{
    applyState({ {ApiGear::ObjectLink::Name::getMemberName(propertyId), value} });
}
void TestApi60Client::olinkOnInit(const std::string& /*name*/, const nlohmann::json& props, ApiGear::ObjectLink::IClientNode *node)
{
    m_node = node;
    applyState(props);
}

void TestApi60Client::olinkOnRelease()
{
    m_node = nullptr;
}

bool TestApi60Client::isReady() const
{
    return m_node != nullptr;
}

ITestApi60Publisher& TestApi60Client::_getPublisher() const
{
    return *m_publisher;
}
