...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi91 publisher in a way it provides access 
* to remote TestApi91 services. 
...
*     It provides a network implementation and tools to connect TestApi91Client to it.
* Use on client side to request changes of the TestApi91 on the server side 
* and to subscribe for the TestApi91 changes.
*/
class CPP_API_EXPORT TestApi91Client : public ITestApi91,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi91Client();
    /** dtor */
    virtual ~TestApi91Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi91 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi91::funcInt on the TestApi91 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi91::funcFloat on the TestApi91 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi91::funcString on the TestApi91 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi91Client is ready to send and receive messages.
    * @return true if TestApi91 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi91 service
...
private:
    ...
    * @param the data received from TestApi91 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi91Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi91 */
