...
namespace olink {
/**
* Server side for TestApi80 implements the TestApi80 service.
* It is a source of data for TestApi80 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi80Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi80Subscriber
{
public:
    /**
    * ctor
    * @param TestApi80 The service source object, the actual TestApi80 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi80Service(std::shared_ptr<ITestApi80> TestApi80, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi80Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi80 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi80 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi80 object.
    * @return the set of properties with their current values for the TestApi80 object in json format.
    */
...
private:
    /**
    * The TestApi80 used for object source.
    */
    std::shared_ptr<ITestApi80> m_TestApi80;
    /**
