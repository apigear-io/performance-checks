...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi42 publisher in a way it provides access 
* to remote TestApi42 services. 
...
*     It provides a network implementation and tools to connect TestApi42Client to it.
* Use on client side to request changes of the TestApi42 on the server side 
* and to subscribe for the TestApi42 changes.
*/
class CPP_API_EXPORT TestApi42Client : public ITestApi42,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi42Client();
    /** dtor */
    virtual ~TestApi42Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi42 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi42::funcInt on the TestApi42 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi42::funcFloat on the TestApi42 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi42::funcString on the TestApi42 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi42Client is ready to send and receive messages.
    * @return true if TestApi42 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi42 service
...
private:
    ...
    * @param the data received from TestApi42 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi42Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi42 */
