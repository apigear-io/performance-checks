...
namespace olink {
/**
* Server side for TestApi6 implements the TestApi6 service.
* It is a source of data for TestApi6 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi6Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi6Subscriber
{
public:
    /**
    * ctor
    * @param TestApi6 The service source object, the actual TestApi6 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi6Service(std::shared_ptr<ITestApi6> TestApi6, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi6Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi6 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi6 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi6 object.
    * @return the set of properties with their current values for the TestApi6 object in json format.
    */
...
private:
    /**
    * The TestApi6 used for object source.
    */
    std::shared_ptr<ITestApi6> m_TestApi6;
    /**
