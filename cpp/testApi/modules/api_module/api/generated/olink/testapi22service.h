...
namespace olink {
/**
* Server side for TestApi22 implements the TestApi22 service.
* It is a source of data for TestApi22 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi22Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi22Subscriber
{
public:
    /**
    * ctor
    * @param TestApi22 The service source object, the actual TestApi22 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi22Service(std::shared_ptr<ITestApi22> TestApi22, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi22Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi22 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi22 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi22 object.
    * @return the set of properties with their current values for the TestApi22 object in json format.
    */
...
private:
    /**
    * The TestApi22 used for object source.
    */
    std::shared_ptr<ITestApi22> m_TestApi22;
    /**
