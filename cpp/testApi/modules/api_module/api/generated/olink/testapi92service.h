...
namespace olink {
/**
* Server side for TestApi92 implements the TestApi92 service.
* It is a source of data for TestApi92 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi92Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi92Subscriber
{
public:
    /**
    * ctor
    * @param TestApi92 The service source object, the actual TestApi92 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi92Service(std::shared_ptr<ITestApi92> TestApi92, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi92Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi92 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi92 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi92 object.
    * @return the set of properties with their current values for the TestApi92 object in json format.
    */
...
private:
    /**
    * The TestApi92 used for object source.
    */
    std::shared_ptr<ITestApi92> m_TestApi92;
    /**
