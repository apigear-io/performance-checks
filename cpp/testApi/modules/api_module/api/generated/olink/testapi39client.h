...
#include "api/generated/core/testapi39.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi39 publisher in a way it provides access 
* to remote TestApi39 services. 
...
*     It provides a network implementation and tools to connect TestApi39Client to it.
* Use on client side to request changes of the TestApi39 on the server side 
* and to subscribe for the TestApi39 changes.
*/
class CPP_API_EXPORT TestApi39Client : public ITestApi39,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi39Client();
    /** dtor */
    virtual ~TestApi39Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi39 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi39::funcInt on the TestApi39 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi39::funcFloat on the TestApi39 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi39::funcString on the TestApi39 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi39Client is ready to send and receive messages.
    * @return true if TestApi39 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi39 service
...
private:
    ...
    * @param the data received from TestApi39 service.
    */
    ...
    TestApi39Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi39Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi39 */
    std::unique_ptr<ITestApi39Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
