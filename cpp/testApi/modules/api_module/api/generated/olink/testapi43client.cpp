...
TestApi43Client::TestApi43Client()
    : m_publisher(std::make_unique<TestApi43Publisher>())
{}

void TestApi43Client::applyState(const nlohmann::json& fields) 
{
...
void TestApi43Client::setPropInt(int propInt)
{
    if(!m_node) {
...
void TestApi43Client::setPropIntLocal(int propInt)
{
...
int TestApi43Client::getPropInt() const
{
    return m_data.m_propInt;
}

void TestApi43Client::setPropFloat(float propFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi43Client::setPropFloatLocal(float propFloat)
{
...
float TestApi43Client::getPropFloat() const
{
    return m_data.m_propFloat;
}

void TestApi43Client::setPropString(const std::string& propString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi43Client::setPropStringLocal(const std::string& propString)
{
...
const std::string& TestApi43Client::getPropString() const
{
    return m_data.m_propString;
}

int TestApi43Client::funcInt(int paramInt)
{
     if(!m_node) {
...
std::future<int> TestApi43Client::funcIntAsync(int paramInt)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
float TestApi43Client::funcFloat(float paramFloat)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return 0.0f;
...
std::future<float> TestApi43Client::funcFloatAsync(float paramFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi43Client::funcString(const std::string& paramString)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return std::string();
...
std::future<std::string> TestApi43Client::funcStringAsync(const std::string& paramString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi43Client::olinkObjectName()
{
    return interfaceId;
}

void TestApi43Client::olinkOnSignal(const std::string& signalId, const nlohmann::json& args)
{
...
void TestApi43Client::olinkOnPropertyChanged(const std::string& propertyId, const nlohmann::json& value)
{
    applyState({ {ApiGear::ObjectLink::Name::getMemberName(propertyId), value} });
}
void TestApi43Client::olinkOnInit(const std::string& /*name*/, const nlohmann::json& props, ApiGear::ObjectLink::IClientNode *node)
{
    m_node = node;
    applyState(props);
}

void TestApi43Client::olinkOnRelease()
{
    m_node = nullptr;
}

bool TestApi43Client::isReady() const
{
    return m_node != nullptr;
}

ITestApi43Publisher& TestApi43Client::_getPublisher() const
{
    return *m_publisher;
}
