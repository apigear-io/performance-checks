...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi62 publisher in a way it provides access 
* to remote TestApi62 services. 
...
*     It provides a network implementation and tools to connect TestApi62Client to it.
* Use on client side to request changes of the TestApi62 on the server side 
* and to subscribe for the TestApi62 changes.
*/
class CPP_API_EXPORT TestApi62Client : public ITestApi62,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi62Client();
    /** dtor */
    virtual ~TestApi62Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi62 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi62::funcInt on the TestApi62 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi62::funcFloat on the TestApi62 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi62::funcString on the TestApi62 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi62Client is ready to send and receive messages.
    * @return true if TestApi62 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi62 service
...
private:
    ...
    * @param the data received from TestApi62 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi62Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi62 */
