...
namespace olink {
/**
* Server side for TestApi2 implements the TestApi2 service.
* It is a source of data for TestApi2 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi2Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi2Subscriber
{
public:
    /**
    * ctor
    * @param TestApi2 The service source object, the actual TestApi2 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi2Service(std::shared_ptr<ITestApi2> TestApi2, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi2Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi2 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi2 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi2 object.
    * @return the set of properties with their current values for the TestApi2 object in json format.
    */
...
private:
    /**
    * The TestApi2 used for object source.
    */
    std::shared_ptr<ITestApi2> m_TestApi2;
    /**
