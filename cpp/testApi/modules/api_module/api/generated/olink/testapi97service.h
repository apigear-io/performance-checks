...
namespace olink {
/**
* Server side for TestApi97 implements the TestApi97 service.
* It is a source of data for TestApi97 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi97Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi97Subscriber
{
public:
    /**
    * ctor
    * @param TestApi97 The service source object, the actual TestApi97 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi97Service(std::shared_ptr<ITestApi97> TestApi97, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi97Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi97 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi97 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi97 object.
    * @return the set of properties with their current values for the TestApi97 object in json format.
    */
...
private:
    /**
    * The TestApi97 used for object source.
    */
    std::shared_ptr<ITestApi97> m_TestApi97;
    /**
