...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi15 publisher in a way it provides access 
* to remote TestApi15 services. 
...
*     It provides a network implementation and tools to connect TestApi15Client to it.
* Use on client side to request changes of the TestApi15 on the server side 
* and to subscribe for the TestApi15 changes.
*/
class CPP_API_EXPORT TestApi15Client : public ITestApi15,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi15Client();
    /** dtor */
    virtual ~TestApi15Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi15 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi15::funcInt on the TestApi15 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi15::funcFloat on the TestApi15 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi15::funcString on the TestApi15 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi15Client is ready to send and receive messages.
    * @return true if TestApi15 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi15 service
...
private:
    ...
    * @param the data received from TestApi15 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi15Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi15 */
