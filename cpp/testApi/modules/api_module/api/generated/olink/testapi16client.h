...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi16 publisher in a way it provides access 
* to remote TestApi16 services. 
...
*     It provides a network implementation and tools to connect TestApi16Client to it.
* Use on client side to request changes of the TestApi16 on the server side 
* and to subscribe for the TestApi16 changes.
*/
class CPP_API_EXPORT TestApi16Client : public ITestApi16,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi16Client();
    /** dtor */
    virtual ~TestApi16Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi16 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi16::funcInt on the TestApi16 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi16::funcFloat on the TestApi16 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi16::funcString on the TestApi16 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi16Client is ready to send and receive messages.
    * @return true if TestApi16 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi16 service
...
private:
    ...
    * @param the data received from TestApi16 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi16Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi16 */
