...
namespace olink {
/**
* Server side for TestApi90 implements the TestApi90 service.
* It is a source of data for TestApi90 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi90Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi90Subscriber
{
public:
    /**
    * ctor
    * @param TestApi90 The service source object, the actual TestApi90 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi90Service(std::shared_ptr<ITestApi90> TestApi90, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi90Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi90 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi90 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi90 object.
    * @return the set of properties with their current values for the TestApi90 object in json format.
    */
...
private:
    /**
    * The TestApi90 used for object source.
    */
    std::shared_ptr<ITestApi90> m_TestApi90;
    /**
