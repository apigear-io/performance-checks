...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi31 publisher in a way it provides access 
* to remote TestApi31 services. 
...
*     It provides a network implementation and tools to connect TestApi31Client to it.
* Use on client side to request changes of the TestApi31 on the server side 
* and to subscribe for the TestApi31 changes.
*/
class CPP_API_EXPORT TestApi31Client : public ITestApi31,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi31Client();
    /** dtor */
    virtual ~TestApi31Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi31 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi31::funcInt on the TestApi31 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi31::funcFloat on the TestApi31 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi31::funcString on the TestApi31 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi31Client is ready to send and receive messages.
    * @return true if TestApi31 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi31 service
...
private:
    ...
    * @param the data received from TestApi31 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi31Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi31 */
