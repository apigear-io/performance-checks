...
namespace olink {
/**
* Server side for TestApi30 implements the TestApi30 service.
* It is a source of data for TestApi30 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi30Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi30Subscriber
{
public:
    /**
    * ctor
    * @param TestApi30 The service source object, the actual TestApi30 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi30Service(std::shared_ptr<ITestApi30> TestApi30, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi30Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi30 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi30 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi30 object.
    * @return the set of properties with their current values for the TestApi30 object in json format.
    */
...
private:
    /**
    * The TestApi30 used for object source.
    */
    std::shared_ptr<ITestApi30> m_TestApi30;
    /**
