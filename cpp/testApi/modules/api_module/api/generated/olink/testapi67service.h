...
namespace olink {
/**
* Server side for TestApi67 implements the TestApi67 service.
* It is a source of data for TestApi67 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi67Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi67Subscriber
{
public:
    /**
    * ctor
    * @param TestApi67 The service source object, the actual TestApi67 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi67Service(std::shared_ptr<ITestApi67> TestApi67, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi67Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi67 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi67 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi67 object.
    * @return the set of properties with their current values for the TestApi67 object in json format.
    */
...
private:
    /**
    * The TestApi67 used for object source.
    */
    std::shared_ptr<ITestApi67> m_TestApi67;
    /**
