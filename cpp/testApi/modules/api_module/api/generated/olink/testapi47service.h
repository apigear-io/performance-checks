...
namespace olink {
/**
* Server side for TestApi47 implements the TestApi47 service.
* It is a source of data for TestApi47 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi47Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi47Subscriber
{
public:
    /**
    * ctor
    * @param TestApi47 The service source object, the actual TestApi47 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi47Service(std::shared_ptr<ITestApi47> TestApi47, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi47Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi47 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi47 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi47 object.
    * @return the set of properties with their current values for the TestApi47 object in json format.
    */
...
private:
    /**
    * The TestApi47 used for object source.
    */
    std::shared_ptr<ITestApi47> m_TestApi47;
    /**
