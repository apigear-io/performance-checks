...
namespace olink {
/**
* Server side for TestApi4 implements the TestApi4 service.
* It is a source of data for TestApi4 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi4Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi4Subscriber
{
public:
    /**
    * ctor
    * @param TestApi4 The service source object, the actual TestApi4 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi4Service(std::shared_ptr<ITestApi4> TestApi4, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi4Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi4 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi4 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi4 object.
    * @return the set of properties with their current values for the TestApi4 object in json format.
    */
...
private:
    /**
    * The TestApi4 used for object source.
    */
    std::shared_ptr<ITestApi4> m_TestApi4;
    /**
