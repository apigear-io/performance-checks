...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi35 publisher in a way it provides access 
* to remote TestApi35 services. 
...
*     It provides a network implementation and tools to connect TestApi35Client to it.
* Use on client side to request changes of the TestApi35 on the server side 
* and to subscribe for the TestApi35 changes.
*/
class CPP_API_EXPORT TestApi35Client : public ITestApi35,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi35Client();
    /** dtor */
    virtual ~TestApi35Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi35 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi35::funcInt on the TestApi35 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi35::funcFloat on the TestApi35 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi35::funcString on the TestApi35 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi35Client is ready to send and receive messages.
    * @return true if TestApi35 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi35 service
...
private:
    ...
    * @param the data received from TestApi35 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi35Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi35 */
