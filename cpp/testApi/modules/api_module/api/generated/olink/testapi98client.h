...
#include "api/generated/core/testapi98.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi98 publisher in a way it provides access 
* to remote TestApi98 services. 
...
*     It provides a network implementation and tools to connect TestApi98Client to it.
* Use on client side to request changes of the TestApi98 on the server side 
* and to subscribe for the TestApi98 changes.
*/
class CPP_API_EXPORT TestApi98Client : public ITestApi98,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi98Client();
    /** dtor */
    virtual ~TestApi98Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi98 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi98::funcInt on the TestApi98 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi98::funcFloat on the TestApi98 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi98::funcString on the TestApi98 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi98Client is ready to send and receive messages.
    * @return true if TestApi98 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi98 service
...
private:
    ...
    * @param the data received from TestApi98 service.
    */
    ...
    TestApi98Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi98Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi98 */
    std::unique_ptr<ITestApi98Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
