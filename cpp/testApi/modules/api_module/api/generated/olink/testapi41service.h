...
namespace olink {
/**
* Server side for TestApi41 implements the TestApi41 service.
* It is a source of data for TestApi41 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi41Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi41Subscriber
{
public:
    /**
    * ctor
    * @param TestApi41 The service source object, the actual TestApi41 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi41Service(std::shared_ptr<ITestApi41> TestApi41, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi41Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi41 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi41 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi41 object.
    * @return the set of properties with their current values for the TestApi41 object in json format.
    */
...
private:
    /**
    * The TestApi41 used for object source.
    */
    std::shared_ptr<ITestApi41> m_TestApi41;
    /**
