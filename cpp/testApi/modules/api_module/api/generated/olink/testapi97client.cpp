...
TestApi97Client::TestApi97Client()
    : m_publisher(std::make_unique<TestApi97Publisher>())
{}

void TestApi97Client::applyState(const nlohmann::json& fields) 
{
...
void TestApi97Client::setPropInt(int propInt)
{
    if(!m_node) {
...
void TestApi97Client::setPropIntLocal(int propInt)
{
...
int TestApi97Client::getPropInt() const
{
    return m_data.m_propInt;
}

void TestApi97Client::setPropFloat(float propFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi97Client::setPropFloatLocal(float propFloat)
{
...
float TestApi97Client::getPropFloat() const
{
    return m_data.m_propFloat;
}

void TestApi97Client::setPropString(const std::string& propString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi97Client::setPropStringLocal(const std::string& propString)
{
...
const std::string& TestApi97Client::getPropString() const
{
    return m_data.m_propString;
}

int TestApi97Client::funcInt(int paramInt)
{
     if(!m_node) {
...
std::future<int> TestApi97Client::funcIntAsync(int paramInt)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
float TestApi97Client::funcFloat(float paramFloat)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return 0.0f;
...
std::future<float> TestApi97Client::funcFloatAsync(float paramFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi97Client::funcString(const std::string& paramString)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return std::string();
...
std::future<std::string> TestApi97Client::funcStringAsync(const std::string& paramString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi97Client::olinkObjectName()
{
    return interfaceId;
}

void TestApi97Client::olinkOnSignal(const std::string& signalId, const nlohmann::json& args)
{
...
void TestApi97Client::olinkOnPropertyChanged(const std::string& propertyId, const nlohmann::json& value)
{
    applyState({ {ApiGear::ObjectLink::Name::getMemberName(propertyId), value} });
}
void TestApi97Client::olinkOnInit(const std::string& /*name*/, const nlohmann::json& props, ApiGear::ObjectLink::IClientNode *node)
{
    m_node = node;
    applyState(props);
}

void TestApi97Client::olinkOnRelease()
{
    m_node = nullptr;
}

bool TestApi97Client::isReady() const
{
    return m_node != nullptr;
}

ITestApi97Publisher& TestApi97Client::_getPublisher() const
{
    return *m_publisher;
}
