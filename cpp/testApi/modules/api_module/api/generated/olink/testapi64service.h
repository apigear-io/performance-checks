...
namespace olink {
/**
* Server side for TestApi64 implements the TestApi64 service.
* It is a source of data for TestApi64 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi64Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi64Subscriber
{
public:
    /**
    * ctor
    * @param TestApi64 The service source object, the actual TestApi64 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi64Service(std::shared_ptr<ITestApi64> TestApi64, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi64Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi64 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi64 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi64 object.
    * @return the set of properties with their current values for the TestApi64 object in json format.
    */
...
private:
    /**
    * The TestApi64 used for object source.
    */
    std::shared_ptr<ITestApi64> m_TestApi64;
    /**
