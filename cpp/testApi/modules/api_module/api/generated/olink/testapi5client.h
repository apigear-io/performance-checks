...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi5 publisher in a way it provides access 
* to remote TestApi5 services. 
...
*     It provides a network implementation and tools to connect TestApi5Client to it.
* Use on client side to request changes of the TestApi5 on the server side 
* and to subscribe for the TestApi5 changes.
*/
class CPP_API_EXPORT TestApi5Client : public ITestApi5,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi5Client();
    /** dtor */
    virtual ~TestApi5Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi5 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi5::funcInt on the TestApi5 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi5::funcFloat on the TestApi5 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi5::funcString on the TestApi5 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi5Client is ready to send and receive messages.
    * @return true if TestApi5 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi5 service
...
private:
    ...
    * @param the data received from TestApi5 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi5Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi5 */
