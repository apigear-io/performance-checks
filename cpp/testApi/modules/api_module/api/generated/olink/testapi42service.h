...
namespace olink {
/**
* Server side for TestApi42 implements the TestApi42 service.
* It is a source of data for TestApi42 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi42Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi42Subscriber
{
public:
    /**
    * ctor
    * @param TestApi42 The service source object, the actual TestApi42 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi42Service(std::shared_ptr<ITestApi42> TestApi42, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi42Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi42 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi42 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi42 object.
    * @return the set of properties with their current values for the TestApi42 object in json format.
    */
...
private:
    /**
    * The TestApi42 used for object source.
    */
    std::shared_ptr<ITestApi42> m_TestApi42;
    /**
