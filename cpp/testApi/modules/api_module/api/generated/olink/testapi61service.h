...
namespace olink {
/**
* Server side for TestApi61 implements the TestApi61 service.
* It is a source of data for TestApi61 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi61Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi61Subscriber
{
public:
    /**
    * ctor
    * @param TestApi61 The service source object, the actual TestApi61 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi61Service(std::shared_ptr<ITestApi61> TestApi61, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi61Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi61 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi61 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi61 object.
    * @return the set of properties with their current values for the TestApi61 object in json format.
    */
...
private:
    /**
    * The TestApi61 used for object source.
    */
    std::shared_ptr<ITestApi61> m_TestApi61;
    /**
