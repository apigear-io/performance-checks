...
namespace olink {
/**
* Server side for TestApi86 implements the TestApi86 service.
* It is a source of data for TestApi86 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi86Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi86Subscriber
{
public:
    /**
    * ctor
    * @param TestApi86 The service source object, the actual TestApi86 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi86Service(std::shared_ptr<ITestApi86> TestApi86, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi86Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi86 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi86 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi86 object.
    * @return the set of properties with their current values for the TestApi86 object in json format.
    */
...
private:
    /**
    * The TestApi86 used for object source.
    */
    std::shared_ptr<ITestApi86> m_TestApi86;
    /**
