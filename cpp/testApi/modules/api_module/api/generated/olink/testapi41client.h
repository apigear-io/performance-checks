...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi41 publisher in a way it provides access 
* to remote TestApi41 services. 
...
*     It provides a network implementation and tools to connect TestApi41Client to it.
* Use on client side to request changes of the TestApi41 on the server side 
* and to subscribe for the TestApi41 changes.
*/
class CPP_API_EXPORT TestApi41Client : public ITestApi41,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi41Client();
    /** dtor */
    virtual ~TestApi41Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi41 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi41::funcInt on the TestApi41 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi41::funcFloat on the TestApi41 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi41::funcString on the TestApi41 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi41Client is ready to send and receive messages.
    * @return true if TestApi41 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi41 service
...
private:
    ...
    * @param the data received from TestApi41 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi41Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi41 */
