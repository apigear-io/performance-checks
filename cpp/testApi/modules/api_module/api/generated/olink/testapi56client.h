...
#include "api/generated/core/testapi56.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi56 publisher in a way it provides access 
* to remote TestApi56 services. 
...
*     It provides a network implementation and tools to connect TestApi56Client to it.
* Use on client side to request changes of the TestApi56 on the server side 
* and to subscribe for the TestApi56 changes.
*/
class CPP_API_EXPORT TestApi56Client : public ITestApi56,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi56Client();
    /** dtor */
    virtual ~TestApi56Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi56 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi56::funcInt on the TestApi56 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi56::funcFloat on the TestApi56 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi56::funcString on the TestApi56 service.
    ...
    */
    ...
    ITestApi56Publisher& _getPublisher() const override;
    
    /**
    * Informs if the TestApi56Client is ready to send and receive messages.
    * @return true if TestApi56 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi56 service
...
private:
    ...
    * @param the data received from TestApi56 service.
    */
    ...
    TestApi56Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi56Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi56 */
    std::unique_ptr<ITestApi56Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
