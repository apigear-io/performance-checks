...
TestApi74Client::TestApi74Client()
    : m_publisher(std::make_unique<TestApi74Publisher>())
{}

void TestApi74Client::applyState(const nlohmann::json& fields) 
{
...
void TestApi74Client::setPropInt(int propInt)
{
    if(!m_node) {
...
void TestApi74Client::setPropIntLocal(int propInt)
{
...
int TestApi74Client::getPropInt() const
{
    return m_data.m_propInt;
}

void TestApi74Client::setPropFloat(float propFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi74Client::setPropFloatLocal(float propFloat)
{
...
float TestApi74Client::getPropFloat() const
{
    return m_data.m_propFloat;
}

void TestApi74Client::setPropString(const std::string& propString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi74Client::setPropStringLocal(const std::string& propString)
{
...
const std::string& TestApi74Client::getPropString() const
{
    return m_data.m_propString;
}

int TestApi74Client::funcInt(int paramInt)
{
     if(!m_node) {
...
std::future<int> TestApi74Client::funcIntAsync(int paramInt)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
float TestApi74Client::funcFloat(float paramFloat)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return 0.0f;
...
std::future<float> TestApi74Client::funcFloatAsync(float paramFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi74Client::funcString(const std::string& paramString)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return std::string();
...
std::future<std::string> TestApi74Client::funcStringAsync(const std::string& paramString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi74Client::olinkObjectName()
{
    return interfaceId;
}

void TestApi74Client::olinkOnSignal(const std::string& signalId, const nlohmann::json& args)
{
...
void TestApi74Client::olinkOnPropertyChanged(const std::string& propertyId, const nlohmann::json& value)
{
    applyState({ {ApiGear::ObjectLink::Name::getMemberName(propertyId), value} });
}
void TestApi74Client::olinkOnInit(const std::string& /*name*/, const nlohmann::json& props, ApiGear::ObjectLink::IClientNode *node)
{
    m_node = node;
    applyState(props);
}

void TestApi74Client::olinkOnRelease()
{
    m_node = nullptr;
}

bool TestApi74Client::isReady() const
{
    return m_node != nullptr;
}

ITestApi74Publisher& TestApi74Client::_getPublisher() const
{
    return *m_publisher;
}
