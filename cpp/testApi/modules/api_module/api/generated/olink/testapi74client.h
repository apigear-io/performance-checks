...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi74 publisher in a way it provides access 
* to remote TestApi74 services. 
...
*     It provides a network implementation and tools to connect TestApi74Client to it.
* Use on client side to request changes of the TestApi74 on the server side 
* and to subscribe for the TestApi74 changes.
*/
class CPP_API_EXPORT TestApi74Client : public ITestApi74,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi74Client();
    /** dtor */
    virtual ~TestApi74Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi74 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi74::funcInt on the TestApi74 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi74::funcFloat on the TestApi74 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi74::funcString on the TestApi74 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi74Client is ready to send and receive messages.
    * @return true if TestApi74 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi74 service
...
private:
    ...
    * @param the data received from TestApi74 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi74Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi74 */
