...
namespace olink {
/**
* Server side for TestApi91 implements the TestApi91 service.
* It is a source of data for TestApi91 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi91Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi91Subscriber
{
public:
    /**
    * ctor
    * @param TestApi91 The service source object, the actual TestApi91 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi91Service(std::shared_ptr<ITestApi91> TestApi91, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi91Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi91 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi91 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi91 object.
    * @return the set of properties with their current values for the TestApi91 object in json format.
    */
...
private:
    /**
    * The TestApi91 used for object source.
    */
    std::shared_ptr<ITestApi91> m_TestApi91;
    /**
