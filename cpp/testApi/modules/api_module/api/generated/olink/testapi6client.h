...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi6 publisher in a way it provides access 
* to remote TestApi6 services. 
...
*     It provides a network implementation and tools to connect TestApi6Client to it.
* Use on client side to request changes of the TestApi6 on the server side 
* and to subscribe for the TestApi6 changes.
*/
class CPP_API_EXPORT TestApi6Client : public ITestApi6,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi6Client();
    /** dtor */
    virtual ~TestApi6Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi6 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi6::funcInt on the TestApi6 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi6::funcFloat on the TestApi6 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi6::funcString on the TestApi6 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi6Client is ready to send and receive messages.
    * @return true if TestApi6 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi6 service
...
private:
    ...
    * @param the data received from TestApi6 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi6Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi6 */
