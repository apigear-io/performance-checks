...
namespace olink {
/**
* Server side for TestApi93 implements the TestApi93 service.
* It is a source of data for TestApi93 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi93Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi93Subscriber
{
public:
    /**
    * ctor
    * @param TestApi93 The service source object, the actual TestApi93 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi93Service(std::shared_ptr<ITestApi93> TestApi93, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi93Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi93 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi93 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi93 object.
    * @return the set of properties with their current values for the TestApi93 object in json format.
    */
...
private:
    /**
    * The TestApi93 used for object source.
    */
    std::shared_ptr<ITestApi93> m_TestApi93;
    /**
