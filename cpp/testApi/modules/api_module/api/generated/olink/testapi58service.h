...
namespace olink {
/**
* Server side for TestApi58 implements the TestApi58 service.
* It is a source of data for TestApi58 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi58Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi58Subscriber
{
public:
    /**
    * ctor
    * @param TestApi58 The service source object, the actual TestApi58 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi58Service(std::shared_ptr<ITestApi58> TestApi58, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi58Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi58 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi58 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi58 object.
    * @return the set of properties with their current values for the TestApi58 object in json format.
    */
...
private:
    /**
    * The TestApi58 used for object source.
    */
    std::shared_ptr<ITestApi58> m_TestApi58;
    /**
