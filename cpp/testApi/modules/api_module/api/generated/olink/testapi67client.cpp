...
TestApi67Client::TestApi67Client()
    : m_publisher(std::make_unique<TestApi67Publisher>())
{}

void TestApi67Client::applyState(const nlohmann::json& fields) 
{
...
void TestApi67Client::setPropInt(int propInt)
{
    if(!m_node) {
...
void TestApi67Client::setPropIntLocal(int propInt)
{
...
int TestApi67Client::getPropInt() const
{
    return m_data.m_propInt;
}

void TestApi67Client::setPropFloat(float propFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi67Client::setPropFloatLocal(float propFloat)
{
...
float TestApi67Client::getPropFloat() const
{
    return m_data.m_propFloat;
}

void TestApi67Client::setPropString(const std::string& propString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi67Client::setPropStringLocal(const std::string& propString)
{
...
const std::string& TestApi67Client::getPropString() const
{
    return m_data.m_propString;
}

int TestApi67Client::funcInt(int paramInt)
{
     if(!m_node) {
...
std::future<int> TestApi67Client::funcIntAsync(int paramInt)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
float TestApi67Client::funcFloat(float paramFloat)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return 0.0f;
...
std::future<float> TestApi67Client::funcFloatAsync(float paramFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi67Client::funcString(const std::string& paramString)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return std::string();
...
std::future<std::string> TestApi67Client::funcStringAsync(const std::string& paramString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi67Client::olinkObjectName()
{
    return interfaceId;
}

void TestApi67Client::olinkOnSignal(const std::string& signalId, const nlohmann::json& args)
{
...
void TestApi67Client::olinkOnPropertyChanged(const std::string& propertyId, const nlohmann::json& value)
{
    applyState({ {ApiGear::ObjectLink::Name::getMemberName(propertyId), value} });
}
void TestApi67Client::olinkOnInit(const std::string& /*name*/, const nlohmann::json& props, ApiGear::ObjectLink::IClientNode *node)
{
    m_node = node;
    applyState(props);
}

void TestApi67Client::olinkOnRelease()
{
    m_node = nullptr;
}

bool TestApi67Client::isReady() const
{
    return m_node != nullptr;
}

ITestApi67Publisher& TestApi67Client::_getPublisher() const
{
    return *m_publisher;
}
