...
namespace olink {
/**
* Server side for TestApi79 implements the TestApi79 service.
* It is a source of data for TestApi79 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi79Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi79Subscriber
{
public:
    /**
    * ctor
    * @param TestApi79 The service source object, the actual TestApi79 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi79Service(std::shared_ptr<ITestApi79> TestApi79, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi79Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi79 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi79 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi79 object.
    * @return the set of properties with their current values for the TestApi79 object in json format.
    */
...
private:
    /**
    * The TestApi79 used for object source.
    */
    std::shared_ptr<ITestApi79> m_TestApi79;
    /**
