...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi66 publisher in a way it provides access 
* to remote TestApi66 services. 
...
*     It provides a network implementation and tools to connect TestApi66Client to it.
* Use on client side to request changes of the TestApi66 on the server side 
* and to subscribe for the TestApi66 changes.
*/
class CPP_API_EXPORT TestApi66Client : public ITestApi66,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi66Client();
    /** dtor */
    virtual ~TestApi66Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi66 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi66::funcInt on the TestApi66 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi66::funcFloat on the TestApi66 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi66::funcString on the TestApi66 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi66Client is ready to send and receive messages.
    * @return true if TestApi66 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi66 service
...
private:
    ...
    * @param the data received from TestApi66 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi66Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi66 */
