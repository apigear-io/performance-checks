...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi92 publisher in a way it provides access 
* to remote TestApi92 services. 
...
*     It provides a network implementation and tools to connect TestApi92Client to it.
* Use on client side to request changes of the TestApi92 on the server side 
* and to subscribe for the TestApi92 changes.
*/
class CPP_API_EXPORT TestApi92Client : public ITestApi92,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi92Client();
    /** dtor */
    virtual ~TestApi92Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi92 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi92::funcInt on the TestApi92 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi92::funcFloat on the TestApi92 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi92::funcString on the TestApi92 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi92Client is ready to send and receive messages.
    * @return true if TestApi92 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi92 service
...
private:
    ...
    * @param the data received from TestApi92 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi92Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi92 */
