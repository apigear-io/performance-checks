...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi88 publisher in a way it provides access 
* to remote TestApi88 services. 
...
*     It provides a network implementation and tools to connect TestApi88Client to it.
* Use on client side to request changes of the TestApi88 on the server side 
* and to subscribe for the TestApi88 changes.
*/
class CPP_API_EXPORT TestApi88Client : public ITestApi88,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi88Client();
    /** dtor */
    virtual ~TestApi88Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi88 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi88::funcInt on the TestApi88 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi88::funcFloat on the TestApi88 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi88::funcString on the TestApi88 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi88Client is ready to send and receive messages.
    * @return true if TestApi88 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi88 service
...
private:
    ...
    * @param the data received from TestApi88 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi88Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi88 */
