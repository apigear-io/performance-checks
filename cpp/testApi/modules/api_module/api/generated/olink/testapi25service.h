...
namespace olink {
/**
* Server side for TestApi25 implements the TestApi25 service.
* It is a source of data for TestApi25 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi25Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi25Subscriber
{
public:
    /**
    * ctor
    * @param TestApi25 The service source object, the actual TestApi25 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi25Service(std::shared_ptr<ITestApi25> TestApi25, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi25Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi25 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi25 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi25 object.
    * @return the set of properties with their current values for the TestApi25 object in json format.
    */
...
private:
    /**
    * The TestApi25 used for object source.
    */
    std::shared_ptr<ITestApi25> m_TestApi25;
    /**
