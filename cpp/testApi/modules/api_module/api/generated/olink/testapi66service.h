...
namespace olink {
/**
* Server side for TestApi66 implements the TestApi66 service.
* It is a source of data for TestApi66 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi66Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi66Subscriber
{
public:
    /**
    * ctor
    * @param TestApi66 The service source object, the actual TestApi66 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi66Service(std::shared_ptr<ITestApi66> TestApi66, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi66Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi66 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi66 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi66 object.
    * @return the set of properties with their current values for the TestApi66 object in json format.
    */
...
private:
    /**
    * The TestApi66 used for object source.
    */
    std::shared_ptr<ITestApi66> m_TestApi66;
    /**
