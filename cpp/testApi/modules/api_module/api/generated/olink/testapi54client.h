...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi54 publisher in a way it provides access 
* to remote TestApi54 services. 
...
*     It provides a network implementation and tools to connect TestApi54Client to it.
* Use on client side to request changes of the TestApi54 on the server side 
* and to subscribe for the TestApi54 changes.
*/
class CPP_API_EXPORT TestApi54Client : public ITestApi54,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi54Client();
    /** dtor */
    virtual ~TestApi54Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi54 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi54::funcInt on the TestApi54 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi54::funcFloat on the TestApi54 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi54::funcString on the TestApi54 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi54Client is ready to send and receive messages.
    * @return true if TestApi54 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi54 service
...
private:
    ...
    * @param the data received from TestApi54 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi54Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi54 */
