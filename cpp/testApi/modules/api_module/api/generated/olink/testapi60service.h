...
namespace olink {
/**
* Server side for TestApi60 implements the TestApi60 service.
* It is a source of data for TestApi60 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi60Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi60Subscriber
{
public:
    /**
    * ctor
    * @param TestApi60 The service source object, the actual TestApi60 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi60Service(std::shared_ptr<ITestApi60> TestApi60, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi60Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi60 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi60 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi60 object.
    * @return the set of properties with their current values for the TestApi60 object in json format.
    */
...
private:
    /**
    * The TestApi60 used for object source.
    */
    std::shared_ptr<ITestApi60> m_TestApi60;
    /**
