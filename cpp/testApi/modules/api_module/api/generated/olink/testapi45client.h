...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi45 publisher in a way it provides access 
* to remote TestApi45 services. 
...
*     It provides a network implementation and tools to connect TestApi45Client to it.
* Use on client side to request changes of the TestApi45 on the server side 
* and to subscribe for the TestApi45 changes.
*/
class CPP_API_EXPORT TestApi45Client : public ITestApi45,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi45Client();
    /** dtor */
    virtual ~TestApi45Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi45 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi45::funcInt on the TestApi45 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi45::funcFloat on the TestApi45 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi45::funcString on the TestApi45 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi45Client is ready to send and receive messages.
    * @return true if TestApi45 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi45 service
...
private:
    ...
    * @param the data received from TestApi45 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi45Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi45 */
