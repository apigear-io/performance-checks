...
namespace olink {
/**
* Server side for TestApi15 implements the TestApi15 service.
* It is a source of data for TestApi15 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi15Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi15Subscriber
{
public:
    /**
    * ctor
    * @param TestApi15 The service source object, the actual TestApi15 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi15Service(std::shared_ptr<ITestApi15> TestApi15, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi15Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi15 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi15 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi15 object.
    * @return the set of properties with their current values for the TestApi15 object in json format.
    */
...
private:
    /**
    * The TestApi15 used for object source.
    */
    std::shared_ptr<ITestApi15> m_TestApi15;
    /**
