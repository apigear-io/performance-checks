...
#include "api/generated/core/testapi28.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi28 publisher in a way it provides access 
* to remote TestApi28 services. 
...
*     It provides a network implementation and tools to connect TestApi28Client to it.
* Use on client side to request changes of the TestApi28 on the server side 
* and to subscribe for the TestApi28 changes.
*/
class CPP_API_EXPORT TestApi28Client : public ITestApi28,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi28Client();
    /** dtor */
    virtual ~TestApi28Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi28 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi28::funcInt on the TestApi28 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi28::funcFloat on the TestApi28 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi28::funcString on the TestApi28 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi28Client is ready to send and receive messages.
    * @return true if TestApi28 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi28 service
...
private:
    ...
    * @param the data received from TestApi28 service.
    */
    ...
    TestApi28Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi28Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi28 */
    std::unique_ptr<ITestApi28Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
