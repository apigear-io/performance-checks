...
#include "api/generated/core/testapi40.data.h"
...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi40 publisher in a way it provides access 
* to remote TestApi40 services. 
...
*     It provides a network implementation and tools to connect TestApi40Client to it.
* Use on client side to request changes of the TestApi40 on the server side 
* and to subscribe for the TestApi40 changes.
*/
class CPP_API_EXPORT TestApi40Client : public ITestApi40,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi40Client();
    /** dtor */
    virtual ~TestApi40Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi40 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi40::funcInt on the TestApi40 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi40::funcFloat on the TestApi40 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi40::funcString on the TestApi40 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi40Client is ready to send and receive messages.
    * @return true if TestApi40 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi40 service
...
private:
    ...
    * @param the data received from TestApi40 service.
    */
    ...
    TestApi40Data m_data;

    /** 
    * An abstraction layer over the connection with service for the TestApi40Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi40 */
    std::unique_ptr<ITestApi40Publisher> m_publisher;
};
} // namespace olink
} // namespace Api
} // namespace Cpp
