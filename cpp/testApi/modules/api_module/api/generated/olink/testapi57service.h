...
namespace olink {
/**
* Server side for TestApi57 implements the TestApi57 service.
* It is a source of data for TestApi57 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi57Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi57Subscriber
{
public:
    /**
    * ctor
    * @param TestApi57 The service source object, the actual TestApi57 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi57Service(std::shared_ptr<ITestApi57> TestApi57, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi57Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi57 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi57 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi57 object.
    * @return the set of properties with their current values for the TestApi57 object in json format.
    */
...
private:
    /**
    * The TestApi57 used for object source.
    */
    std::shared_ptr<ITestApi57> m_TestApi57;
    /**
