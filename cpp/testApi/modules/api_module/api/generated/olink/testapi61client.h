...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi61 publisher in a way it provides access 
* to remote TestApi61 services. 
...
*     It provides a network implementation and tools to connect TestApi61Client to it.
* Use on client side to request changes of the TestApi61 on the server side 
* and to subscribe for the TestApi61 changes.
*/
class CPP_API_EXPORT TestApi61Client : public ITestApi61,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi61Client();
    /** dtor */
    virtual ~TestApi61Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi61 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi61::funcInt on the TestApi61 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi61::funcFloat on the TestApi61 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi61::funcString on the TestApi61 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi61Client is ready to send and receive messages.
    * @return true if TestApi61 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi61 service
...
private:
    ...
    * @param the data received from TestApi61 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi61Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi61 */
