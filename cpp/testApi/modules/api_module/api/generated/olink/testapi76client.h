...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi76 publisher in a way it provides access 
* to remote TestApi76 services. 
...
*     It provides a network implementation and tools to connect TestApi76Client to it.
* Use on client side to request changes of the TestApi76 on the server side 
* and to subscribe for the TestApi76 changes.
*/
class CPP_API_EXPORT TestApi76Client : public ITestApi76,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi76Client();
    /** dtor */
    virtual ~TestApi76Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi76 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi76::funcInt on the TestApi76 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi76::funcFloat on the TestApi76 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi76::funcString on the TestApi76 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi76Client is ready to send and receive messages.
    * @return true if TestApi76 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi76 service
...
private:
    ...
    * @param the data received from TestApi76 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi76Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi76 */
