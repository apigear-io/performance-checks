...
namespace olink {
/**
* Server side for TestApi8 implements the TestApi8 service.
* It is a source of data for TestApi8 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi8Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi8Subscriber
{
public:
    /**
    * ctor
    * @param TestApi8 The service source object, the actual TestApi8 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi8Service(std::shared_ptr<ITestApi8> TestApi8, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi8Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi8 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi8 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi8 object.
    * @return the set of properties with their current values for the TestApi8 object in json format.
    */
...
private:
    /**
    * The TestApi8 used for object source.
    */
    std::shared_ptr<ITestApi8> m_TestApi8;
    /**
