...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi52 publisher in a way it provides access 
* to remote TestApi52 services. 
...
*     It provides a network implementation and tools to connect TestApi52Client to it.
* Use on client side to request changes of the TestApi52 on the server side 
* and to subscribe for the TestApi52 changes.
*/
class CPP_API_EXPORT TestApi52Client : public ITestApi52,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi52Client();
    /** dtor */
    virtual ~TestApi52Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi52 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi52::funcInt on the TestApi52 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi52::funcFloat on the TestApi52 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi52::funcString on the TestApi52 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi52Client is ready to send and receive messages.
    * @return true if TestApi52 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi52 service
...
private:
    ...
    * @param the data received from TestApi52 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi52Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi52 */
