...
TestApi14Client::TestApi14Client()
    : m_publisher(std::make_unique<TestApi14Publisher>())
{}

void TestApi14Client::applyState(const nlohmann::json& fields) 
{
...
void TestApi14Client::setPropInt(int propInt)
{
    if(!m_node) {
...
void TestApi14Client::setPropIntLocal(int propInt)
{
...
int TestApi14Client::getPropInt() const
{
    return m_data.m_propInt;
}

void TestApi14Client::setPropFloat(float propFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi14Client::setPropFloatLocal(float propFloat)
{
...
float TestApi14Client::getPropFloat() const
{
    return m_data.m_propFloat;
}

void TestApi14Client::setPropString(const std::string& propString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to set property but " + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return;
...
void TestApi14Client::setPropStringLocal(const std::string& propString)
{
...
const std::string& TestApi14Client::getPropString() const
{
    return m_data.m_propString;
}

int TestApi14Client::funcInt(int paramInt)
{
     if(!m_node) {
...
std::future<int> TestApi14Client::funcIntAsync(int paramInt)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
float TestApi14Client::funcFloat(float paramFloat)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return 0.0f;
...
std::future<float> TestApi14Client::funcFloatAsync(float paramFloat)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi14Client::funcString(const std::string& paramString)
{
     if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
        return std::string();
...
std::future<std::string> TestApi14Client::funcStringAsync(const std::string& paramString)
{
    if(!m_node) {
        AG_LOG_WARNING("Attempt to invoke method but" + olinkObjectName() +" is not linked to source . Make sure your object is linked. Check your connection to service");
...
std::string TestApi14Client::olinkObjectName()
{
    return interfaceId;
}

void TestApi14Client::olinkOnSignal(const std::string& signalId, const nlohmann::json& args)
{
...
void TestApi14Client::olinkOnPropertyChanged(const std::string& propertyId, const nlohmann::json& value)
{
    applyState({ {ApiGear::ObjectLink::Name::getMemberName(propertyId), value} });
}
void TestApi14Client::olinkOnInit(const std::string& /*name*/, const nlohmann::json& props, ApiGear::ObjectLink::IClientNode *node)
{
    m_node = node;
    applyState(props);
}

void TestApi14Client::olinkOnRelease()
{
    m_node = nullptr;
}

bool TestApi14Client::isReady() const
{
    return m_node != nullptr;
}

ITestApi14Publisher& TestApi14Client::_getPublisher() const
{
    return *m_publisher;
}
