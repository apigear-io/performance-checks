...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi12 publisher in a way it provides access 
* to remote TestApi12 services. 
...
*     It provides a network implementation and tools to connect TestApi12Client to it.
* Use on client side to request changes of the TestApi12 on the server side 
* and to subscribe for the TestApi12 changes.
*/
class CPP_API_EXPORT TestApi12Client : public ITestApi12,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi12Client();
    /** dtor */
    virtual ~TestApi12Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi12 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi12::funcInt on the TestApi12 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi12::funcFloat on the TestApi12 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi12::funcString on the TestApi12 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi12Client is ready to send and receive messages.
    * @return true if TestApi12 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi12 service
...
private:
    ...
    * @param the data received from TestApi12 service.
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi12Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi12 */
