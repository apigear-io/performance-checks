...
namespace olink {
/**
* Server side for TestApi11 implements the TestApi11 service.
* It is a source of data for TestApi11 clients.
* Sends and receives data over the network with ObjectLink protocol. 
* see https://objectlinkprotocol.net for Object Link Details
*/
class CPP_API_EXPORT TestApi11Service : public ApiGear::ObjectLink::IObjectSource, public ITestApi11Subscriber
{
public:
    /**
    * ctor
    * @param TestApi11 The service source object, the actual TestApi11 object which is exposed for remote clients with olink.
    * @param registry The global registry that keeps track of the object source services associated with network nodes.
    */
    explicit TestApi11Service(std::shared_ptr<ITestApi11> TestApi11, ApiGear::ObjectLink::RemoteRegistry& registry);
    virtual ~TestApi11Service() override;
    ...
    */
    ...
    /**
    * Applies received method invocation with given arguments on the TestApi11 object.
    ...
    */
    ...
    /**
    * Applies received change property request to TestApi11 object.
    ...
    */
    ...
    /**
    * Gets the current state of TestApi11 object.
    * @return the set of properties with their current values for the TestApi11 object in json format.
    */
...
private:
    /**
    * The TestApi11 used for object source.
    */
    std::shared_ptr<ITestApi11> m_TestApi11;
    /**
