...
/**
* The TestApi77 implementation.
*/
class CPP_API_EXPORT TestApi77 : public ITestApi77
{
public:
    explicit TestApi77();
    ~TestApi77();
...
private:
    /** The publisher for the TestApi77. */
    std::unique_ptr<ITestApi77Publisher> m_publisher;
    /** The helper structure to store all the properties for TestApi77. */
