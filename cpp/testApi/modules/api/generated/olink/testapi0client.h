...
namespace olink {
/**
* Adapts the general OLink Client handler to a TestApi0 publisher in a way it provides access 
* to remote TestApi0 services. 
...
*     It provides a network implementation and tools to connect TestApi0Client to it.
* Use on client side to request changes of the TestApi0 on the server side 
* and to subscribe for the TestApi0 changes.
*/
class CPP_API_EXPORT TestApi0Client : public ITestApi0,
    public ApiGear::ObjectLink::IObjectSink
{
public:

    /** ctor */
    explicit TestApi0Client();
    /** dtor */
    virtual ~TestApi0Client() = default;
    /**
    * Property getter
    ...
    */
    ...
    /**
    * Request setting a property on the TestApi0 service.
    ...
    */
    ...
    /**
    * Remote call of ITestApi0::funcInt on the TestApi0 service.
    * Uses funcIntAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi0::funcFloat on the TestApi0 service.
    * Uses funcFloatAsync
    */
    ...
    */
    ...
    /**
    * Remote call of ITestApi0::funcString on the TestApi0 service.
    ...
    */
    ...
    /**
    * Informs if the TestApi0Client is ready to send and receive messages.
    * @return true if TestApi0 is operable, false otherwise.
    */
    bool isReady() const;
    ...
    * @param props Initial values obtained from the TestApi0 service
    ...
    */
    ...
    ApiGear::ObjectLink::IClientNode* getNode() 
    {
        return m_node;
    }
...
private:
    ...
    * @param the data received from TestApi0 service.
    */
    ...
    */
    ...
    /** 
    * An abstraction layer over the connection with service for the TestApi0Client.
    * Handles incoming and outgoing messages.
    * Is given when object is linked with the service.
    */
    ApiGear::ObjectLink::IClientNode* m_node = nullptr;

    /** The publisher for TestApi0 */
