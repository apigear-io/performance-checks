...
#include "olinktestapi76adapter.h"
...
OLinkTestApi76Adapter::OLinkTestApi76Adapter(RemoteRegistry& registry, AbstractTestApi76* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi76::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi76::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi76::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi76::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi76::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi76::sigString, this,
...
json OLinkTestApi76Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi76Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi76Adapter::olinkObjectName() {
    return "api.TestApi76";
}

json OLinkTestApi76Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi76Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi76Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi76Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi76Adapter::olinkCollectProperties()
{
    return captureState();
}
