...
#include "olinktestapi1adapter.h"
...
OLinkTestApi1Adapter::OLinkTestApi1Adapter(RemoteRegistry& registry, AbstractTestApi1* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi1::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi1::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi1::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi1::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi1::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi1::sigString, this,
...
json OLinkTestApi1Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi1Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi1Adapter::olinkObjectName() {
    return "api.TestApi1";
}

json OLinkTestApi1Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi1Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi1Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi1Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi1Adapter::olinkCollectProperties()
{
    return captureState();
}
