...
#include "olinktestapi91adapter.h"
...
OLinkTestApi91Adapter::OLinkTestApi91Adapter(RemoteRegistry& registry, AbstractTestApi91* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi91::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi91::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi91::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi91::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi91::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi91::sigString, this,
...
json OLinkTestApi91Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi91Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi91Adapter::olinkObjectName() {
    return "api.TestApi91";
}

json OLinkTestApi91Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi91Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi91Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi91Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi91Adapter::olinkCollectProperties()
{
    return captureState();
}
