...
#include "olinktestapi79adapter.h"
...
OLinkTestApi79Adapter::OLinkTestApi79Adapter(RemoteRegistry& registry, AbstractTestApi79* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi79::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi79::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi79::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi79::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi79::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi79::sigString, this,
...
json OLinkTestApi79Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi79Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi79Adapter::olinkObjectName() {
    return "api.TestApi79";
}

json OLinkTestApi79Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi79Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi79Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi79Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi79Adapter::olinkCollectProperties()
{
    return captureState();
}
