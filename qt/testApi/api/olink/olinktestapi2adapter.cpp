...
#include "olinktestapi2adapter.h"
...
OLinkTestApi2Adapter::OLinkTestApi2Adapter(RemoteRegistry& registry, AbstractTestApi2* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi2::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi2::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi2::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi2::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi2::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi2::sigString, this,
...
json OLinkTestApi2Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi2Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi2Adapter::olinkObjectName() {
    return "api.TestApi2";
}

json OLinkTestApi2Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi2Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi2Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi2Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi2Adapter::olinkCollectProperties()
{
    return captureState();
}
