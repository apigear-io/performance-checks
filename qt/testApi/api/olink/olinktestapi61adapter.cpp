...
#include "olinktestapi61adapter.h"
...
OLinkTestApi61Adapter::OLinkTestApi61Adapter(RemoteRegistry& registry, AbstractTestApi61* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi61::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi61::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi61::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi61::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi61::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi61::sigString, this,
...
json OLinkTestApi61Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi61Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi61Adapter::olinkObjectName() {
    return "api.TestApi61";
}

json OLinkTestApi61Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi61Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi61Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi61Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi61Adapter::olinkCollectProperties()
{
    return captureState();
}
