...
#include "olinktestapi40adapter.h"
...
OLinkTestApi40Adapter::OLinkTestApi40Adapter(RemoteRegistry& registry, AbstractTestApi40* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi40::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi40::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi40::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi40::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi40::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi40::sigString, this,
...
json OLinkTestApi40Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi40Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi40Adapter::olinkObjectName() {
    return "api.TestApi40";
}

json OLinkTestApi40Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi40Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi40Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi40Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi40Adapter::olinkCollectProperties()
{
    return captureState();
}
