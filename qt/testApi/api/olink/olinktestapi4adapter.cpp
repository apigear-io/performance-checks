...
#include "olinktestapi4adapter.h"
...
OLinkTestApi4Adapter::OLinkTestApi4Adapter(RemoteRegistry& registry, AbstractTestApi4* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi4::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi4::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi4::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi4::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi4::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi4::sigString, this,
...
json OLinkTestApi4Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi4Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi4Adapter::olinkObjectName() {
    return "api.TestApi4";
}

json OLinkTestApi4Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi4Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi4Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi4Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi4Adapter::olinkCollectProperties()
{
    return captureState();
}
