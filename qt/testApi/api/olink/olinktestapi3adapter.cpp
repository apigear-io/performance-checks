...
#include "olinktestapi3adapter.h"
...
OLinkTestApi3Adapter::OLinkTestApi3Adapter(RemoteRegistry& registry, AbstractTestApi3* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi3::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi3::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi3::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi3::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi3::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi3::sigString, this,
...
json OLinkTestApi3Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi3Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi3Adapter::olinkObjectName() {
    return "api.TestApi3";
}

json OLinkTestApi3Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi3Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi3Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi3Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi3Adapter::olinkCollectProperties()
{
    return captureState();
}
