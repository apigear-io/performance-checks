...
#include "olinktestapi41adapter.h"
...
OLinkTestApi41Adapter::OLinkTestApi41Adapter(RemoteRegistry& registry, AbstractTestApi41* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi41::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi41::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi41::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi41::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi41::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi41::sigString, this,
...
json OLinkTestApi41Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi41Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi41Adapter::olinkObjectName() {
    return "api.TestApi41";
}

json OLinkTestApi41Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi41Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi41Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi41Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi41Adapter::olinkCollectProperties()
{
    return captureState();
}
