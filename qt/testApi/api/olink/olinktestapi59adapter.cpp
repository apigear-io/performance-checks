...
#include "olinktestapi59adapter.h"
...
OLinkTestApi59Adapter::OLinkTestApi59Adapter(RemoteRegistry& registry, AbstractTestApi59* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi59::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi59::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi59::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi59::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi59::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi59::sigString, this,
...
json OLinkTestApi59Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi59Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi59Adapter::olinkObjectName() {
    return "api.TestApi59";
}

json OLinkTestApi59Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi59Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi59Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi59Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi59Adapter::olinkCollectProperties()
{
    return captureState();
}
