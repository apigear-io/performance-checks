...
#include "olinktestapi21adapter.h"
...
OLinkTestApi21Adapter::OLinkTestApi21Adapter(RemoteRegistry& registry, AbstractTestApi21* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi21::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi21::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi21::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi21::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi21::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi21::sigString, this,
...
json OLinkTestApi21Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi21Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi21Adapter::olinkObjectName() {
    return "api.TestApi21";
}

json OLinkTestApi21Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi21Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi21Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi21Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi21Adapter::olinkCollectProperties()
{
    return captureState();
}
