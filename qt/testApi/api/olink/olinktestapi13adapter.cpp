...
#include "olinktestapi13adapter.h"
...
OLinkTestApi13Adapter::OLinkTestApi13Adapter(RemoteRegistry& registry, AbstractTestApi13* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi13::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi13::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi13::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi13::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi13::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi13::sigString, this,
...
json OLinkTestApi13Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi13Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi13Adapter::olinkObjectName() {
    return "api.TestApi13";
}

json OLinkTestApi13Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi13Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi13Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi13Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi13Adapter::olinkCollectProperties()
{
    return captureState();
}
