...
#include "olinktestapi69adapter.h"
...
OLinkTestApi69Adapter::OLinkTestApi69Adapter(RemoteRegistry& registry, AbstractTestApi69* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi69::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi69::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi69::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi69::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi69::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi69::sigString, this,
...
json OLinkTestApi69Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi69Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi69Adapter::olinkObjectName() {
    return "api.TestApi69";
}

json OLinkTestApi69Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi69Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi69Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi69Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi69Adapter::olinkCollectProperties()
{
    return captureState();
}
