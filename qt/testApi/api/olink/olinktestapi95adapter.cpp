...
#include "olinktestapi95adapter.h"
...
OLinkTestApi95Adapter::OLinkTestApi95Adapter(RemoteRegistry& registry, AbstractTestApi95* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi95::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi95::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi95::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi95::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi95::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi95::sigString, this,
...
json OLinkTestApi95Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi95Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi95Adapter::olinkObjectName() {
    return "api.TestApi95";
}

json OLinkTestApi95Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi95Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi95Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi95Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi95Adapter::olinkCollectProperties()
{
    return captureState();
}
