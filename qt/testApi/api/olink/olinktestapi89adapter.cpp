...
#include "olinktestapi89adapter.h"
...
OLinkTestApi89Adapter::OLinkTestApi89Adapter(RemoteRegistry& registry, AbstractTestApi89* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi89::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi89::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi89::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi89::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi89::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi89::sigString, this,
...
json OLinkTestApi89Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi89Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi89Adapter::olinkObjectName() {
    return "api.TestApi89";
}

json OLinkTestApi89Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi89Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi89Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi89Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi89Adapter::olinkCollectProperties()
{
    return captureState();
}
