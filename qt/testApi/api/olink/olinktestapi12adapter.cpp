...
#include "olinktestapi12adapter.h"
...
OLinkTestApi12Adapter::OLinkTestApi12Adapter(RemoteRegistry& registry, AbstractTestApi12* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi12::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi12::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi12::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi12::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi12::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi12::sigString, this,
...
json OLinkTestApi12Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi12Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi12Adapter::olinkObjectName() {
    return "api.TestApi12";
}

json OLinkTestApi12Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi12Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi12Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi12Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi12Adapter::olinkCollectProperties()
{
    return captureState();
}
