...
#include "olinktestapi46adapter.h"
...
OLinkTestApi46Adapter::OLinkTestApi46Adapter(RemoteRegistry& registry, AbstractTestApi46* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi46::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi46::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi46::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi46::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi46::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi46::sigString, this,
...
json OLinkTestApi46Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi46Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi46Adapter::olinkObjectName() {
    return "api.TestApi46";
}

json OLinkTestApi46Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi46Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi46Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi46Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi46Adapter::olinkCollectProperties()
{
    return captureState();
}
