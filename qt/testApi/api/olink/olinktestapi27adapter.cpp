...
#include "olinktestapi27adapter.h"
...
OLinkTestApi27Adapter::OLinkTestApi27Adapter(RemoteRegistry& registry, AbstractTestApi27* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi27::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi27::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi27::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi27::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi27::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi27::sigString, this,
...
json OLinkTestApi27Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi27Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi27Adapter::olinkObjectName() {
    return "api.TestApi27";
}

json OLinkTestApi27Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi27Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi27Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi27Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi27Adapter::olinkCollectProperties()
{
    return captureState();
}
