...
#include "olinktestapi35adapter.h"
...
OLinkTestApi35Adapter::OLinkTestApi35Adapter(RemoteRegistry& registry, AbstractTestApi35* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi35::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi35::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi35::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi35::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi35::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi35::sigString, this,
...
json OLinkTestApi35Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi35Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi35Adapter::olinkObjectName() {
    return "api.TestApi35";
}

json OLinkTestApi35Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi35Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi35Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi35Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi35Adapter::olinkCollectProperties()
{
    return captureState();
}
