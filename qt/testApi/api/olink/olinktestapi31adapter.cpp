...
#include "olinktestapi31adapter.h"
...
OLinkTestApi31Adapter::OLinkTestApi31Adapter(RemoteRegistry& registry, AbstractTestApi31* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi31::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi31::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi31::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi31::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi31::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi31::sigString, this,
...
json OLinkTestApi31Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi31Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi31Adapter::olinkObjectName() {
    return "api.TestApi31";
}

json OLinkTestApi31Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi31Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi31Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi31Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi31Adapter::olinkCollectProperties()
{
    return captureState();
}
