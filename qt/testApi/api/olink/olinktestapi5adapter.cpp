...
#include "olinktestapi5adapter.h"
...
OLinkTestApi5Adapter::OLinkTestApi5Adapter(RemoteRegistry& registry, AbstractTestApi5* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi5::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi5::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi5::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi5::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi5::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi5::sigString, this,
...
json OLinkTestApi5Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi5Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi5Adapter::olinkObjectName() {
    return "api.TestApi5";
}

json OLinkTestApi5Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi5Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi5Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi5Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi5Adapter::olinkCollectProperties()
{
    return captureState();
}
