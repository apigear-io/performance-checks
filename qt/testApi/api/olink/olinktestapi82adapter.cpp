...
#include "olinktestapi82adapter.h"
...
OLinkTestApi82Adapter::OLinkTestApi82Adapter(RemoteRegistry& registry, AbstractTestApi82* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi82::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi82::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi82::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi82::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi82::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi82::sigString, this,
...
json OLinkTestApi82Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi82Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi82Adapter::olinkObjectName() {
    return "api.TestApi82";
}

json OLinkTestApi82Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi82Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi82Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi82Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi82Adapter::olinkCollectProperties()
{
    return captureState();
}
