...
#include "olinktestapi72adapter.h"
...
OLinkTestApi72Adapter::OLinkTestApi72Adapter(RemoteRegistry& registry, AbstractTestApi72* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi72::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi72::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi72::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi72::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi72::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi72::sigString, this,
...
json OLinkTestApi72Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi72Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi72Adapter::olinkObjectName() {
    return "api.TestApi72";
}

json OLinkTestApi72Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi72Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi72Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi72Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi72Adapter::olinkCollectProperties()
{
    return captureState();
}
