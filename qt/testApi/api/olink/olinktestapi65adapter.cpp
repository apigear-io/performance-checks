...
#include "olinktestapi65adapter.h"
...
OLinkTestApi65Adapter::OLinkTestApi65Adapter(RemoteRegistry& registry, AbstractTestApi65* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi65::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi65::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi65::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi65::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi65::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi65::sigString, this,
...
json OLinkTestApi65Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi65Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi65Adapter::olinkObjectName() {
    return "api.TestApi65";
}

json OLinkTestApi65Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi65Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi65Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi65Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi65Adapter::olinkCollectProperties()
{
    return captureState();
}
