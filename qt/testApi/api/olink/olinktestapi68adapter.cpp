...
#include "olinktestapi68adapter.h"
...
OLinkTestApi68Adapter::OLinkTestApi68Adapter(RemoteRegistry& registry, AbstractTestApi68* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi68::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi68::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi68::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi68::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi68::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi68::sigString, this,
...
json OLinkTestApi68Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi68Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi68Adapter::olinkObjectName() {
    return "api.TestApi68";
}

json OLinkTestApi68Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi68Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi68Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi68Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi68Adapter::olinkCollectProperties()
{
    return captureState();
}
