...
#include "olinktestapi80adapter.h"
...
OLinkTestApi80Adapter::OLinkTestApi80Adapter(RemoteRegistry& registry, AbstractTestApi80* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi80::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi80::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi80::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi80::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi80::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi80::sigString, this,
...
json OLinkTestApi80Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi80Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi80Adapter::olinkObjectName() {
    return "api.TestApi80";
}

json OLinkTestApi80Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi80Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi80Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi80Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi80Adapter::olinkCollectProperties()
{
    return captureState();
}
