...
#include "olinktestapi42adapter.h"
...
OLinkTestApi42Adapter::OLinkTestApi42Adapter(RemoteRegistry& registry, AbstractTestApi42* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi42::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi42::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi42::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi42::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi42::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi42::sigString, this,
...
json OLinkTestApi42Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi42Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi42Adapter::olinkObjectName() {
    return "api.TestApi42";
}

json OLinkTestApi42Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi42Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi42Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi42Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi42Adapter::olinkCollectProperties()
{
    return captureState();
}
