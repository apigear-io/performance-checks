...
#include "olinktestapi26adapter.h"
...
OLinkTestApi26Adapter::OLinkTestApi26Adapter(RemoteRegistry& registry, AbstractTestApi26* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi26::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi26::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi26::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi26::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi26::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi26::sigString, this,
...
json OLinkTestApi26Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi26Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi26Adapter::olinkObjectName() {
    return "api.TestApi26";
}

json OLinkTestApi26Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi26Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi26Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi26Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi26Adapter::olinkCollectProperties()
{
    return captureState();
}
