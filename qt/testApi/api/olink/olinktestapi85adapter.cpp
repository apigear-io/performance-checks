...
#include "olinktestapi85adapter.h"
...
OLinkTestApi85Adapter::OLinkTestApi85Adapter(RemoteRegistry& registry, AbstractTestApi85* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi85::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi85::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi85::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi85::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi85::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi85::sigString, this,
...
json OLinkTestApi85Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi85Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi85Adapter::olinkObjectName() {
    return "api.TestApi85";
}

json OLinkTestApi85Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi85Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi85Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi85Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi85Adapter::olinkCollectProperties()
{
    return captureState();
}
