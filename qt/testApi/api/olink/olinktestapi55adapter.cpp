...
#include "olinktestapi55adapter.h"
...
OLinkTestApi55Adapter::OLinkTestApi55Adapter(RemoteRegistry& registry, AbstractTestApi55* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi55::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi55::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi55::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi55::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi55::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi55::sigString, this,
...
json OLinkTestApi55Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi55Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi55Adapter::olinkObjectName() {
    return "api.TestApi55";
}

json OLinkTestApi55Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi55Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi55Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi55Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi55Adapter::olinkCollectProperties()
{
    return captureState();
}
