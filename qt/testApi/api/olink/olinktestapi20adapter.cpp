...
#include "olinktestapi20adapter.h"
...
OLinkTestApi20Adapter::OLinkTestApi20Adapter(RemoteRegistry& registry, AbstractTestApi20* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi20::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi20::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi20::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi20::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi20::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi20::sigString, this,
...
json OLinkTestApi20Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi20Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi20Adapter::olinkObjectName() {
    return "api.TestApi20";
}

json OLinkTestApi20Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi20Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi20Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi20Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi20Adapter::olinkCollectProperties()
{
    return captureState();
}
