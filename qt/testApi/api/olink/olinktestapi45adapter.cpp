...
#include "olinktestapi45adapter.h"
...
OLinkTestApi45Adapter::OLinkTestApi45Adapter(RemoteRegistry& registry, AbstractTestApi45* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi45::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi45::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi45::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi45::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi45::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi45::sigString, this,
...
json OLinkTestApi45Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi45Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi45Adapter::olinkObjectName() {
    return "api.TestApi45";
}

json OLinkTestApi45Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi45Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi45Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi45Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi45Adapter::olinkCollectProperties()
{
    return captureState();
}
