...
#include "olinktestapi92adapter.h"
...
OLinkTestApi92Adapter::OLinkTestApi92Adapter(RemoteRegistry& registry, AbstractTestApi92* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi92::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi92::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi92::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi92::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi92::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi92::sigString, this,
...
json OLinkTestApi92Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi92Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi92Adapter::olinkObjectName() {
    return "api.TestApi92";
}

json OLinkTestApi92Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi92Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi92Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi92Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi92Adapter::olinkCollectProperties()
{
    return captureState();
}
