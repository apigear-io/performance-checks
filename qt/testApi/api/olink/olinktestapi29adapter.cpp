...
#include "olinktestapi29adapter.h"
...
OLinkTestApi29Adapter::OLinkTestApi29Adapter(RemoteRegistry& registry, AbstractTestApi29* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi29::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi29::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi29::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi29::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi29::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi29::sigString, this,
...
json OLinkTestApi29Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi29Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi29Adapter::olinkObjectName() {
    return "api.TestApi29";
}

json OLinkTestApi29Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi29Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi29Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi29Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi29Adapter::olinkCollectProperties()
{
    return captureState();
}
