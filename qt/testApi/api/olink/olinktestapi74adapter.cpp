...
#include "olinktestapi74adapter.h"
...
OLinkTestApi74Adapter::OLinkTestApi74Adapter(RemoteRegistry& registry, AbstractTestApi74* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi74::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi74::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi74::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi74::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi74::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi74::sigString, this,
...
json OLinkTestApi74Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi74Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi74Adapter::olinkObjectName() {
    return "api.TestApi74";
}

json OLinkTestApi74Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi74Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi74Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi74Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi74Adapter::olinkCollectProperties()
{
    return captureState();
}
