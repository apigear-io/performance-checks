...
#include "olinktestapi10adapter.h"
...
OLinkTestApi10Adapter::OLinkTestApi10Adapter(RemoteRegistry& registry, AbstractTestApi10* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi10::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi10::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi10::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi10::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi10::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi10::sigString, this,
...
json OLinkTestApi10Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi10Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi10Adapter::olinkObjectName() {
    return "api.TestApi10";
}

json OLinkTestApi10Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi10Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi10Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi10Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi10Adapter::olinkCollectProperties()
{
    return captureState();
}
