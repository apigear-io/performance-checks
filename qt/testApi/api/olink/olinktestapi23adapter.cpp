...
#include "olinktestapi23adapter.h"
...
OLinkTestApi23Adapter::OLinkTestApi23Adapter(RemoteRegistry& registry, AbstractTestApi23* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi23::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi23::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi23::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi23::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi23::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi23::sigString, this,
...
json OLinkTestApi23Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi23Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi23Adapter::olinkObjectName() {
    return "api.TestApi23";
}

json OLinkTestApi23Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi23Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi23Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi23Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi23Adapter::olinkCollectProperties()
{
    return captureState();
}
