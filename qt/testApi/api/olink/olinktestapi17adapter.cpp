...
#include "olinktestapi17adapter.h"
...
OLinkTestApi17Adapter::OLinkTestApi17Adapter(RemoteRegistry& registry, AbstractTestApi17* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi17::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi17::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi17::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi17::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi17::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi17::sigString, this,
...
json OLinkTestApi17Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi17Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi17Adapter::olinkObjectName() {
    return "api.TestApi17";
}

json OLinkTestApi17Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi17Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi17Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi17Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi17Adapter::olinkCollectProperties()
{
    return captureState();
}
