...
#include "olinktestapi88adapter.h"
...
OLinkTestApi88Adapter::OLinkTestApi88Adapter(RemoteRegistry& registry, AbstractTestApi88* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi88::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi88::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi88::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi88::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi88::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi88::sigString, this,
...
json OLinkTestApi88Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi88Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi88Adapter::olinkObjectName() {
    return "api.TestApi88";
}

json OLinkTestApi88Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi88Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi88Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi88Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi88Adapter::olinkCollectProperties()
{
    return captureState();
}
