...
#include "olinktestapi0adapter.h"
...
OLinkTestApi0Adapter::OLinkTestApi0Adapter(RemoteRegistry& registry, AbstractTestApi0* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi0::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi0::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi0::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi0::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi0::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi0::sigString, this,
...
json OLinkTestApi0Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi0Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi0Adapter::olinkObjectName() {
    return "api.TestApi0";
}

json OLinkTestApi0Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi0Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi0Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi0Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi0Adapter::olinkCollectProperties()
{
    return captureState();
}
