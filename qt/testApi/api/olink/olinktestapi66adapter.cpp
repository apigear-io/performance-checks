...
#include "olinktestapi66adapter.h"
...
OLinkTestApi66Adapter::OLinkTestApi66Adapter(RemoteRegistry& registry, AbstractTestApi66* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi66::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi66::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi66::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi66::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi66::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi66::sigString, this,
...
json OLinkTestApi66Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi66Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi66Adapter::olinkObjectName() {
    return "api.TestApi66";
}

json OLinkTestApi66Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi66Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi66Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi66Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi66Adapter::olinkCollectProperties()
{
    return captureState();
}
