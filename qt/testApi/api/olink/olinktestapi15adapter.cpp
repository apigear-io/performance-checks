...
#include "olinktestapi15adapter.h"
...
OLinkTestApi15Adapter::OLinkTestApi15Adapter(RemoteRegistry& registry, AbstractTestApi15* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi15::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi15::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi15::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi15::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi15::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi15::sigString, this,
...
json OLinkTestApi15Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi15Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi15Adapter::olinkObjectName() {
    return "api.TestApi15";
}

json OLinkTestApi15Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi15Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi15Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi15Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi15Adapter::olinkCollectProperties()
{
    return captureState();
}
