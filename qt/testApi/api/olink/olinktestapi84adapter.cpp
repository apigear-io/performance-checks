...
#include "olinktestapi84adapter.h"
...
OLinkTestApi84Adapter::OLinkTestApi84Adapter(RemoteRegistry& registry, AbstractTestApi84* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi84::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi84::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi84::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi84::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi84::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi84::sigString, this,
...
json OLinkTestApi84Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi84Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi84Adapter::olinkObjectName() {
    return "api.TestApi84";
}

json OLinkTestApi84Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi84Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi84Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi84Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi84Adapter::olinkCollectProperties()
{
    return captureState();
}
