...
#include "olinktestapi78adapter.h"
...
OLinkTestApi78Adapter::OLinkTestApi78Adapter(RemoteRegistry& registry, AbstractTestApi78* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi78::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi78::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi78::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi78::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi78::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi78::sigString, this,
...
json OLinkTestApi78Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi78Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi78Adapter::olinkObjectName() {
    return "api.TestApi78";
}

json OLinkTestApi78Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi78Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi78Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi78Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi78Adapter::olinkCollectProperties()
{
    return captureState();
}
