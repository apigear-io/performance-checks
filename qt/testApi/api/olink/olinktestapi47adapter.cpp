...
#include "olinktestapi47adapter.h"
...
OLinkTestApi47Adapter::OLinkTestApi47Adapter(RemoteRegistry& registry, AbstractTestApi47* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi47::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi47::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi47::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi47::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi47::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi47::sigString, this,
...
json OLinkTestApi47Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi47Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi47Adapter::olinkObjectName() {
    return "api.TestApi47";
}

json OLinkTestApi47Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi47Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi47Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi47Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi47Adapter::olinkCollectProperties()
{
    return captureState();
}
