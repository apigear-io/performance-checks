...
#include "olinktestapi86adapter.h"
...
OLinkTestApi86Adapter::OLinkTestApi86Adapter(RemoteRegistry& registry, AbstractTestApi86* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi86::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi86::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi86::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi86::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi86::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi86::sigString, this,
...
json OLinkTestApi86Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi86Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi86Adapter::olinkObjectName() {
    return "api.TestApi86";
}

json OLinkTestApi86Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi86Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi86Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi86Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi86Adapter::olinkCollectProperties()
{
    return captureState();
}
