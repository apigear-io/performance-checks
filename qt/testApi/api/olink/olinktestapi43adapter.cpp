...
#include "olinktestapi43adapter.h"
...
OLinkTestApi43Adapter::OLinkTestApi43Adapter(RemoteRegistry& registry, AbstractTestApi43* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi43::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi43::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi43::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi43::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi43::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi43::sigString, this,
...
json OLinkTestApi43Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi43Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi43Adapter::olinkObjectName() {
    return "api.TestApi43";
}

json OLinkTestApi43Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi43Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi43Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi43Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi43Adapter::olinkCollectProperties()
{
    return captureState();
}
