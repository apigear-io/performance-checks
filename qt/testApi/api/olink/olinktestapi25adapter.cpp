...
#include "olinktestapi25adapter.h"
...
OLinkTestApi25Adapter::OLinkTestApi25Adapter(RemoteRegistry& registry, AbstractTestApi25* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi25::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi25::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi25::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi25::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi25::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi25::sigString, this,
...
json OLinkTestApi25Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi25Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi25Adapter::olinkObjectName() {
    return "api.TestApi25";
}

json OLinkTestApi25Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi25Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi25Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi25Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi25Adapter::olinkCollectProperties()
{
    return captureState();
}
