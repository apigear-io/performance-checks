...
#include "olinktestapi93adapter.h"
...
OLinkTestApi93Adapter::OLinkTestApi93Adapter(RemoteRegistry& registry, AbstractTestApi93* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi93::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi93::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi93::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi93::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi93::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi93::sigString, this,
...
json OLinkTestApi93Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi93Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi93Adapter::olinkObjectName() {
    return "api.TestApi93";
}

json OLinkTestApi93Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi93Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi93Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi93Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi93Adapter::olinkCollectProperties()
{
    return captureState();
}
