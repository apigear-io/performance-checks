...
#include "olinktestapi44adapter.h"
...
OLinkTestApi44Adapter::OLinkTestApi44Adapter(RemoteRegistry& registry, AbstractTestApi44* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi44::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi44::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi44::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi44::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi44::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi44::sigString, this,
...
json OLinkTestApi44Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi44Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi44Adapter::olinkObjectName() {
    return "api.TestApi44";
}

json OLinkTestApi44Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi44Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi44Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi44Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi44Adapter::olinkCollectProperties()
{
    return captureState();
}
