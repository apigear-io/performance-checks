...
#include "olinktestapi99adapter.h"
...
OLinkTestApi99Adapter::OLinkTestApi99Adapter(RemoteRegistry& registry, AbstractTestApi99* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi99::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi99::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi99::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi99::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi99::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi99::sigString, this,
...
json OLinkTestApi99Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi99Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi99Adapter::olinkObjectName() {
    return "api.TestApi99";
}

json OLinkTestApi99Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi99Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi99Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi99Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi99Adapter::olinkCollectProperties()
{
    return captureState();
}
