...
#include "olinktestapi50adapter.h"
...
OLinkTestApi50Adapter::OLinkTestApi50Adapter(RemoteRegistry& registry, AbstractTestApi50* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi50::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi50::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi50::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi50::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi50::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi50::sigString, this,
...
json OLinkTestApi50Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi50Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi50Adapter::olinkObjectName() {
    return "api.TestApi50";
}

json OLinkTestApi50Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi50Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi50Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi50Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi50Adapter::olinkCollectProperties()
{
    return captureState();
}
