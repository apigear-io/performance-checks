...
#include "olinktestapi14adapter.h"
...
OLinkTestApi14Adapter::OLinkTestApi14Adapter(RemoteRegistry& registry, AbstractTestApi14* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi14::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi14::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi14::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi14::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi14::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi14::sigString, this,
...
json OLinkTestApi14Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi14Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi14Adapter::olinkObjectName() {
    return "api.TestApi14";
}

json OLinkTestApi14Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi14Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi14Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi14Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi14Adapter::olinkCollectProperties()
{
    return captureState();
}
