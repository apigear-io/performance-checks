...
#include "olinktestapi49adapter.h"
...
OLinkTestApi49Adapter::OLinkTestApi49Adapter(RemoteRegistry& registry, AbstractTestApi49* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi49::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi49::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi49::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi49::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi49::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi49::sigString, this,
...
json OLinkTestApi49Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi49Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi49Adapter::olinkObjectName() {
    return "api.TestApi49";
}

json OLinkTestApi49Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi49Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi49Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi49Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi49Adapter::olinkCollectProperties()
{
    return captureState();
}
