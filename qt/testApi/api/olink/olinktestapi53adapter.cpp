...
#include "olinktestapi53adapter.h"
...
OLinkTestApi53Adapter::OLinkTestApi53Adapter(RemoteRegistry& registry, AbstractTestApi53* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi53::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi53::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi53::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi53::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi53::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi53::sigString, this,
...
json OLinkTestApi53Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi53Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi53Adapter::olinkObjectName() {
    return "api.TestApi53";
}

json OLinkTestApi53Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi53Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi53Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi53Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi53Adapter::olinkCollectProperties()
{
    return captureState();
}
