...
#include "olinktestapi6adapter.h"
...
OLinkTestApi6Adapter::OLinkTestApi6Adapter(RemoteRegistry& registry, AbstractTestApi6* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi6::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi6::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi6::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi6::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi6::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi6::sigString, this,
...
json OLinkTestApi6Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi6Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi6Adapter::olinkObjectName() {
    return "api.TestApi6";
}

json OLinkTestApi6Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi6Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi6Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi6Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi6Adapter::olinkCollectProperties()
{
    return captureState();
}
