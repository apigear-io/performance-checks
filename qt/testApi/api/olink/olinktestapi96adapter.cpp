...
#include "olinktestapi96adapter.h"
...
OLinkTestApi96Adapter::OLinkTestApi96Adapter(RemoteRegistry& registry, AbstractTestApi96* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi96::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi96::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi96::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi96::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi96::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi96::sigString, this,
...
json OLinkTestApi96Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi96Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi96Adapter::olinkObjectName() {
    return "api.TestApi96";
}

json OLinkTestApi96Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi96Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi96Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi96Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi96Adapter::olinkCollectProperties()
{
    return captureState();
}
