...
#include "olinktestapi64adapter.h"
...
OLinkTestApi64Adapter::OLinkTestApi64Adapter(RemoteRegistry& registry, AbstractTestApi64* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi64::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi64::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi64::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi64::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi64::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi64::sigString, this,
...
json OLinkTestApi64Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi64Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi64Adapter::olinkObjectName() {
    return "api.TestApi64";
}

json OLinkTestApi64Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi64Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi64Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi64Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi64Adapter::olinkCollectProperties()
{
    return captureState();
}
