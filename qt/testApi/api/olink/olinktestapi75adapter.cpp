...
#include "olinktestapi75adapter.h"
...
OLinkTestApi75Adapter::OLinkTestApi75Adapter(RemoteRegistry& registry, AbstractTestApi75* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi75::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi75::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi75::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi75::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi75::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi75::sigString, this,
...
json OLinkTestApi75Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi75Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi75Adapter::olinkObjectName() {
    return "api.TestApi75";
}

json OLinkTestApi75Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi75Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi75Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi75Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi75Adapter::olinkCollectProperties()
{
    return captureState();
}
