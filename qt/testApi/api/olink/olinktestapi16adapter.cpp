...
#include "olinktestapi16adapter.h"
...
OLinkTestApi16Adapter::OLinkTestApi16Adapter(RemoteRegistry& registry, AbstractTestApi16* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi16::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi16::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi16::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi16::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi16::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi16::sigString, this,
...
json OLinkTestApi16Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi16Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi16Adapter::olinkObjectName() {
    return "api.TestApi16";
}

json OLinkTestApi16Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi16Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi16Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi16Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi16Adapter::olinkCollectProperties()
{
    return captureState();
}
