...
#include "olinktestapi67adapter.h"
...
OLinkTestApi67Adapter::OLinkTestApi67Adapter(RemoteRegistry& registry, AbstractTestApi67* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi67::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi67::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi67::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi67::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi67::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi67::sigString, this,
...
json OLinkTestApi67Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi67Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi67Adapter::olinkObjectName() {
    return "api.TestApi67";
}

json OLinkTestApi67Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi67Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi67Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi67Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi67Adapter::olinkCollectProperties()
{
    return captureState();
}
