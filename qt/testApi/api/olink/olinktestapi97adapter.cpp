...
#include "olinktestapi97adapter.h"
...
OLinkTestApi97Adapter::OLinkTestApi97Adapter(RemoteRegistry& registry, AbstractTestApi97* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi97::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi97::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi97::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi97::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi97::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi97::sigString, this,
...
json OLinkTestApi97Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi97Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi97Adapter::olinkObjectName() {
    return "api.TestApi97";
}

json OLinkTestApi97Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi97Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi97Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi97Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi97Adapter::olinkCollectProperties()
{
    return captureState();
}
