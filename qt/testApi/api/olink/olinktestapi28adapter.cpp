...
#include "olinktestapi28adapter.h"
...
OLinkTestApi28Adapter::OLinkTestApi28Adapter(RemoteRegistry& registry, AbstractTestApi28* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi28::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi28::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi28::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi28::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi28::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi28::sigString, this,
...
json OLinkTestApi28Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi28Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi28Adapter::olinkObjectName() {
    return "api.TestApi28";
}

json OLinkTestApi28Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi28Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi28Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi28Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi28Adapter::olinkCollectProperties()
{
    return captureState();
}
