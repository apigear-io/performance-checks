...
#include "olinktestapi36adapter.h"
...
OLinkTestApi36Adapter::OLinkTestApi36Adapter(RemoteRegistry& registry, AbstractTestApi36* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi36::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi36::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi36::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi36::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi36::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi36::sigString, this,
...
json OLinkTestApi36Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi36Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi36Adapter::olinkObjectName() {
    return "api.TestApi36";
}

json OLinkTestApi36Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi36Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi36Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi36Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi36Adapter::olinkCollectProperties()
{
    return captureState();
}
