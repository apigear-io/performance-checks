...
#include "olinktestapi98adapter.h"
...
OLinkTestApi98Adapter::OLinkTestApi98Adapter(RemoteRegistry& registry, AbstractTestApi98* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi98::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi98::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi98::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi98::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi98::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi98::sigString, this,
...
json OLinkTestApi98Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi98Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi98Adapter::olinkObjectName() {
    return "api.TestApi98";
}

json OLinkTestApi98Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi98Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi98Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi98Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi98Adapter::olinkCollectProperties()
{
    return captureState();
}
