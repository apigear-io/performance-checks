...
#include "olinktestapi30adapter.h"
...
OLinkTestApi30Adapter::OLinkTestApi30Adapter(RemoteRegistry& registry, AbstractTestApi30* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi30::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi30::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi30::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi30::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi30::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi30::sigString, this,
...
json OLinkTestApi30Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi30Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi30Adapter::olinkObjectName() {
    return "api.TestApi30";
}

json OLinkTestApi30Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi30Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi30Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi30Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi30Adapter::olinkCollectProperties()
{
    return captureState();
}
