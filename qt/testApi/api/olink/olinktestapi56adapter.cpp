...
#include "olinktestapi56adapter.h"
...
OLinkTestApi56Adapter::OLinkTestApi56Adapter(RemoteRegistry& registry, AbstractTestApi56* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi56::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi56::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi56::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi56::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi56::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi56::sigString, this,
...
json OLinkTestApi56Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi56Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi56Adapter::olinkObjectName() {
    return "api.TestApi56";
}

json OLinkTestApi56Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi56Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi56Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi56Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi56Adapter::olinkCollectProperties()
{
    return captureState();
}
