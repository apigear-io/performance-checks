...
#include "olinktestapi71adapter.h"
...
OLinkTestApi71Adapter::OLinkTestApi71Adapter(RemoteRegistry& registry, AbstractTestApi71* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi71::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi71::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi71::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi71::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi71::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi71::sigString, this,
...
json OLinkTestApi71Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi71Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi71Adapter::olinkObjectName() {
    return "api.TestApi71";
}

json OLinkTestApi71Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi71Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi71Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi71Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi71Adapter::olinkCollectProperties()
{
    return captureState();
}
