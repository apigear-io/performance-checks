...
#include "olinktestapi87adapter.h"
...
OLinkTestApi87Adapter::OLinkTestApi87Adapter(RemoteRegistry& registry, AbstractTestApi87* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi87::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi87::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi87::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi87::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi87::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi87::sigString, this,
...
json OLinkTestApi87Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi87Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi87Adapter::olinkObjectName() {
    return "api.TestApi87";
}

json OLinkTestApi87Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi87Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi87Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi87Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi87Adapter::olinkCollectProperties()
{
    return captureState();
}
