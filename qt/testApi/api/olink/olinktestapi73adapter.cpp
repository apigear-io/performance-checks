...
#include "olinktestapi73adapter.h"
...
OLinkTestApi73Adapter::OLinkTestApi73Adapter(RemoteRegistry& registry, AbstractTestApi73* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi73::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi73::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi73::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi73::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi73::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi73::sigString, this,
...
json OLinkTestApi73Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi73Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi73Adapter::olinkObjectName() {
    return "api.TestApi73";
}

json OLinkTestApi73Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi73Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi73Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi73Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi73Adapter::olinkCollectProperties()
{
    return captureState();
}
