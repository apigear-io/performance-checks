...
#include "olinktestapi48adapter.h"
...
OLinkTestApi48Adapter::OLinkTestApi48Adapter(RemoteRegistry& registry, AbstractTestApi48* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi48::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi48::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi48::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi48::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi48::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi48::sigString, this,
...
json OLinkTestApi48Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi48Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi48Adapter::olinkObjectName() {
    return "api.TestApi48";
}

json OLinkTestApi48Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi48Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi48Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi48Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi48Adapter::olinkCollectProperties()
{
    return captureState();
}
