...
#include "olinktestapi38adapter.h"
...
OLinkTestApi38Adapter::OLinkTestApi38Adapter(RemoteRegistry& registry, AbstractTestApi38* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi38::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi38::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi38::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi38::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi38::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi38::sigString, this,
...
json OLinkTestApi38Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi38Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi38Adapter::olinkObjectName() {
    return "api.TestApi38";
}

json OLinkTestApi38Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi38Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi38Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi38Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi38Adapter::olinkCollectProperties()
{
    return captureState();
}
