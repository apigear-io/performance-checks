...
#include "olinktestapi94adapter.h"
...
OLinkTestApi94Adapter::OLinkTestApi94Adapter(RemoteRegistry& registry, AbstractTestApi94* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi94::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi94::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi94::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi94::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi94::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi94::sigString, this,
...
json OLinkTestApi94Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi94Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi94Adapter::olinkObjectName() {
    return "api.TestApi94";
}

json OLinkTestApi94Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi94Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi94Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi94Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi94Adapter::olinkCollectProperties()
{
    return captureState();
}
