...
#include "olinktestapi62adapter.h"
...
OLinkTestApi62Adapter::OLinkTestApi62Adapter(RemoteRegistry& registry, AbstractTestApi62* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi62::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi62::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi62::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi62::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi62::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi62::sigString, this,
...
json OLinkTestApi62Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi62Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi62Adapter::olinkObjectName() {
    return "api.TestApi62";
}

json OLinkTestApi62Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi62Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi62Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi62Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi62Adapter::olinkCollectProperties()
{
    return captureState();
}
