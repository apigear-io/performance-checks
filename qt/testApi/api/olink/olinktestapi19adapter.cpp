...
#include "olinktestapi19adapter.h"
...
OLinkTestApi19Adapter::OLinkTestApi19Adapter(RemoteRegistry& registry, AbstractTestApi19* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi19::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi19::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi19::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi19::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi19::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi19::sigString, this,
...
json OLinkTestApi19Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi19Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi19Adapter::olinkObjectName() {
    return "api.TestApi19";
}

json OLinkTestApi19Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi19Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi19Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi19Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi19Adapter::olinkCollectProperties()
{
    return captureState();
}
