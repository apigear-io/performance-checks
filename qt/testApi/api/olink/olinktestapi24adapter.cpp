...
#include "olinktestapi24adapter.h"
...
OLinkTestApi24Adapter::OLinkTestApi24Adapter(RemoteRegistry& registry, AbstractTestApi24* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi24::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi24::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi24::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi24::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi24::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi24::sigString, this,
...
json OLinkTestApi24Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi24Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi24Adapter::olinkObjectName() {
    return "api.TestApi24";
}

json OLinkTestApi24Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi24Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi24Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi24Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi24Adapter::olinkCollectProperties()
{
    return captureState();
}
