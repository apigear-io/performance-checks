...
#include "olinktestapi52adapter.h"
...
OLinkTestApi52Adapter::OLinkTestApi52Adapter(RemoteRegistry& registry, AbstractTestApi52* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi52::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi52::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi52::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi52::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi52::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi52::sigString, this,
...
json OLinkTestApi52Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi52Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi52Adapter::olinkObjectName() {
    return "api.TestApi52";
}

json OLinkTestApi52Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi52Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi52Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi52Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi52Adapter::olinkCollectProperties()
{
    return captureState();
}
