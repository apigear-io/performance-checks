...
#include "olinktestapi8adapter.h"
...
OLinkTestApi8Adapter::OLinkTestApi8Adapter(RemoteRegistry& registry, AbstractTestApi8* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi8::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi8::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi8::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi8::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi8::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi8::sigString, this,
...
json OLinkTestApi8Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi8Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi8Adapter::olinkObjectName() {
    return "api.TestApi8";
}

json OLinkTestApi8Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi8Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi8Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi8Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi8Adapter::olinkCollectProperties()
{
    return captureState();
}
