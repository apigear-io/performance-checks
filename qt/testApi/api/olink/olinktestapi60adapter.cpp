...
#include "olinktestapi60adapter.h"
...
OLinkTestApi60Adapter::OLinkTestApi60Adapter(RemoteRegistry& registry, AbstractTestApi60* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi60::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi60::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi60::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi60::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi60::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi60::sigString, this,
...
json OLinkTestApi60Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi60Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi60Adapter::olinkObjectName() {
    return "api.TestApi60";
}

json OLinkTestApi60Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi60Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi60Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi60Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi60Adapter::olinkCollectProperties()
{
    return captureState();
}
