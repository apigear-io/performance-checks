...
#include "olinktestapi37adapter.h"
...
OLinkTestApi37Adapter::OLinkTestApi37Adapter(RemoteRegistry& registry, AbstractTestApi37* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi37::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi37::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi37::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi37::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi37::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi37::sigString, this,
...
json OLinkTestApi37Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi37Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi37Adapter::olinkObjectName() {
    return "api.TestApi37";
}

json OLinkTestApi37Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi37Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi37Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi37Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi37Adapter::olinkCollectProperties()
{
    return captureState();
}
