...
#include "olinktestapi90adapter.h"
...
OLinkTestApi90Adapter::OLinkTestApi90Adapter(RemoteRegistry& registry, AbstractTestApi90* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi90::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi90::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi90::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi90::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi90::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi90::sigString, this,
...
json OLinkTestApi90Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi90Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi90Adapter::olinkObjectName() {
    return "api.TestApi90";
}

json OLinkTestApi90Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi90Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi90Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi90Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi90Adapter::olinkCollectProperties()
{
    return captureState();
}
