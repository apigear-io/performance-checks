...
#include "olinktestapi54adapter.h"
...
OLinkTestApi54Adapter::OLinkTestApi54Adapter(RemoteRegistry& registry, AbstractTestApi54* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi54::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi54::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi54::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi54::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi54::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi54::sigString, this,
...
json OLinkTestApi54Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi54Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi54Adapter::olinkObjectName() {
    return "api.TestApi54";
}

json OLinkTestApi54Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi54Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi54Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi54Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi54Adapter::olinkCollectProperties()
{
    return captureState();
}
