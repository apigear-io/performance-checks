...
#include "olinktestapi9adapter.h"
...
OLinkTestApi9Adapter::OLinkTestApi9Adapter(RemoteRegistry& registry, AbstractTestApi9* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi9::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi9::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi9::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi9::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi9::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi9::sigString, this,
...
json OLinkTestApi9Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi9Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi9Adapter::olinkObjectName() {
    return "api.TestApi9";
}

json OLinkTestApi9Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi9Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi9Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi9Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi9Adapter::olinkCollectProperties()
{
    return captureState();
}
