...
#include "olinktestapi57adapter.h"
...
OLinkTestApi57Adapter::OLinkTestApi57Adapter(RemoteRegistry& registry, AbstractTestApi57* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi57::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi57::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi57::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi57::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi57::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi57::sigString, this,
...
json OLinkTestApi57Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi57Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi57Adapter::olinkObjectName() {
    return "api.TestApi57";
}

json OLinkTestApi57Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi57Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi57Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi57Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi57Adapter::olinkCollectProperties()
{
    return captureState();
}
