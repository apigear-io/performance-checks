...
#include "olinktestapi83adapter.h"
...
OLinkTestApi83Adapter::OLinkTestApi83Adapter(RemoteRegistry& registry, AbstractTestApi83* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi83::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi83::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi83::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi83::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi83::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi83::sigString, this,
...
json OLinkTestApi83Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi83Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi83Adapter::olinkObjectName() {
    return "api.TestApi83";
}

json OLinkTestApi83Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi83Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi83Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi83Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi83Adapter::olinkCollectProperties()
{
    return captureState();
}
