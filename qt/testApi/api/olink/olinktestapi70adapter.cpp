...
#include "olinktestapi70adapter.h"
...
OLinkTestApi70Adapter::OLinkTestApi70Adapter(RemoteRegistry& registry, AbstractTestApi70* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi70::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi70::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi70::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi70::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi70::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi70::sigString, this,
...
json OLinkTestApi70Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi70Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi70Adapter::olinkObjectName() {
    return "api.TestApi70";
}

json OLinkTestApi70Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi70Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi70Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi70Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi70Adapter::olinkCollectProperties()
{
    return captureState();
}
