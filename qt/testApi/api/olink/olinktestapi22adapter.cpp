...
#include "olinktestapi22adapter.h"
...
OLinkTestApi22Adapter::OLinkTestApi22Adapter(RemoteRegistry& registry, AbstractTestApi22* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi22::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi22::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi22::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi22::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi22::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi22::sigString, this,
...
json OLinkTestApi22Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi22Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi22Adapter::olinkObjectName() {
    return "api.TestApi22";
}

json OLinkTestApi22Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi22Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi22Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi22Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi22Adapter::olinkCollectProperties()
{
    return captureState();
}
