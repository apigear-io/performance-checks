...
#include "olinktestapi18adapter.h"
...
OLinkTestApi18Adapter::OLinkTestApi18Adapter(RemoteRegistry& registry, AbstractTestApi18* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi18::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi18::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi18::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi18::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi18::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi18::sigString, this,
...
json OLinkTestApi18Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi18Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi18Adapter::olinkObjectName() {
    return "api.TestApi18";
}

json OLinkTestApi18Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi18Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi18Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi18Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi18Adapter::olinkCollectProperties()
{
    return captureState();
}
