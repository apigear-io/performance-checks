...
#include "olinktestapi11adapter.h"
...
OLinkTestApi11Adapter::OLinkTestApi11Adapter(RemoteRegistry& registry, AbstractTestApi11* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi11::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi11::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi11::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi11::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi11::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi11::sigString, this,
...
json OLinkTestApi11Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi11Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi11Adapter::olinkObjectName() {
    return "api.TestApi11";
}

json OLinkTestApi11Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi11Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi11Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi11Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi11Adapter::olinkCollectProperties()
{
    return captureState();
}
