...
#include "olinktestapi63adapter.h"
...
OLinkTestApi63Adapter::OLinkTestApi63Adapter(RemoteRegistry& registry, AbstractTestApi63* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi63::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi63::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi63::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi63::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi63::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi63::sigString, this,
...
json OLinkTestApi63Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi63Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi63Adapter::olinkObjectName() {
    return "api.TestApi63";
}

json OLinkTestApi63Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi63Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi63Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi63Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi63Adapter::olinkCollectProperties()
{
    return captureState();
}
