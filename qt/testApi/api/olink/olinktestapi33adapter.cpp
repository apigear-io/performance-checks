...
#include "olinktestapi33adapter.h"
...
OLinkTestApi33Adapter::OLinkTestApi33Adapter(RemoteRegistry& registry, AbstractTestApi33* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi33::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi33::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi33::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi33::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi33::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi33::sigString, this,
...
json OLinkTestApi33Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi33Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi33Adapter::olinkObjectName() {
    return "api.TestApi33";
}

json OLinkTestApi33Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi33Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi33Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi33Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi33Adapter::olinkCollectProperties()
{
    return captureState();
}
