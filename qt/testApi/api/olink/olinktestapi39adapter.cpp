...
#include "olinktestapi39adapter.h"
...
OLinkTestApi39Adapter::OLinkTestApi39Adapter(RemoteRegistry& registry, AbstractTestApi39* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi39::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi39::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi39::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi39::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi39::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi39::sigString, this,
...
json OLinkTestApi39Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi39Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi39Adapter::olinkObjectName() {
    return "api.TestApi39";
}

json OLinkTestApi39Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi39Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi39Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi39Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi39Adapter::olinkCollectProperties()
{
    return captureState();
}
