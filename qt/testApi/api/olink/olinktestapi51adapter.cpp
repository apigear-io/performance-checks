...
#include "olinktestapi51adapter.h"
...
OLinkTestApi51Adapter::OLinkTestApi51Adapter(RemoteRegistry& registry, AbstractTestApi51* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi51::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi51::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi51::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi51::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi51::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi51::sigString, this,
...
json OLinkTestApi51Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi51Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi51Adapter::olinkObjectName() {
    return "api.TestApi51";
}

json OLinkTestApi51Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi51Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi51Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi51Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi51Adapter::olinkCollectProperties()
{
    return captureState();
}
