...
#include "olinktestapi58adapter.h"
...
OLinkTestApi58Adapter::OLinkTestApi58Adapter(RemoteRegistry& registry, AbstractTestApi58* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi58::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi58::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi58::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi58::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi58::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi58::sigString, this,
...
json OLinkTestApi58Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi58Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi58Adapter::olinkObjectName() {
    return "api.TestApi58";
}

json OLinkTestApi58Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi58Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi58Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi58Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi58Adapter::olinkCollectProperties()
{
    return captureState();
}
