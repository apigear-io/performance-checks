...
#include "olinktestapi81adapter.h"
...
OLinkTestApi81Adapter::OLinkTestApi81Adapter(RemoteRegistry& registry, AbstractTestApi81* impl, QObject *parent)
    : QObject(parent)
    , m_impl(impl)
    , m_registry(registry)
{
    connect(m_impl, &AbstractTestApi81::propIntChanged, this,
        [=](int propInt) {
    ...
    connect(m_impl, &AbstractTestApi81::propFloatChanged, this,
        [=](qreal propFloat) {
    ...
    connect(m_impl, &AbstractTestApi81::propStringChanged, this,
        ...
        connect(m_impl, &AbstractTestApi81::sigInt, this,
            [=](int paramInt) {
        ...
        connect(m_impl, &AbstractTestApi81::sigFloat, this,
            [=](qreal paramFloat) {
        ...
        connect(m_impl, &AbstractTestApi81::sigString, this,
...
json OLinkTestApi81Adapter::captureState()
{
    return json::object({
...
void OLinkTestApi81Adapter::applyState(const json& state)
{
...
std::string OLinkTestApi81Adapter::olinkObjectName() {
    return "api.TestApi81";
}

json OLinkTestApi81Adapter::olinkInvoke(const std::string& methodId, const nlohmann::json& args){
...
void OLinkTestApi81Adapter::olinkSetProperty(const std::string& propertyId, const nlohmann::json& value){
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void OLinkTestApi81Adapter::olinkLinked(const std::string& objectId, IRemoteNode *node) {
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

void OLinkTestApi81Adapter::olinkUnlinked(const std::string& objectId)
{
    AG_LOG_INFO(Q_FUNC_INFO);
    AG_LOG_INFO(objectId);
}

json OLinkTestApi81Adapter::olinkCollectProperties()
{
    return captureState();
}
